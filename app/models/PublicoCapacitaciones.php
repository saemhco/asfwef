 ...
 * Types of Products
 */
class PublicoCapacitaciones extends Model {

    public function initialize() {
        $this->setSource("tbl_web_publico_capacitaciones");
    }
...
//        ]));
        ...
        $validator->add(
                'capacitacion', new PresenceOfValidator([
                    'message' => 'El campo capacitacion es requerido'
        ]));
