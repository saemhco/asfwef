<?php
class Registroencuestas6Controller extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/registroencuestas6.js?v=" . uniqid());
    }
    ...
    public function registroAction()
    {
        ...
        WHERE
        public.tbl_enc_encuestas.id_encuesta = 6 AND public.tbl_enc_encuestas_alumnos.id_alumno = '$id_alumno' AND public.tbl_enc_encuestas_alumnos.id_semestre = $semestre_a->codigo";
        ...
        if (count($verifica) > 0) {
            return $this->response->redirect("registroencuestas6/fin");
        }

        //Modelo encuestas
        $encuesta = Encuestas::findFirst("estado = 'A' AND id_tipo_encuesta = '2' AND id_encuesta = 6");
        ...
        $tipo_de_pregunta = $this->modelsManager->createBuilder()
            ...
            ->where("Encuestas.id_encuesta = 6 AND TipoPreguntas.numero = 36")
        ...
        $encuestasRespuestasT = EncuestasRespuestasT::find("estado = 'A' AND id_encuesta = 6 ORDER BY orden ASC");
    ...
    public function finAction()
    {
        ...
        $encuesta = Encuestas::findFirst("estado = 'A' AND id_tipo_encuesta = '3' AND id_encuesta = 6");
        $this->view->encuesta = $encuesta;
        ...
        $encuestasAlumnos = EncuestasAlumnos::findFirst("id_alumno = '$id_alumno' AND id_encuesta = 6");
        ...
        $preguntas = $this->modelsManager->createBuilder()
            ...
            ->where("Encuestas.id_encuesta = 6 AND TipoPreguntas.numero = 36 AND RespuestasAlumnos.id_encuesta_alumno = $encuestasAlumnos->id_encuesta_alumno")
            ->orderBy('EncuestasPreguntas.numero ASC')
            ->getQuery()
            ->execute();
