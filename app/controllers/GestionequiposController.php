...
class GestionequiposController extends ControllerPanel
{
    ...
    {
        $this->assets->addJs("adminpanel/js/modulos/gestionequipos.js?v=" . uniqid() . "");
    }
    ...
    public function datatableAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setSelect("id_personal_area,personal_nombre,areas_nombres,estado");
            $datatable->setFrom("(SELECT
            public.tbl_web_personal_areas.codigo AS id_personal_area,
            ...
            public.tbl_web_areas.nombres AS areas_nombres,
            public.tbl_web_personal_areas.estado AS estado
            FROM
            ...
            WHERE
            public.tbl_web_personal_areas.estado = 'A') AS temporal_table");
    ...
    public function registroAction($id = null)
    {
        $this->view->id = $id;
        if ($id != null) {
            $personalAreas = PersonalAreas::findFirstBycodigo((int) $id);
        }
        ...
        $this->assets->addJs("adminpanel/js/modulos/gestionequipos.computadoras.js?v=" . uniqid());
        $this->assets->addJs("adminpanel/js/modulos/gestionequipos.impresoras.js?v=" . uniqid());
        $this->assets->addJs("adminpanel/js/modulos/gestionequipos.estabilizadores.js?v=" . uniqid());
        $this->assets->addJs("adminpanel/js/modulos/gestionequipos.pantallas.js?v=" . uniqid());
    }
    ...
    public function datatableComputadorasAction($id_personal_area)
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setOrderby("id_personal_area_equipo");
            $datatable->setParams($_POST);
            $datatable->getJson();
        }
    }
