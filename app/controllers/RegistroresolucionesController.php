                                ...
                                if ($file->getKey() == "archivo_resolucion") {
                                    ...
                                    if ($filex->getExtension() == 'pdf') {
                                        ...
                                        if (isset($Resoluciones->archivo)) {
                                            ...
                                            $url_destino = 'adminpanel/archivos/resoluciones/' . 'RES. VPA.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPA-' . $xAbrevIns . '-' . $temporal_rand . '.pdf';
                                            $Resoluciones->archivo = 'RES. VPA.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPA-' . $xAbrevIns . '-' . $temporal_rand . '.pdf';
                                        } else {
                                            $url_destino = 'adminpanel/archivos/resoluciones/' . 'RES. VPA.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPA-' . $xAbrevIns . '.pdf';
                                            $Resoluciones->archivo = 'RES. VPA.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPA-' . $xAbrevIns . '.pdf';
                                        }
                                ...
                                if ($file->getKey() == "archivo_resolucion") {
                                    ...
                                    if ($filex->getExtension() == 'pdf') {
                                        ...
                                        if (isset($Resoluciones->archivo)) {
                                            ...
                                            $url_destino = 'adminpanel/archivos/resoluciones/' . 'RES. VPI.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPI-' . $xAbrevIns . '-' . $temporal_rand . '.pdf';
                                            $Resoluciones->archivo = 'RES. VPI.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPI-' . $xAbrevIns . '-' . $temporal_rand . '.pdf';
                                        } else {
                                            $url_destino = 'adminpanel/archivos/resoluciones/' . 'RES. VPI.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPI-' . $xAbrevIns . '.pdf';
                                            $Resoluciones->archivo = 'RES. VPI.' . ' ' . $Resoluciones->numero . '-' . $fecha_ex[2] . '-VPI-' . $xAbrevIns . '.pdf';
                                        }
