...
class RegistrorequerimientosController extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/registrorequerimientos.js?v=" . uniqid());
    }
    ...
    public function registroAction($id = null)
    {
        ...
        $this->view->id = $id;
        if ($id != null) {
            $requerimientos = RequerimientoServicio::findFirstByid_req_servicio((int) $id);
            ...
            $requerimientos = RequerimientoServicio::findFirstByid_req_servicio(0);
        }
        ...
        $procesos = HelpdeskProceso::find("estado = 'A' AND numero = 94 AND codigo > 1 AND codigo <= 3 ");
    ...
    public function datatableAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            prioridad,proceso,estado, fecha, hora");
            ...
            public.tbl_hdt_req_servicios.fecha_req AS fecha,
            public.tbl_hdt_req_servicios.hora_req AS hora
            FROM
            ...
            procesos.numero = 94) AS temporal_table");
            $datatable->setParams($_POST);
            $datatable->setOrderby("fecha DESC, hora DESC");
            $datatable->getJson();
        }
    }
    ...
    public function saveAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $model = RequerimientoServicio::findFirstByid_req_servicio($id);
                //Valida cuando es nuevo
                $model = (!$model) ? new RequerimientoServicio() : $model;
                ...
                if ($this->request->getPost("proceso", "int") == 3) {
                    //no hace nada
                } else {
                    $model->proceso = 2;
                    ...
                    $model->solucion = $this->request->getPost("solucion", "string");
                }
    ...
    public function eliminarAction()
    {
        $this->view->disable();
        if ($this->request->isPost() && $this->request->isAjax()) {
            $model = RequerimientoServicio::findFirstByid_req_servicio((int) $this->request->getPost("id", "int"));
    ...
    public function finalizarAction()
    {
        $this->view->disable();
        if ($this->request->isPost() && $this->request->isAjax()) {
            $model = RequerimientoServicio::findFirstByid_req_servicio((int) $this->request->getPost("id_req_servicio", "int"));
            if ($model && $model->estado = 'A') {
                $model->proceso = 3;
                $model->save();
                $this->response->setStatusCode(200, "OK");
