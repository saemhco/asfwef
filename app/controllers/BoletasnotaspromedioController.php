...
class BoletasnotaspromedioController  extends ControllerPanel {
    ...
    public function indexAction() {
        ...
        AlumnosAsignaturas.ef,AlumnosAsignaturas.ea,AlumnosAsignaturas.pf')
                        ...
                        ->where("AlumnosAsignaturas.alumno='{$codigo_alumno}' AND AlumnosAsignaturas.pf >= -2 AND AlumnosAsignaturas.estado = '1' AND AlumnosAsignaturas.semestre = {$v->semestre} ")
                        ->getQuery()
                        ->execute();
                $detalle_notas = array();
                 $sum_creditos = 0;
