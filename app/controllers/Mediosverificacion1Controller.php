...
class Mediosverificacion1Controller extends ControllerPanel {

    public function initialize() {
        $this->tag->setTitle('ADMIN');
        parent::initialize();

        $this->assets->addJs("adminpanel/js/modulos/medios1.js?v=" . uniqid());
    }
    ...
    public function datatableAction() {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setColumnaId("medios.id_medio");
            $datatable->setSelect("medios.id_medio,"
            ...
            $datatable->setFrom("tbl_lic_medios medios  INNER JOIN tbl_lic_indicadores indicadores ON medios.indicador = indicadores.id_indicador"
                    . " INNER JOIN tbl_seg_usuarios_detalles usuarios_detalles ON usuarios_detalles.id_tabla = medios.id_medio");
            $datatable->setWhere("usuarios_detalles.id_usuario ={$id_usuario} AND usuarios_detalles.tabla = 'tbl_lic_medios' AND medios.estado = 'A'");
