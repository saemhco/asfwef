...
class WebController extends ControllerBase
{
    ...
    public function web_proyectos_investigacionAction()
    {
        ...
        $proyectosInvestigacion = $this->modelsManager->createBuilder()
            ...
            ->columns('ProyectosInvestigacion.id_proyecto,
                        ...
                        ProyectosInvestigacion.imagen,
                        ProyectosInvestigacion.estado')
            ->where("ProyectosInvestigacion.tipo_proyecto = 1 and ProyectosInvestigacion.estado ='A' ")
            ->orderBy('ProyectosInvestigacion.id_proyecto DESC')
            ->getQuery()
            ->execute();
    ...
    public function web_detalle_servicioAction($id)
    {
        ...
        $ServiciosImagenes = ServiciosImagenes::find("id_servicio = $id ");
    ...
    public function web_documentosAction($enlace)
    {
        ...
        $verificae = DocumentosEvaluaciones::find("id_documento = $documento->id_documento");
        ...
        $verificaa = DocumentosArchivos::find("id_documento = $documento->id_documento");
                        ...
                        foreach ($this->request->getUploadedFiles() as $file) {
                            ...
                            if ($file->getKey() == "foto") {
                                ...
                                if ($filex->getExtension() == 'jpg') {
                                    ...
                                    $url_destino = 'adminpanel/imagenes/postulantes/' . 'IMG' . '-' . $Publico->codigo . '.png';
                    ...
                    if ($this->request->hasFiles() == true) {
                        ...
                        foreach ($this->request->getUploadedFiles() as $file) {
                            ...
                            if ($file->getKey() == "foto") {
                                ...
                                if ($filex->getExtension() == 'jpg') {
                                    $url_destino = 'adminpanel/imagenes/postulantes/' . 'IMG' . '-' . $postulantes->codigo . '.jpg';
                                    ...
                                    $url_destino = 'adminpanel/imagenes/postulantes/' . 'IMG' . '-' . $postulantes->codigo . '.png';
    ...
    public function envioEmailPublicoAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            ...
            if ($empresaPublico !== false) {
                ...
                $link = $this->url->getBaseUri() . "registro-tramite-documentario.html";

                //print $link."<br>";
                // print base64_decode($encrypt);
                // exit();

                $emailTramite = $this->config->mail->destEmail;
                $text_body .= "" . '<br>';
    ...
    public function web_consulta_tramite_documentarioAction()
    {
        ...
        public.tbl_doc_documentos.anio
        FROM
        ...
        WHERE
        tipo_documentos.numero = 102 AND $where";
        ...
        if ($this->request->isGet()) {
            ...
            if (isset($_GET["anio_tramite"]) && $_GET["anio_tramite"] != "") {
                ...
                if ($documentos) {
                    ...
                    // exit();
                    $mensaje = "No se encontraron documentos ... Verifique el numero de su cargo ...";
                }
            }
        }
    ...
    public function login_concurso_rsuAction()
    {
    ...
    public function loginConcursoRsuAction()
    {
        // echo "<pre>";
        // print_r($_POST);
        // exit();
