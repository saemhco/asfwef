...
class GestiontramitedocumentarioexternowebController extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/gestiontramitedocumentarioexternoweb.js?v=" . uniqid());
    }

   
    public function documentosenviadoswebAction()
    {
    ...
    public function registroAction($id = null)
    {
        ...
        $ProcesoTramite = TipoTramite::find("estado = 'A' AND numero = 145");
        $this->view->ProcesoTramite = $ProcesoTramite;
        ...
        */
        ...
        WHERE
        public.tbl_web_empresa_publico.id_empresa_publico = {$documentos->id_remitente}";
    ...
    public function saveAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                //$documentos->proceso = $this->request->getPost("id_proc", "int");
                if ($this->request->getPost("id_proc", "int") == "") {
    ...
    public function datatableAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setSelect("id_doc,fecha_envio, fecha_cargo,tipo_documento,nro_documento,remitente_nombres,personal_nombre,destinatario_personal,area,archivo,estado,proceso,observaciones");
            $datatable->setFrom("(
            SELECT
            ...
            public.tbl_doc_documentos.archivo, tbl_web_empresa_publico.email,
            public.publico.nro_doc as dni, public.publico.celular,
            public.tbl_doc_documentos.proceso, public.tbl_doc_documentos.observaciones
            FROM
            ...
            INNER JOIN public.tbl_web_empresa_publico on public.tbl_doc_documentos.id_remitente = public.tbl_web_empresa_publico.id_empresa_publico
            INNER JOIN public.publico on public.tbl_web_empresa_publico.id_publico = public.publico.codigo
            WHERE public.a_codigos.numero = 102 order by public.tbl_doc_documentos.id_doc desc) AS temporal_table");
