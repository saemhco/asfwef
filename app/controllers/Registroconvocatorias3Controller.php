...
class Registroconvocatorias3Controller extends ControllerPanel {

    public function initialize() {
        $this->tag->setTitle('ADMIN');
        parent::initialize();

        $this->assets->addJs("adminpanel/js/modulos/registroconvocatorias3.js?v=" . uniqid());
    }
    ...
    public function saveAction() {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                //titular
                $Convocatorias->titulo = $this->request->getPost("titular", "string");
    ...
    public function datatableAction() {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            //$datatable->setWhere("conv.etapa <> 3");
            //$datatable->setWhere("conv.estado = 'A' AND aco.numero = 72");
            $datatable->setWhere("aco.numero = 72 AND usuarios_detalles.id_usuario ={$id_usuario} AND usuarios_detalles.tabla = 'tbl_web_convocatorias' AND usuarios_detalles.tipo = 3 AND usuarios_detalles.estado = 'A' and conv.etapa <> 3");
            //exit();
...
//                exit();
                ...
                //titular
                $ConvocatoriasDetalles->titulo = $this->request->getPost("titular_detalle", "string");
