...
class ConvocatoriasbsController extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/convocatoriasbs.js?v=" . uniqid());
    }
...
$this->view->personal = $Pesonal;
        ...
        $this->assets->addJs("adminpanel/js/modulos/convocatoriasbs.usuarios.detalles.js?v=" . uniqid());
    }
...
//        echo '<pre>';
    ...
    public function perfilesAction($convocatoria)
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/convocatoriasbs.perfiles.js?v" . uniqid());
    }
