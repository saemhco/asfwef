...
class WebbolsatrabajoController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        //Cargamos el modelo de cargos (trabajos populares)
        ...
        //                ->from('Empleos')
        //                ->columns('Empleos.empleo_id,Empleos.descripcion,'
        //                        . 'Empleos.titulo,Empleos.salario,'
        //                        . 'Empleos.fecha_clausura,Empleos.fecha_creacion,'
        //                        . 'Empleador.razon_social,Provincias.descripcion as provincia,'
        //                        . ' Distritos.descripcion as distrito, Jornadas.descripcion as jornada ')
        //                ->join('Empleador', 'Empleos.empleador_id = Empleador.empleador_id')
        ...
        //                ->join('Jornadas', 'Empleos.jornada_id = Jornadas.jornada_id')
        //                ->where("Empleos.estado='A' AND Empleos.fecha_clausura >= '" . $fecha_actual . "'")
        //                ->limit(6)
        //                ->orderBy('Empleos.empleo_id DESC')
        //                ->getQuery()
        //                ->execute();
        ...
        jornada.nombres AS jornada,
        cargos.nombres AS cargo,
        tipo_contrato.nombres AS tipo_contrato,
        distritos.descripcion AS distrito
        FROM
        Empleos AS empleos
        INNER JOIN Empresas AS empresas ON empresas.id_empresa = empleos.empresa
        INNER JOIN Jornadas AS jornada ON jornada.codigo = empleos.jornada
        ...
        WHERE
        empleos.fecha_clausura >= '$fecha_actual' AND
        empleos.estado = 'A' AND
        jornada.numero = 46 AND
        cargos.numero = 45 AND
        tipo_contrato.numero = 47
        ORDER BY
