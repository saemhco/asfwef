...
class PublicocvController extends ControllerPanel {

    public function initialize() {
        $this->tag->setTitle('ADMIN');
        parent::initialize();

        $this->assets->addJs("adminpanel/js/modulos/publicocv.js?v=" . uniqid());
    }
    ...
    public function datatableAction() {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setSelect("p.codigo, p.apellidop, p.apellidom, p.nombres, p.nro_doc, p.telefono, p.celular, p.direccion, p.email, p.estado");
...
;
    ...
    public function admisionregistroPostulanteAction() {
        ...
        $this->view->disable();
        if ($this->request->isPost() && $this->request->isAjax()) {
            $postulante = Admision::findFirstBypostulante((int) $this->request->getPost("postulante", "int"));
