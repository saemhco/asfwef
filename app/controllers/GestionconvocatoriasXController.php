...
class GestionconvocatoriasController extends ControllerPanel
{
    ...
    public function cargosAction()
    {
        ...
        $tipocargos = TipoCargos::find("estado = 'A' AND numero = 68");
    ...
    public function datatableCargosAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            tipodecargos.numero = 68 AND public.tbl_web_publico_cargos.publico = $id_publico) AS temporal_table");
    ...
    public function saveCargosAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoCargos->nro_doc = $Publico->nro_doc;
    ...
    public function datatableIdiomasAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            tipodeidiomas.numero = 49 AND public.tbl_web_publico_idiomas.publico = $id_publico) AS temporal_table");
            $datatable->setOrderby("fecha_inicio DESC");
            $datatable->setParams($_POST);
            $datatable->getJson();
        }
    ...
    public function saveIdiomasAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoIdiomas->nro_doc = $Publico->nro_doc;
    ...
    public function datatableAsesoriasAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            tipo_grado.numero = 69 AND public.tbl_web_publico_asesorias.publico = $id_publico) AS temporal_table");
    ...
    public function saveAsesoriasAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                //     if ($info->getExtension() == 'pdf' or $info->getExtension() == 'jpg' or $info->getExtension() == 'jpeg') {
                //         $PublicoAsesorias->archivo = $this->request->getPost("input-file");
                //     } else {
                //         $this->response->setJsonContent(array("say" => "no_formato"));
                //         $this->response->send();
                //         exit();
                ...
                //         if ($info->getExtension() == 'pdf' or $info->getExtension() == 'jpg' or $info->getExtension() == 'jpeg') {
                //             $PublicoAsesorias->archivo = $_FILES['archivo']['name'];
                //         } else {
                //             $this->response->setJsonContent(array("say" => "no_formato"));
                //             $this->response->send();
                //             exit();
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoAsesorias->nro_doc = $Publico->nro_doc;
    ...
    public function datatablePublicacionesAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            tipo_de_publicaciones.numero = 135 AND public.tbl_web_publico_publicaciones.publico = $id_publico) AS temporal_table");
    ...
    public function savePublicacionesAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoPublicaciones->nro_doc = $Publico->nro_doc;
    ...
    public function datatableExtensionAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            public.tbl_web_publico_extension.publico = $id_publico) AS temporal_table");
            $datatable->setOrderby("fecha DESC");
            $datatable->setParams($_POST);
            $datatable->getJson();
        }
    ...
    public function saveExtensionAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoExtension->nro_doc = $Publico->nro_doc;
    ...
    public function datatableMaterialesAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            tipo_de_materiales.numero = 133 AND public.tbl_web_publico_materiales.publico = $id_publico) AS temporal_table");
            $datatable->setOrderby("fecha DESC");
            $datatable->setParams($_POST);
            $datatable->getJson();
        }
    ...
    public function saveMaterialesAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoMateriales->nro_doc = $Publico->nro_doc;
    ...
    public function convocatorias2Action()
    {
        ...
        $archivo_solicitud = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_solicitud <> ''",
            ]
        );
        ...
        $archivo_silabo = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_silabo <> ''",
            ]
        );
        ...
        $archivo_dni = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_dni <> ''",
            ]
        );
        ...
        $archivo_dj = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_dj <> ''",
            ]
        );
        ...
        $archivo_colegiatura = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_colegiatura <> ''",
            ]
        );
        ...
        $archivo_habilitacion = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_habilitacion <> ''",
            ]
        );
        ...
        $archivo_cti = ConvocatoriasPublico::count(
            [
                "publico = $Publico->codigo AND convocatoria = $convocatoria_m->id_convocatoria AND archivo_cti <> ''",
            ]
        );
    ...
    {
        $this->assets->addJs("adminpanel/js/modulos/gestionconvocatorias.datosgenerales.js?v" . uniqid());
        $id_publico = $this->session->get("auth")["codigo"];
        $convocatoria = Convocatorias::findFirst("activo = 'M'");
    ...
    public function saveDatosGeneralesAction()
    {
    ...
    public function datatableExcepcionesAction()
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            tipodepublicaciones.numero = 136 AND public.tbl_web_publico_excepciones.publico = $id_publico) AS temporal_table");
    ...
    public function saveExcepcionesAction()
    {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $Publico = Publico::findFirstBycodigo($this->session->get("auth")["codigo"]);
                $PublicoExcepciones->nro_doc = $Publico->nro_doc;
