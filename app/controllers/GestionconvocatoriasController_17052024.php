...
class GestionconvocatoriasController extends ControllerPanel
{
    ...
    public function datatableValidarPagoAction() {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setSelect("voucher,codigo, convocatoria, fecha, archivo,  estado,  nomestado,nombredocente,nro_doc,mensaje,titulo");
...
SET estado=1,fechaatencion=now() where voucher='{$indice}'";
