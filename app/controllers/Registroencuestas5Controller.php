<?php
class Registroencuestas5Controller extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/registroencuestas5.js?v=" . uniqid());
    }
    ...
    public function registroAction()
    {
        ...
        WHERE
        public.tbl_enc_encuestas.id_encuesta = 5 AND public.tbl_enc_encuestas_alumnos.id_alumno = '$id_alumno' AND public.tbl_enc_encuestas_alumnos.id_semestre = $semestre_a->codigo";
        ...
        if (count($verifica) > 0) {
            return $this->response->redirect("registroencuestas5/fin");
        }
        ...
        //Modelo encuestas
        $encuesta = Encuestas::findFirst("estado = 'A' AND id_tipo_encuesta = '3' AND id_encuesta = 5");
        ...
        $tipo_de_pregunta = $this->modelsManager->createBuilder()
            ...
            ->where("Encuestas.id_encuesta = 5 AND TipoPreguntas.numero = 36")
        ...
        $preguntas = $this->modelsManager->createBuilder()
            ...
            ->join('EncuestasPreguntasRespuestas', 'EncuestasPreguntas.id_encuesta_pregunta = EncuestasPreguntasRespuestas.id_encuesta_pregunta')
            ->where("Encuestas.id_encuesta = 5 AND TipoPreguntas.numero = 36")
            ->groupBy('Encuestas.id_tipo_encuesta, EncuestasPreguntas.descripcion, TipoPreguntas.codigo,TipoPreguntas.nombres, EncuestasPreguntas.id_encuesta_pregunta, EncuestasPreguntas.numero')
        ...
        $encuestasRespuestasT = EncuestasRespuestasT::find("estado = 'A' AND id_encuesta = 5 ORDER BY orden ASC");
    ...
    public function finAction()
    {
        ...
        $tipo_de_pregunta = $this->modelsManager->createBuilder()
            ...
            // foreach ($tipo_de_pregunta as $value) {
            //     echo "<pre>";
            //     print_r("tipo: " . $value->nombres);
            // }
            // exit();
    
        $this->view->tipo_preguntas = $tipo_de_pregunta;

        $encuestasAlumnos = EncuestasAlumnos::findFirst("id_alumno = '$id_alumno' AND id_encuesta = 5");
        ...
        $preguntas = $this->modelsManager->createBuilder()
            ...
            ->where("Encuestas.id_encuesta = 5 AND TipoPreguntas.numero = 36 AND RespuestasAlumnos.id_encuesta_alumno = $encuestasAlumnos->id_encuesta_alumno")
            ->orderBy('EncuestasPreguntas.numero ASC')
            ->getQuery()
            ->execute();
        ...
        // print($encuestasAlumnos->recomendacion);
        // exit();
