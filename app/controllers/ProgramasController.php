...
class ProgramasController extends ControllerPanel {

    public function initialize() {
        $this->tag->setTitle('ADMIN');
        parent::initialize();

        $this->assets->addJs("adminpanel/js/modulos/programas.js?v=" . uniqid());
    }
    ...
    public function saveAction() {
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $carrera = Programas::findFirstBycodigo($id);
                $carrera = (!$carrera) ? new Programas() : $carrera;
    ...
    public function getAjaxAction() {
        $this->view->disable();
        if ($this->request->isPost() && $this->request->isAjax()) {
            $carrera = Programas::findFirstBycodigo((string) $this->request->getPost("id", "string"));
            if ($carrera) {
