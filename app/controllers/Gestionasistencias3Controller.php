<?php
class Gestionasistencias3Controller extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/gestionasistencias3.js?v=" . uniqid());
    }
    ...
    public function datatableAction($fecha_inicio = null, $fecha_fin = null)
    {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            WHERE
            public.tbl_web_personal_marcaciones.id_personal = $id_personal AND public.tbl_web_personal_marcaciones.estado = 'A' $where ORDER BY public.tbl_web_personal_marcaciones.fecha DESC) AS temporal_table");
