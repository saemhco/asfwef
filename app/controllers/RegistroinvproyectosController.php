...
class RegistroinvproyectosController extends ControllerPanel
{
    ...
    public function initialize()
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/registroinvproyectos.js?v=" . uniqid());
    }
    ...
    public function registroAction($id = null)
    {
        ...
        $this->assets->addJs("adminpanel/js/modulos/registroinvproyectos.usuarios.detalles.personal.js?v=" . uniqid());
        $this->assets->addJs("adminpanel/js/modulos/registroinvproyectos.usuarios.detalles.docentes.js?v=" . uniqid());
    }
...
//        echo "<pre>";
        ...
        if ($this->request->isPost() && $this->request->isAjax()) {
            try {
                ...
                $InvProyecto->lineas = $this->request->getPost("lineas", "string");
