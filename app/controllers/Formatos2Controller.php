...
class Formatos2Controller extends ControllerPanel {

    public function initialize() {
        $this->tag->setTitle('ADMIN');
        parent::initialize();

        $this->assets->addJs("adminpanel/js/modulos/formatos2.js?v=" . uniqid());
    }
    ...
    public function datatableAction() {
        ...
        if ($this->request->isPOST() && $this->request->isAjax()) {
            ...
            $datatable->setWhere("usuarios_detalles.id_usuario ={$id_usuario} AND usuarios_detalles.tabla = 'tbl_lic_formatos' AND formatos.estado = 'A' AND usuarios_detalles.tipo = 2");
