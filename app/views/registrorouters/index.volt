...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Mantenimientos</li><li>Routers</li>
    </ol>
</div>
<!-- END RIBBON -->		
...
<div id="content">
                            ...
                            <div class="jarviswidget" id="wid-id-0" 
                                ...
                                <div>
                                    ...
                                    <div class="widget-body no-padding">										
                                        ...
                                        <table id="tbl_routers" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                            <thead>			                
                                                <tr>
    ...
    {{ form('registrorouters/save','method': 'post','id':'form_routers','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
    <fieldset>
        <div class="row">
            <section class="col col-md-6">
                ...
                <label class="select">
                    <select id="input-tipo"  name="tipo" >
                        ...
                        {% for tiporouters_select in tiporouters %}                                       
                            <option value="{{ tiporouters_select.codigo }}">{{ tiporouters_select.nombres }}</option>                                       
                        {% endfor %}
                    </select> <i></i> 
                </label>
            </section>
        ...
        <div class="row">
            <section class="col col-md-6">
                ...
                <label class="input"> <i class="icon-prepend fa fa-desktop"></i>
                    ...
                    <input type="hidden" id="input-id_router" name="id_router" value="">                           
                </label>
            </section> 
            <section class="col col-md-6">
        ...
        <div class="row">
            <section class="col col-md-6">
                <label class="text-info">MAC</label>
                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                    <input type="text" name="mac" id="input-mac" placeholder="">
                </label>
            </section>
        </div>
