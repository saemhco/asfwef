                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>PROCESO DE ADMISIÓN - {{admision_m.definicion}} </h2>
                            </header>
                                ...
                                <table class="table table-sm table-primary table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="40%">
                                                {{ admision.nro_documento }}<br> <a class="btn btn-success btn-sm" target="_BLANK" role="button" href="{{ url('adminpanel/imagenes/imagenes_admision/'~admision.imagen) }}" >  <i class="fa-fw fa fa-eye"></i></a>
                                            </td>
                                        </tr>
