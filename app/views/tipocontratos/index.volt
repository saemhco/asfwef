<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Tipos de Contrato</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro de Tipos de Contrato</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_tipocontratos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
...
{{ form('tipocontratos/save','method': 'post','id':'form_tipocontratos','class':'smart-form') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-descripcion" name="descripcion" placeholder="Descripcion" >
                <input type="hidden" id="input-tc_id" name="tc_id" value="">
            </label>
        </section>
    </div>    
</fieldset>
