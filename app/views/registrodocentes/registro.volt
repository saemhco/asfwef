...
{% if docentes.colegio_profesional is defined %}
    {% set colegio_profesional = docentes.colegio_profesional %}
{% endif %}

{% set colegio_profesional_nro = "" %}
{% if docentes.colegio_profesional_nro is defined %}
    {% set colegio_profesional_nro = docentes.colegio_profesional_nro %}
{% endif %}

{% set grado_abreviado  = "" %}
{% if docentes.grado_abreviado  is defined %}
    {% set grado_abreviado  = docentes.grado_abreviado %}
{% endif %}

{% set enlace  = "" %}
{% if docentes.enlace  is defined %}
    {% set enlace  = docentes.enlace %}
{% endif %}
...
{% if docentes.categoria  is defined %}
    {% set categoria  = docentes.categoria %}
{% endif %}

{% set dedicacion = "" %}
{% if docentes.dedicacion  is defined %}
    {% set dedicacion  = docentes.dedicacion %}
{% endif %}

{% set condicion = "" %}
{% if docentes.condicion  is defined %}
    {% set condicion  = docentes.condicion %}
{% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registrodocentes/save','method': 'post','id':'form_docentes','class':'smart-form','enctype':'multipart/form-data') }}
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="checkbox">
                                                    {% if ley == 1 %}
                                                        <input type="checkbox" name="ley30220" value="{{ ley }}" id="ley" checked> 
                                                    {% else %}
                                                        <input type="checkbox" name="ley30220" value="{{ ley }}" id="ley">
                                                    {% endif %}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-nro_doc" name="nro_doc" placeholder="Nro. Documento" value="{{ nro_doc }}" >
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-at"></i>
                                                    <input type="text" id="input-email1" name="email1" placeholder="E-mail UNAAA" value="{{ email1 }}" >
                                        ...
                                        <div class="row">
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                    <input type="text" id="input-fecha_ingreso" name="fecha_ingreso" placeholder="Fecha de Ingreso" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_ingreso }}">
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-md-9">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-titulo" name="titulo" placeholder="Título profesional" value="{{ titulo }}" >
                                            ...
                                            <section class="col col-md-9">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-grado_mencion_mayor" name="grado_mencion_mayor" placeholder="Grado mención" value="{{ grado_mencion_mayor }}" >
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-grado_universidad_mayor" name="grado_universidad_mayor" placeholder="Grado Universidad" value="{{ grado_universidad_mayor }}" >
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-pais_universidad_mayor" name="pais_universidad_mayor" placeholder="País Universidad" value="{{ pais_universidad_mayor }}" >
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="select">
                                                    <select id="input-gradom"  name="gradom" >
                                                        <option value="" >Seleccione...</option>
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="select">
                                                    <select id="input-grado_otro"  name="grado_otro" >
                                                        <option value="" >Seleccione...</option>
                                                        {% for grado in grados %}
                                            ...
                                            <section class="col col-md-9">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-grado_mencion_otro" name="grado_mencion_otro" placeholder="Grado mención otro" value="{{ grado_mencion_otro }}" >
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-grado_universidad_otro" name="grado_universidad_otro" placeholder="Grado Universidad otro" value="{{ grado_universidad_otro }}" >
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-pais_universidad_otro" name="pais_universidad_otro" placeholder="País Universidad Otro" value="{{ pais_universidad_otro }}" >
                                                ...
                                                <label class="select">
                                                    <select id="input-condicion"  name="condicion" >
                                                        ...
                                                        {% for condicion_select in condiciones %}
                                                            {% if condicion_select.codigo == condicion %}
                                                                <option selected="selected" value="{{ condicion_select.codigo }}">{{ condicion_select.nombres }}</option>   
                                                            {% else %}
                                                                <option value="{{ condicion_select.codigo }}">{{ condicion_select.nombres }}</option>   
                                                            {% endif %}
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="select">
                                                    <select id="input-categoria"  name="categoria" >
                                                        <option value="" >Seleccione...</option>
                                                        {% for categoria_select in categorias %}
                                                            {% if categoria_select.codigo == categoria %}
                                                                <option selected="selected" value="{{ categoria_select.codigo }}">{{ categoria_select.nombres }}</option>   
                                                            {% else %}
                                                                <option value="{{ categoria_select.codigo }}">{{ categoria_select.nombres }}</option>   
                                                            {% endif %}
                                            ...
                                            <section class="col col-md-4">
                                                <label class="text-info" >Dedicación</label>
                                                <label class="select">
                                                    <select id="input-dedicacion"  name="dedicacion" >
                                                        <option value="" >Seleccione...</option>
                                                        {% for dedicacion_select in dedicaciones %}
                                                            {% if dedicacion_select.codigo == dedicacion %}
                                                                <option selected="selected" value="{{ dedicacion_select.codigo }}">{{ dedicacion_select.nombres }}</option>   
                                                            {% else %}
                                                                <option value="{{ dedicacion_select.codigo }}">{{ dedicacion_select.nombres }}</option>   
                                                            {% endif %}
                                            ...
                                            <section class="col col-md-3">
                                                <label class="checkbox">
                                                    ...
                                                    {% if titulo_universitario == 1 %}
                                                        <input type="checkbox" name="titulo_universitario" value="{{ titulo_universitario }}" id="titulo_universitario" checked> 
                                                    {% else %}
                                                        <input type="checkbox" name="titulo_universitario" value="{{ titulo_universitario }}" id="titulo_universitario">
                                                    {% endif %}
                                            ...
                                            <section class="col col-md-3">
                                                <label class="checkbox">
                                                    ...
                                                    {% if maestria == 1 %}
                                                        <input type="checkbox" name="maestria" value="{{ maestria }}" id="maestria" checked> 
                                                    {% else %}
                                                        <input type="checkbox" name="maestria" value="{{ maestria }}" id="maestria">
                                                    {% endif %}
                                            ...
                                            <section class="col col-md-3">
                                                <label class="checkbox">
                                                    {% if doctorado == 1 %}
                                                        <input type="checkbox" name="doctorado" value="{{ doctorado }}" id="doctorado" checked> 
                                                    {% else %}
                                                        <input type="checkbox" name="doctorado" value="{{ doctorado }}" id="doctorado">
                                                    {% endif %}
                                                    <i></i>Doctorado
                                            ...
                                            <section class="col col-md-3">
                                                <label class="checkbox">
                                                    {% if dina == 1 %}
                                                        <input type="checkbox" name="dina" value="{{ dina }}" id="dina" checked> 
                                                    {% else %}
                                                        <input type="checkbox" name="dina" value="{{ dina }}" id="dina">
                                                    {% endif %}
