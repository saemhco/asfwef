        ...
        <div id="ms-preload" class="ms-preload">
         ...
         <div class="container container-full-blue">
          ...
          <div class="container">                    
            ...
            <a  href="#" class="btn-circle btn-circle-white animated zoomInDown animation-delay-7"><i class="zmdi zmdi-email-open"></i></a><label style="font-size: 13px;"> admision@unca.edu.pe </label>         
                ...
                <div class="container container-full">
                  <div class="ms-title">
                    <a href="admision">
                      ...
                      {{ image("https://www.unca.edu.pe/webpage/assets/img/logo_admision_unca.png", "alt":"UNCA") }}
                      <!--
...
-->  
              ...
              <nav class="navbar navbar-expand-md navbar-static ms-navbar ms-navbar-white " style="height: 50px;margin-bottom:0px!important;">
                <div class="container container-full" style="">
                  ...
                  <div class="responsive-logo">
                      {{ image("https://www.unca.edu.pe/webpage/assets/img/logo_admision_unca_sunedu.png", "alt":"UNCA","width":"350") }}
                  ...
                  <div class="navbar-header">
                    <div>
                      ...
                      {{ image("https://www.unca.edu.pe/webpage/assets/img/logo_admision_unca_sunedu.png", "alt":"UNCA","id":"unca-logo", "class":"img-responsive") }}
                  ...
                  <div class="collapse navbar-collapse" id="ms-navbar">
                    <ul class="navbar-nav" style="width: 1010px;">
                      <li class="nav-item dropdown dropdown-megamenu-container">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle animated fadeIn animation-delay-7" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-name="component"><i class="fa fa-university"></i>&nbsp;Admisión 2024 - I<i class="zmdi zmdi-chevron-down"></i></a>
                            ...
                            <div class="row">
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInLeft animated-2x">
                                  <h3 class="megamenu-block-title">ADMISIÓN</h3>
                                  <ul class="megamenu-block-list">
                                        <li><a href="{{ url('presentacion-admision.html') }}"><i class="fa fa-caret-right"></i>Presentación </a></li>
                                        <li><a target="_blank" href="{{ url('unca-mision-vision.html') }}"><i class="fa fa-caret-right"></i>Misión y Visión </a></li>
                                        <li><a target="_blank" href="{{ url('web-comision-organizadora.html') }}"><i class="fa fa-caret-right"></i>Autoridades </a></li>
                                        <li><a target="_blank" href="{{ url('web-areas/'~'da'~".html") }}"><i class="fa fa-caret-right"></i>Dirección de Admisión </a></li>
                                        <li><a href="{{ url('comision-admision.html') }}"><i class="fa fa-caret-right"></i>Comisión de Admisión</a></li>	
                                        <li><a href="{{ url('perfil-estudiante.html') }}"><i class="fa fa-caret-right"></i>Perfil del Estudiante </a></li>	
                              ...
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInRight animated-2x">
                                  <h3 class="megamenu-block-title">MODALIDADES</h3>
                                  <ul class="megamenu-block-list">
                                        <li><a href="{{ url('modalidad-ordinario.html') }}"><i class="fa fa-caret-right"></i>Ordinario</a></li>
                                        <li><a href="{{ url('modalidad-extraordinario.html') }}"><i class="fa fa-caret-right"></i>Extraordinario</a></li>                                        
                              ...
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInRight animated-2x">
                                  <h3 class="megamenu-block-title">VACANTES Y CRONOGRAMA</h3>
                                  <ul class="megamenu-block-list">
                                        <li><a href="{{ url('vacantes.html') }}"><i class="fa fa-caret-right"></i>Cuadro de Vacantes</a></li>
                                        <li><a href="{{ url('cronograma.html') }}"><i class="fa fa-caret-right"></i>Cronograma de Actividades</a></li>                                        
                              ...
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInRight animated-2x">
                                  ...
                                  <ul class="megamenu-block-list">
                                    <li><a href="{{ url('documentos-admision.html') }}"><i class="fa fa-caret-right"></i>Documentos de Inscripción</a></li>    
                                    <li><a href="{{ url('proceso-admision.html') }}"><i class="fa fa-caret-right"></i>Proceso de Inscripción</a></li>
                                    <li><a href="{{ url('costos.html') }}"><i class="fa fa-caret-right"></i>Costos de Inscripción</a></li>                                                                                
                                  </ul>
                                </div>
                      ...
                      <li class="nav-item dropdown dropdown-megamenu-container">
                        <a href="javascript:void(0)" class="nav-link dropdown-toggle animated fadeIn animation-delay-7" data-toggle="dropdown" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-name="component"><i class="fa fa-book"></i>&nbsp;Exámen de Admisión 2024 - I<i class="zmdi zmdi-chevron-down"></i></a>
                        <ul class="dropdown-menu dropdown-megamenu animated fadeIn animated-2x">
                          <li class="container">
                            <div class="row">
                              <div class="col-sm-6 megamenu-col">
                                <div class="megamenu-block animated fadeInLeft animated-2x">
                                  <h3 class="megamenu-block-title">EXÁMEN DE ADMISIÓN</h3>
                                  <ul class="megamenu-block-list">
                                    <li><a href="{{ url('temario.html') }}"><i class="fa fa-caret-right"></i>Temario</a></li>
                                    <li><a href="{{ url('prospecto.html') }}"><i class="fa fa-caret-right"></i>Prospecto</a></li>     
                                    <li><a href="{{ url('examen-ordinario.html') }}"><i class="fa fa-caret-right"></i>Modalidad Ordinario</a></li>
                                    <li><a href="{{ url('examen-extraordinario.html') }}"><i class="fa fa-caret-right"></i>Modalidad Extraordinaria</a></li>
                                    <li><a href="{{ url('resultados.html') }}"><i class="fa fa-caret-right"></i>Resultados</a></li>
                              ...
                              <div class="col-sm-6 megamenu-col">
                                <div class="megamenu-block animated fadeInLeft animated-2x">
                                  ...
                                  <ul class="megamenu-block-list">
                                            <li><a href="{{ url('recomendaciones-examen.html') }}"><i class="fa fa-caret-right"></i>Recomendaciones a seguir</a></li>
                                            <li><a href="{{ url('preguntas-frecuentes.html') }}"><i class="fa fa-caret-right"></i>Preguntas Frecuentes</a></li>    
              ...
              ?>
              {% if  config.global.xAbrevIns  == 'UNCA' and re_uri=='/admision'  %}
