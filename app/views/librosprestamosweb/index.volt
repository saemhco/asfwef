    ...
    <div class="row">
        ...
        <section class="col col-md-12">
            <a class="btn bg-color-magenta txt-color-white btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_librosprestamosweb_pdf()" id="reporte_librosprestamosweb_pdf"><i
                    class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;&nbsp;Reporte Registro de prestamos web</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}
    ...
    <div class="row">
        ...
        <section class="col col-md-12">
            <a class="btn btn-success btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_librosprestamosweb_xls()" id="reporte_librosprestamosweb_xls"><i
                    class="fa fa-file-excel-o"></i>&nbsp;&nbsp;&nbsp;Reporte Registro de prestamos web</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}