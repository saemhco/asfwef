                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro Solicitudes de Becas</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_alumnos_solicitudes_becas" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
...
{{ form('gestionsolicitudes/saveRegistrosbecas','method': 'post','id':'form_alumnos_solicitudes_becas','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
    ...
    <div class="row">
        <section class="col col-md-12">
            <label class="text-info" >Solicitud de Becas</label>
            <label class="select">
                <select id="input_tipo"  name="tipo">
                    <option value="" >SELECCIONE...</option>
                    {% for t_s_a in tipo_solicitud_alumno_becas %}                                       
