...
{{ form('gestionsolicitudes/saveRegistrosacademicos','method': 'post','id':'form_alumnos_solicitudes','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
