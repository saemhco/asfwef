...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Providencias</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro de Providencias</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    <table id="tbl_fsc_providencias" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
...
{{ form('registrosecciones/save','method': 'post','id':'form_tbl_fsc_providencias','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                ...
                <input type="hidden" id="input-id_providencia" name="id_providencia" value="">
            </label>
        </section>
