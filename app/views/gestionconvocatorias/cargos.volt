			...
			<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
				...
				<div>
					...
					<div class="widget-body text-center">
						...
						<a href="javascript:void(0);" onclick="editar();" class="btn btn-warning btn-block">
							<i class="fa fa-edit"></i>
						</a>

						<a href="javascript:void(0);" onclick="eliminar();" class="btn btn-danger btn-block">
						...
						<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-custombutton="false" data-widget-sortable="false" data-widget-togglebutton="false">
							...
							<div>
								...
								<div class="widget-body no-padding">
									<fieldset>
										<div class="row">
											<section class="col col-md-12">
												<table id="tbl_web_publico_cargos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
													<thead>
														<tr>
															<th>
																<center>
									...
									<footer>
										<a href="javascript:history.back()" role="button" class="btn tbn-block btn-primary">
...
{{ form('gestionconvocatorias/saveCargos','method': 'post','id':'form_tbl_web_publico_cargos','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
	<fieldset>
		<div class="row">
			<section class="col col-md-3">
				<label class="text-info">Tipo</label>
				<label class="select">
					<select id="input-id_tipo_cargo" name="id_tipo_cargo">
						<option value="">SELECCIONE...</option>
						{% for tipocargos_select in tipocargos %}
							<option value="{{ tipocargos_select.codigo }}">{{ tipocargos_select.nombres }}
							</option>
						{% endfor %}
					</select>
					<i></i>
		...
		<div class="row">
			...
			<section class="col col-md-3" style="
				...
				<label class="checkbox">
					<input type="checkbox" name="hasta_la_fecha" id="hasta_la_fecha" >
					<i></i>Hasta la fecha</label>
			</section>
		</section>
	</div>
	...
	<div class="row">
		...
		<section class="col col-md-3">
			<label class="text-info">Tipo de Institución</label>
			<label class="select">
				<select id="input-tipo_institucion" name="tipo_institucion">
					<option value="">SELECCIONE...</option>
					{% for tipoinstitucion_select in tipoinstitucion %}
						<option value="{{ tipoinstitucion_select.codigo }}">{{ tipoinstitucion_select.nombres }}
						</option>
					{% endfor %}
				</select>
				<i></i>
		...
		<section class="col col-md-12">
			...
			<button type="button" class="btn btn-primary btn-block" data-toggle="collapse" data-target="#collpse_funciones">
				<i class="fa fa-hand-o-up"></i>
				Click Aquí para editar</button>
	...
	<div class="row">
		<section class="col col-md-6">
			...
			<div class="input input-file" id="input-archivo">
				...
				<span class="button"><input id="file-archivo" type="file" name="archivo" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i>
