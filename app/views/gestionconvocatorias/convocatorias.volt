...
{{ form('gestionconvocatorias/saveConvocatorias','method':
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;text-align: center;" width="25%">
                                <div class="form-group">
                                    ...
                                    <a href="https://www.unca.edu.pe/adminpanel/archivos/convocatorias/ANEXOS_CAS.docx" class="btn btn-warning btn-xs" download
    ...
    <div class="row">
        <section class="col col-md-12">
            ...
            <div class="input input-file" id="input-anexos">
                ...
                <span class="button"><input type="file" id="input-file-archivo" name="archivo"
                    onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');">Buscar</span><input type="text" id="input-file"
                    placeholder="Agregar Archivo (Archivo pdf, PDF menor a 10 MB)" readonly="" name="input-file">
