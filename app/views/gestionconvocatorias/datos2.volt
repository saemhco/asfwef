...
{% set nacionalidad = "" %}
{% if publico.nacionalidad is defined %}
    {% set nacionalidad = publico.nacionalidad %}
{% endif %}

{% set id_bonificacion = "" %}
{% if publico.id_bonificacion is defined %}
    {% set id_bonificacion = publico.id_bonificacion %}
{% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('gestionconvocatorias/saveDatos2','method': 'post','id':'form_publico','class':'smart-form','enctype':'multipart/form-data') }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-at"></i>
                                                    <input type="text" id="input-email" name="email"  placeholder="Email" value="{{email }}" readonly >                             
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-md-8">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-nacionalidad" name="nacionalidad"  placeholder="Nacionalidad" value="{{nacionalidad }}"  >                             
                                                </label>
                                            </section>
                                                    ...
                                                    <select id="input-id_bonificacion"  name="id_bonificacion">
                                                        ...
                                                        {% for tipobonificaciones_select in tipobonificaciones %}
                                                            {% if tipobonificaciones_select.codigo == id_bonificacion %}
                                                                <option selected="selected" value="{{ tipobonificaciones_select.codigo }}">{{ tipobonificaciones_select.nombres }}</option>   
                                                            {% else %}
                                                                <option value="{{ tipobonificaciones_select.codigo }}">{{ tipobonificaciones_select.nombres }}</option>   
                                                            {% endif %}
                                        ...
                                        <div class="row" id="input-archivos" style="display:none;">
                                            ...
                                            <section class="col col-md-12">
                                                ...
                                                <label class="text-info" style="margin-bottom: 10px !important;" id="label_archivo"></label>
                                                <div class="input input-file" id="input-archivos-file">

                                                    <input type="hidden" id="input-archivo" class="archivoFile">

                                                    <span class="button"><input id="archivo_dc" type="file" name="archivo_dc" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');" class="archivoFile"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-file" name="input-file"  placeholder="Agregar Archivo (Archivo pdf, PDF menor a 10 MB)" readonly="">
                                        ...
                                        <div class="row" >
                                            <section class="col col-md-4">
                                                <label class="text-info" >Régimen de Dedicación :</label>
                                                <label class="select">
                                                    <select id="input-id_bonificacion"  disabled="disabled">
