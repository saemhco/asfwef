...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>de Excepciones</li>
    </ol>
</div>
<!-- END RIBBON -->		
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12" >
                                                <table id="tbl_web_publico_excepciones" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                                    <thead>			                
                                                        <tr>
...
{{ form('gestionconvocatorias/saveExcepciones','method': 'post','id':'form_tbl_web_publico_excepciones','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">

        <section class="col col-md-4">
            <label class="text-info" >Tipo de Excepcion</label>
            <label class="select">
                <select id="input-id_tipo_excepcion"  name="id_tipo_excepcion" >
        ...
        <section class="col col-md-4" >
            ...
            <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                <input type="text" id="input-fecha_excepcion" name="fecha_excepcion" placeholder="Fecha" class="datepicker" data-dateformat='dd/mm/yy' value="">
            </label>
        </section>
        ...
        <section class="col col-md-6">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-institucion" name="institucion" placeholder="Institucion" value="">
            </label>
        </section>
