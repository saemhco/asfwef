            ...
            <table class="table table-sm table-primary table-bordered">
                ...
                <tbody>
                    <tr>
                                            <td>
                                                <center>
                                                    <h1 style="color: #3276b1;font-weight: bold;">REGISTRO DE DATOS DE PAGOS</h1>
                                                </center>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="center-block" style="margin-bottom: 20px; margin-top: 20px;">
                                                    {{ form('gestionsolicitudes/saveRegistrosacademicos','method': 'post','id':'form_alumnos_solicitudes','class':'smart-form','enctype':'multipart/form-data') }}
                                                    <fieldset>
                                                        <div class="row">
                            ...
                            <div class="center-block" style="margin-bottom: 20px;">
                                <a class="btn btn-block btn-lg btn-primary"
                                    href="{{ url('gestionconvocatorias/publicaciones') }}" style="width: 465px;margin: 0 auto;
                                       "> <i class="fa fa-book"></i> Trabajos de investigación y publicaciones</a>
                            </div>
                            ...
                            <div class="center-block" style="margin-bottom: 20px;">
                                <a class="btn btn-block btn-lg btn-primary"
                                    href="{{ url('gestionconvocatorias/extension') }}" style="width: 465px;margin: 0 auto;
                                       "> <i class="fa fa-book"></i> Actividades de Proyección Social y/o Extensión Cultural</a>
                            </div>
