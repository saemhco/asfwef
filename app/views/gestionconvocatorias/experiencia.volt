...
{{ form('gestionconvocatorias/saveExperiencia','method': 'post','id':'form_experiencia','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
            ...
            <label class="select">
                <select id="input-tipo_institucion"  name="tipo_institucion" >
                    ...
                    {% for tipoinstitucion_select in tipoinstitucion %}                                       
                        <option value="{{ tipoinstitucion_select.codigo }}">{{ tipoinstitucion_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
            </label>
        </section>
