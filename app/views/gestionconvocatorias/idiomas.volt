...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>Idiomas</li>
    </ol>
</div>
<!-- END RIBBON -->		
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12" >
                                                <table id="tbl_web_publico_idiomas" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                                    <thead>			                
                                                        <tr>
...
{{ form('gestionconvocatorias/saveIdiomas','method': 'post','id':'form_tbl_web_publico_idiomas','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-3">
            <label class="text-info" >Tipo</label>
            <label class="select">
                <select id="input-id_tipo_idioma"  name="id_tipo_idioma" >
                    <option value="">SELECCIONE...</option>
                    {% for tipoidiomas_select in tipoidiomas %}                                       
                        <option value="{{ tipoidiomas_select.codigo }}">{{ tipoidiomas_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
    ...
    <div class="row">
        <section class="col col-md-9">
            <label class="text-info" >Denominación del idioma</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
    ...
    <div class="row">
        ...
        <section class="col col-md-8">
            ...
            <label class="text-info" >Agregar Archivo (Documento que acredita el idioma)</label>
