...
{{ form('gestionconvocatorias/saveCapacitaciones','method': 'post','id':'form_capacitaciones','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-3">
            <label class="text-info" >Capacitación</label>
            <label class="select">
