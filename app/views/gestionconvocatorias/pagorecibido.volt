<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Gestión de Convalidacion</li><li>Validar pago docente</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Lista de voucher registrados</h2>
                            </header>
...
{{ form('gestionconvocatorias/saveGrabarVoucher','method': 'post','id':'form_subir_voucher_docente','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset id="frm_subir_documento">
