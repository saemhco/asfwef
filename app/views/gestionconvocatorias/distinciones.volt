...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>de Distinciones</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro de Distinciones</h2>
                            </header>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12" >
                                                <table id="tbl_web_publico_distinciones" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                                    <thead>			                
                                                        <tr>
...
{{ form('gestionconvocatorias/saveDistinciones','method': 'post','id':'form_tbl_web_publico_distinciones','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">

        <section class="col col-md-4">
            <label class="text-info" >Tipo de Distincion</label>
            <label class="select">
                <select id="input-id_tipo_distincion"  name="id_tipo_distincion" >
                    <option value="">SELECCIONE...</option>
                    {% for tipodistinciones_select in tipodistinciones %}                                       
                        <option value="{{ tipodistinciones_select.codigo }}">{{ tipodistinciones_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
