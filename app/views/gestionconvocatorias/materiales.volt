...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>de Materiales</li>
    </ol>
</div>
<!-- END RIBBON -->		
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12" >
                                                <table id="tbl_web_publico_materiales" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                                    <thead>			                
                                                        <tr>
...
{{ form('gestionconvocatorias/saveMateriales','method': 'post','id':'form_tbl_web_publico_materiales','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">

        <section class="col col-md-4">
            <label class="text-info" >Tipo de Material</label>
            <label class="select">
                <select id="input-id_tipo_material"  name="id_tipo_material" >
                    <option value="">SELECCIONE...</option>
                    {% for tipomateriales_select in tipomateriales %}                                       
                        <option value="{{ tipomateriales_select.codigo }}">{{ tipomateriales_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
