...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>Ofimatica</li>
    </ol>
</div>
<!-- END RIBBON -->		
...
<fieldset>
    ...
    <div class="row">
        <section class="col col-md-9">
            <label class="text-info" >Denominación de Ofimatica</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
    ...
    <div class="row">
        ...
        <section class="col col-md-8">
            ...
            <label class="text-info" >Agregar Archivo (Documento que acredita la ofimatica)</label>
