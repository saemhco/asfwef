						...
						<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-custombutton="false">
							...
							<div>
								...
								<div class="widget-body no-padding">
									{{ form('gestionconvocatorias/saveDatosGenerales3','method': 'post','id':'form_publico','class':'smart-form','enctype':'multipart/form-data') }}
										<fieldset>
											...
											<div class="row">
												...
												<section class="col col-md-6">
													...
													<label class="text-info">Solicitud de inscripción y postulación (Anexo 01)
													</label>
													<div class="input input-file">

														<span class="button"><input id="archivo_solicitud" type="file" name="archivo_solicitud" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i>
															Buscar
													...
													{% if archivo_solicitud !== ""   %}
														...
														<div class="alert alert-success fade in">
															...
															<a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/convocatorias_publico/'~archivo_solicitud) }}">
												...
												<section class="col col-md-6">
													...
													<div class="input input-file">
														...
														<span class="button"><input id="archivo_silabo" type="file" name="archivo_silabo" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i>
															Buscar</span><input type="text" id="input-file" name="input-file" placeholder="Agregar Archivo (Archivo pdf, PDF menor a 10 MB)" readonly="">
													...
													{% if archivo_silabo !== ""   %}
														...
														<div class="alert alert-success fade in">
															...
															Click aqui para ver el archivo
															<a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/convocatorias_publico/'~archivo_silabo) }}">
																<i class="fa-fw fa fa-book"></i>
															</a>
														</div>
												...
												<section class="col col-md-6">
													...
													<div class="input input-file">
														...
														<span class="button"><input id="archivo_dj" type="file" name="archivo_dj" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i>
															Buscar</span><input type="text" id="input-file" name="input-file" placeholder="Agregar Archivo (Archivo pdf, PDF menor a 10 MB)" readonly="">
													...
													{% if archivo_dj !== ""   %}
														...
														<div class="alert alert-success fade in">
															...
															Click aqui para ver el archivo
															<a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/convocatorias_publico/'~archivo_dj) }}">
																<i class="fa-fw fa fa-book"></i>
															</a>
														</div>
