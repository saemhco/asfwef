...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registro </li><li>Ofimática</li>
    </ol>
</div>
<!-- END RIBBON -->		
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12" >
                                                <table id="tbl_web_publico_ofimaticas" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                                    <thead>			                
                                                        <tr>
                                                            <th><center><i class="fa fa-check-circle"></i></center></th>
                                                    <th data-class="expand"> Especialidad</th>
                                                    <th data-hide="phone,tablet"> Denominación del curso</th>
...
{{ form('gestionconvocatorias/saveOfimaticas','method': 'post','id':'form_tbl_web_publico_ofimaticas','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-3">
            <label class="text-info" >Tipo</label>
            <label class="select">
                <select id="input-id_tipo_ofimatica"  name="id_tipo_ofimatica" >
                    <option value="">SELECCIONE...</option>
                    {% for tipoofimaticas_select in tipoofimaticas %}                                       
                        <option value="{{ tipoofimaticas_select.codigo }}">{{ tipoofimaticas_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
    ...
    <div class="row">
        <section class="col col-md-9">
            <label class="text-info" >Denominación de Ofimática</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
        ...
        <section class="col col-md-3">
            ...
            <label class="select">
                <select id="input-id_nivel"  name="id_nivel" >
                    <option value="">SELECCIONE...</option>
                    {% for niveles_select in niveles %}                                       
                        <option value="{{ niveles_select.codigo }}">{{ niveles_select.nombres }} </option>                                       
                    {% endfor %}
                </select> <i></i>
            </label>
        </section>
    ...
    <div class="row">
        ...
        <section class="col col-md-8">
            ...
            <label class="text-info" >Agregar Archivo (Documento que acredita la ofimática)</label>
