                                ...
                                <table class="table table-sm table-primary table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="20%"> {{ admision.monto_recibo }}</td>
...
<fieldset>
    <div class="row">
        <section class="col col-md-12">
                ...
                <center>
                    <img class="img-responsive" src="{{ url('adminpanel/imagenes/convocatorias_publico/recibos/'~convocatoria.id_convocatoria~'/'~admision.archivo_recibo) }}"
