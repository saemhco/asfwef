                    ...
                    <tr>
                        <td>
                            <div class="center-block" style="margin-bottom: 20px; margin-top: 20px;">
                                <a class="btn btn-block btn-lg btn-primary" href="{{ url('registrocv/datos') }}" style="width: 300px;margin: 0 auto;
                                   "> <i class="fa fa-user"></i> Datos Personales</a>
                            </div>
                            <div class="center-block" style="margin-bottom: 20px;">
                                <a class="btn btn-block btn-lg btn-primary" href="{{ url('registrocv/formacion') }}" style="width: 300px;margin: 0 auto;
                                   "> <i class="fa fa-graduation-cap"></i> Formación Académica</a>
                            </div>
                            <div class="center-block" style="margin-bottom: 20px;">
                                <a class="btn btn-block btn-lg btn-primary" href="{{ url('registrocv/capacitaciones') }}" style="width: 300px;margin: 0 auto;
                                   "> <i class="fa fa-book"></i> Capacitaciones</a>
                            </div>

                            <div class="center-block" style="margin-bottom: 20px;">
                                <a class="btn btn-block btn-lg btn-primary" href="{{ url('registrocv/experiencia') }}" style="width: 300px;margin: 0 auto;
