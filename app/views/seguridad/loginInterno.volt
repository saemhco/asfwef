								...
								<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="{{ url() }}adminpanel/login_vendor/images/home_gestion_administrativa.png" class="d-block w-100" alt="..." style="background: #416cdc;">
										</div>
										<!--
								...
								<div class="mt-5 va-middle">
									<form method="POST" id="login-form">
										...
										<div class="mb-4 mt-2">
											...
											<input type="text" class="form-control" id="username" name="nro_doc" placeholder="Número de DNI" autocomplete="off"/>
										</div>
										<div class="mb-4 ">
