...
<html lang="en">
	...
	<body>
								...
								<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="{{ url() }}adminpanel/login_vendor/images/home_gestion_superior.png" class="d-block w-100" alt="..." style="background: #416cdc;">
										</div>
										<!--
		...
		<?php
		$tipo_rend = $_GET["tipo"];
		$url_rend = base64_decode($_GET["url"]);
		?>
		<script type="text/javascript">
			var urlPath = "{{ url() }}";
var base_url = "{{ url() }}";
var tipo_rend = "{{ tipo_rend }}";
var url_rend = "{{ url_rend }}";
		</script>
