					...
					<div class="contents">
						<div class="row align-items-center justify-content-center">
							<div class="col-md-8" style="background-color: white;padding: 20px;box-shadow: 5px 3px 36px grey;margin-top:30px;">
								<div class="float-right"><button type="button" data-toggle="modal" data-target="#infoModal"><i class="fa fa-question"></i></button></div><br>
								<div class="mb-2">
									<center>
										<h6>Sistema de Gestión Administrativa</h6>
										<h6>"RATIFICACIÓN DE DOCENTES"</h6>
									</center>
									<center>
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="row align-items-center justify-content-center">
								<div class="col-md-12">
									<p style="text-align: justify;color:black;">Bienvenidos al nuevo portal de Gestión de Ratificación de Docentes. La información que se consigne tiene carácter de Declaración Jurada, por lo que el postulante será responsable de la Información presentada.</p>
									<p style="text-align: justify;color:black;">Para más información sobre el procedimiento de postulación descargue<br></p>
									<p style="text-align: justify;color:black;">
										<a target="_blank" href="https://www.unca.edu.pe/adminpanel/archivos/documentos/manual-de-usuario-del-sistema-de-informacion-de-gestion-de-convocatorias-de-concurso-docente.pdf">
											<strong>Manual de usuario del Sistema de Gestión de Ratificación de Docentes de la UNCA</strong>
										</a>
									</p>
								</div>
								<div class="col-md-12">
									...
									<h5>
										<p style="">
											<i class="fa fa-envelope"></i>&nbsp;&nbsp;&nbsp; Correo electrónico a:
											<a href="mailto:rsu@unca.edu.pe">rsu@unca.edu.pe</a>
										</p>
									</h5>
									<h5>
										<p style="text-align: justify;">
											<i class="fa fa-phone"></i>&nbsp;&nbsp;&nbsp; Teléfono: +51 044 365463</p>
									</h5>
								</div>
							</div>
						</div>
