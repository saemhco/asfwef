								...
								<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
									...
									<div class="carousel-inner">
										<div class="carousel-item active">
											<img src="{{ url() }}adminpanel/login_vendor/images/home_convocatorias_rsu.png" class="d-block w-100" alt="..." style="background: #416cdc;">
										</div>
										<!--
										...
										<div class="text-center mb-4">
											<p style="font-size: 16px;">
												<b>SISTEMA DE GESTIÓN ADMINISTRATIVA
													<br/><b style=" color: var(--primary);">"CONVOCATORIAS DE PROYECTOS DE RESPONSABILIDAD SOCIAL UNIVERSITARIA"</b>
												</b>
											</p>
										</div>
										<div class="mb-4 mt-2">
						...
						<div class="row align-items-center justify-content-center">
							<div class="col-md-12">
								<p style="text-align: justify;">
									Bienvenidos al nuevo portal de Gestión de Convocatoria de proyectos de responsabilidad social universitaria. La información que se consigne tiene carácter de Declaración Jurada, por lo que el postulante será responsable de la Información presentada.
								</p>
								<p style="text-align: justify;">Para más información sobre el procedimiento de postulación descargue
									...
									<a target="_blank" href="https://www.unca.edu.pe/adminpanel/archivos/documentos/manual-de-usuario-del-sistema-de-informacion-de-gestion-de-convocatorias-de-concurso-docente-460923.pdf">
										<strong>Manual de usuario del Sistema de Gestión de Convocatorias de proyectos de responsabilidad social universitaria</strong>
									</a>.</p>
							</div>
							<div class="col-md-12">
								<h5>
								...
								<p>
									...
									<a href="mailto:seleccion.docente@unca.edu.pe">rsu@unca.edu.pe</a>
								</p>
								<p style="text-align: justify;">
...
var base_url = "{{ url() }}";
		...
		<script src="{{ url() }}adminpanel/login_vendor/js/login_concurso_rsu/main.js"></script>
	</body>
