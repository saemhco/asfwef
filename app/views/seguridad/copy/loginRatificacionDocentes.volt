		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-7">
					<div class="row">
						<div class="col-md-12">
							<div id="image_rigth" style="background-image: url('{{ url() }}adminpanel/login_vendor/images/home.png');background-color:#4169e1;height:50vh;background-size: contain;background-repeat: no-repeat;background-position: center;"></div>
						</div>
					</div>
					<br/>
					<div class="row">
						<div class="col-md-7">
							<p style="text-align: justify;color:black;">Bienvenidos al nuevo portal de Gestión de Ratificación de Docentes. La información que se consigne tiene carácter de Declaración Jurada, por lo que el postulante será responsable de la Información presentada.
							...
							<p style="text-align: justify;color:black;">
								<a target="_blank" href="https://www.unca.edu.pe/adminpanel/archivos/documentos/manual-de-usuario-del-sistema-de-informacion-de-gestion-de-convocatorias-de-concurso-docente.pdf">
									<strong>
										Manual de usuario del Sistema de Gestión de Ratificación de Docentes de la UNCA</strong>
								</a>
							</p>
						</div>
						<div class="col-md-5">
