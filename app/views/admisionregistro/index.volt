                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>PROCESO DE ADMISIÓN - {{semestre_admision.definicion}} </h2>
                            </header>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    {{ form('admisionregistro/save','method': 'post','id':'form_admisionproceso','class':'smart-form','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4" >
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                    <input type="text" id="input_fecha_inscripcion" name="fecha_inscripcion" placeholder="" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_actual }}">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-list-ol"></i>
                                                    <input type="text" id="input_nro_documento" name="nro_documento" placeholder="" value="">
