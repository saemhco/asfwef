<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Recursos TIC</li>
    </ol>
</div>
<!-- END RIBBON -->		
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_recursos_tic" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
                                              

                                        <th data-class="expand">Área</th>
                                        <th>Tipo</th>
    ...
    <div class="row">
        <section class="col col-md-12">
            <a class="btn bg-color-magenta txt-color-white btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_consultarecursostic_pdf()" id="consultarecursostic"><i
                    class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;&nbsp;Reporte de Recursos Informaticos Aisgnados</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}
    ...
    <div class="row">
        <section class="col col-md-12">
            <a class="btn btn-success btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_consultarecursostic_xls()" id="reporte_consultarecursostic_xls"><i
                    class="fa fa-file-excel-o"></i>&nbsp;&nbsp;&nbsp;Reporte de Recursos Informaticos Aisgnados</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}
