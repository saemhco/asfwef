            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">								
                ...
                <div>
                    ...
                    <div class="widget-body text-center">
                        <a href="{{ url('registroempresas/registro') }}" class="btn btn-primary btn-block"><i class="fa fa-plus"></i></a>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_empresas" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
...
<script type="text/javascript" >
    ...
    {% if region_id is defined %}
        var region_id = {{ region_id }};
    {% else %}
        var region_id = "";
    {% endif %}

    {% if provincia_id is defined %}
        var provincia_id = {{ provincia_id }};
    {% else %}
        var provincia_id = "";
    {% endif %}

    {% if distrito_id is defined %}
