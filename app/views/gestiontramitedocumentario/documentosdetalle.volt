                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    <div class="widget-body-toolbar">
                                        <div class="row">
                                            <div class="col-sm-6 text-center">
                                                <a href="javascript:void(0);" onclick="reporte_documentosdetalle_pdf();"
                                            ...
                                            <div class="col-sm-6 text-center">
                                                <a href="javascript:void(0);" onclick="reporte_documentosdetalle_xls()"
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12">
                                                <table id="tbl_documento_detalle"
                                    ...
                                    <footer>
                                        <a href="{{ url('gestiontramitedocumentario/documentosrecibidos') }}" role="button"
...
{{ form('gestiontramitedocumentario/saveDocumentosDetalles','method':
...
<fieldset>
    ...
    <div class="row">
        ...
        <section class="col col-md-6">
            <label class="text-info">Proveido</label>
            <label class="select">
                <select id="input-id_proveido" name="id_proveido">
                    <option value="">Proveido</option>
                    {% for proveidos_select in proveidos %}
                    <option value="{{ proveidos_select.codigo }}">{{ proveidos_select.nombres }}</option>
                    {% endfor %}
                </select> <i></i>
            </label>

            <input type="hidden" id="input-id_doc_detalle" name="id_doc_detalle" value="">
            <input type="hidden" id="input-id_doc" name="id_doc" value="{{ iddoc }}">
        </section>


        <section class="col col-md-12">
            <label class="text-info">Personal - Cargo - Área</label>
            
                <select type="text" id="input-id_personal_area" name="id_personal_area"
                style="width:100%">
                <option value="">SELECCIONE...</option>
                {% for personal_select in personal %}
                <option value="{{ personal_select.id_personal_area }}"> 
                    {{personal_select.personal }} - {{personal_select.cargo }} - {{personal_select.area }}
                </option>
                {% endfor %}
            </select> <i></i>
        ...
        <section class="col col-md-12">
            <label class="text-info">Proveido descripción</label>
            <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                <textarea rows="8" id="input-proveido_descripcion" name="proveido_descripcion"
    ...
    <div class="row">
        ...
        <section class="col col-md-12">
            <a class="btn bg-color-magenta txt-color-white btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_gestiontramitedocumentario_documentosdetalle_pdf()" id="reporte_librosprestamos_pdf"><i
                    class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;&nbsp;Reporte Registro de documentos detalles</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}
    ...
    <div class="row">
        ...
        <section class="col col-md-12">
            <a class="btn btn-success btn-sm btn-block" href="javascript:void(0);"
                onclick="reporte_gestiontramitedocumentario_documentosdetalle_xls()" id="reporte_librosprestamos_xls"><i
                    class="fa fa-file-excel-o"></i>&nbsp;&nbsp;&nbsp;Reporte Registro de documentos detalles</a>
        </section>
    </div>
</fieldset>
{{ endForm() }}
