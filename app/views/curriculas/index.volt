...
{{ form('curriculas/save','method': 'post','id':'form_curriculas','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-codigo" name="codigo" placeholder="Codigo" readonly="">
        ...
        <section class="col col-md-12">
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-abreviatura" name="abreviatura" placeholder="Nombre del Programa" >
            </label>
        </section>
        <section class="col col-md-12">
            <label class="select">
