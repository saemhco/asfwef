                                                ...
                                                <ul id="myTab1" class="nav nav-tabs bordered">
                                                    ...
                                                    <li>
                                                        <a href="#s4" data-toggle="tab"><i
                                                                class="fa fa-fw fa-lg fa-edit"></i>Ficha Socio
                                                            Económica</a>
                                                    </li>

                                                    <li>
                                                        <a href="#s5" data-toggle="tab"><i
                                                                class="fa fa-fw fa-lg fa-edit"></i>Acceso a internet</a>
                                                    </li>

                                                    <li>
                                                        <a href="#s6" data-toggle="tab"><i
                                                                class="fa fa-fw fa-lg fa-edit"></i>Composición
                                                            Familiar</a>
                                                    </li>
                                                ...
                                                <div id="myTabContent1" class="tab-content">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Código de
                                                                        Estudiante</label>
                                                                    <label class="input"> <i
                                                                        ...
                                                                        <input type="hidden" id="input-semestre_select"
                                                                            name="semestre_select" value="">
                                                                    </label>
                                                                </section>
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input_modalidad_ingreso"
                                                                            name="modalidad_ingreso" disabled>
                                                                            <option value="">SELECCIONE...</option>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i
                                                                        ...
                                                                        <input type="text" id="input-fecha_nacimiento"
                                                                            ...
                                                                            placeholder="Fecha de Nacimiento" class=""
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        {% else %}
                                                                        <input type="checkbox" name="activo"
                                                                            value="{{ activo }}" id="activo" disabled>
                                                                        {% endif %}
                                                    ...
                                                    <div class="tab-pane fade" id="s2">
                                                        <fieldset>
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="input"> <i
                                                                        ...
                                                                        <input type="text" id="input-fecha_ingreso"
                                                                            name="fecha_ingreso"
                                                                            placeholder="Fecha de Ingreso" class=""
                                                                            data-dateformat='dd/mm/yy'
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="input"> <i
                                                                        ...
                                                                        <input type="text" id="input-fecha_egreso"
                                                                            name="fecha_egreso"
                                                                            placeholder="Fecha de Egreso" class=""
                                                                            data-dateformat='dd/mm/yy'
                                                                            value="{{ fecha_egreso }}">
                                                                    </label>
                                                                </section>
                                                            ...
                                                            <div class="row">
                                                                <section class="col col-md-6">
                                                                    <label class="text-info">Modalidad de
                                                                        Estudios</label>
                                                                    <label class="select">
                                                                        <select id="input-modalidad_estudios"
                                                                            name="modalidad_estudios" disabled>
                                                                            <option value="">SELECCIONE...</option>
                                                                            {% for m_e in modalidadestudios %}
                                                                            {% if m_e.codigo == modalidad_estudios %}
                                                                            <option selected="selected"
                                                                                value="{{ m_e.codigo }}">{{ m_e.nombres
                                                                                }}</option>
                                                                            {% else %}
                                                                            <option value="{{ m_e.codigo }}">{{
                                                                                m_e.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-6">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input-local" name="local" disabled>
                                                                            ...
                                                                            <option selected="selected"
                                                                                value="{{ local_m.codigo }}">{{
                                                                                local_m.nombres }}</option>
                                                                            {% else %}
                                                                            <option value="{{ local_m.codigo }}">{{
                                                                                local_m.nombres }}</option>
                                                                            {% endif %}
                                                    ...
                                                    <div class="tab-pane fade" id="s3">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-12">
                                                                    <label class="text-info">Descripción del lugar
                                                                        actual</label>
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-map-pin"></i>
                                                                        <input type="text"
                                                                            id="input-descripcion_lugar_actual"
                                                                            name="descripcion_lugar_actual"
                                                                            placeholder="Descripción del lugar actual"
                                                                            value="{{ descripcion_lugar_actual }}">
                                                                    </label>
                                                                </section>
                                                            </div>
                                                        </fieldset>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-12">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-map-pin"></i>
                                                                        <input type="text"
                                                                            id="input-descripcion_lugar_origen"
                                                                            name="descripcion_lugar_origen"
                                                                            placeholder="Descripción del lugar origen"
                                                                            value="{{ descripcion_lugar_origen }}">
                                                                    </label>
                                                                </section>
                                                            </div>
                                                        </fieldset>
                                                    ...
                                                    <div class="tab-pane fade" id="s4">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input" style="margin-top: 10px;"> <i
                                                                            class="icon-prepend fa fa-hashtag"></i>
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input" style="margin-top: 10px;"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="input-talla" name="talla"
                                                                            placeholder="Talla" value="{{ talla }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input" style="margin-top: 10px;"> <i
                                                                        ...
                                                                        <input type="text" id="input-edad" name="edad"
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="es_padre_familia"
                                                                            value="{{ es_padre_familia }}"
                                                                            id="input-es_padre_familia" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="es_padre_familia"
                                                                            value="{{ es_padre_familia }}"
                                                                            id="input-es_padre_familia">
                                                                        {% endif %}
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-hashtag"></i>
                                                                        <input type="text" id="input-nro_hijos"
                                                                            name="nro_hijos"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Con quién vive tu
                                                                        hijo/a:</label>
                                                                    <label class="input" style="margin-top: 10px;"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-hijos_con_quien_viven"
                                                                            name="hijos_con_quien_viven"
                                                                            placeholder="Con quién vive tu hijo/a:"
                                                                            value="{{ hijos_con_quien_viven }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info"
                                                                        style="margin-bottom: 10px;">Celular Apoderado
                                                                        1</label>
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="input-celular_apoderado1"
                                                                            name="celular_apoderado1"
                                                                            placeholder="Celular Apoderado 1"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="input-celular_apoderado2"
                                                                            name="celular_apoderado2"
                                                                            placeholder="Celular Apoderado 2"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        {% if estudios_ayuda == 1 %}
                                                                        <input type="checkbox" name="estudios_ayuda"
                                                                            value="{{ estudios_ayuda }}"
                                                                            id="estudios_ayuda" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="estudios_ayuda"
                                                                            value="{{ estudios_ayuda }}"
                                                                            id="estudios_ayuda">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-estudios_ayuda_nombre"
                                                                            name="estudios_ayuda_nombre"
                                                                            placeholder="Persona que ayuda en estudios"
                                                                            value="{{ estudios_ayuda_nombre }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-6">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="sitrabaja_nombre"
                                                                            name="sitrabaja_nombre"
                                                                            placeholder="Lugar / Institución donde labora"
                                                                            value="{{ sitrabaja_nombre }}">
                                                                ...
                                                                <section class="col col-md-6" style="">
                                                                    ...
                                                                    <label class="input" style="margin-top: 10px;"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-sitrabaja_actividad"
                                                                            name="sitrabaja_actividad"
                                                                            placeholder="Actividad laboral"
                                                                            value="{{ sitrabaja_actividad }}">
                                                            ...
                                                            <div class="row">
                                                                <section class="col col-md-6">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="sidepende_nombre"
                                                                            name="sidepende_nombre"
                                                                            placeholder="Depende de ..."
                                                                            value="{{ sidepende_nombre }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-ingresos_papa"
                                                                            name="ingresos_papa"
                                                                            placeholder="Ingresos papa"
                                                                            value="{{ ingresos_papa }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-ingresos_mama"
                                                                            name="ingresos_mama"
                                                                            placeholder="Ingresos mama"
                                                                            value="{{ ingresos_mama }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-ingresos_hnos"
                                                                            name="ingresos_hnos"
                                                                            placeholder="Ingresos hermanos"
                                                                            value="{{ ingresos_hnos }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-ingresos_personal"
                                                                            name="ingresos_personal"
                                                                            placeholder="Ingresos Personal"
                                                                            value="{{ ingresos_personal }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_vivienda"
                                                                            name="egresos_vivienda"
                                                                            placeholder="Egresos Vivienda"
                                                                            value="{{ egresos_vivienda }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text"
                                                                            id="input-egresos_alimentacion"
                                                                            name="egresos_alimentacion"
                                                                            placeholder="Egresos Alimentacion"
                                                                            value="{{ egresos_alimentacion }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_luz"
                                                                            name="egresos_luz" placeholder="Egresos Luz"
                                                                            value="{{ egresos_luz }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_agua"
                                                                            name="egresos_agua"
                                                                            placeholder="Egresos Agua"
                                                                            value="{{ egresos_agua }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_cable_tv"
                                                                            name="egresos_cable_tv"
                                                                            placeholder="Egresos de Cable"
                                                                            value="{{ egresos_cable_tv }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_internet"
                                                                            name="egresos_internet"
                                                                            placeholder="Egresos de Internet"
                                                                            value="{{ egresos_internet }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_pasajes"
                                                                            name="egresos_pasajes"
                                                                            placeholder="Egresos de Pasajes"
                                                                            value="{{ egresos_pasajes }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_gas"
                                                                            name="egresos_gas" placeholder="Egresos Gas"
                                                                            value="{{ egresos_gas }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="text-info">Materiales de
                                                                        Estudio</label>
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text"
                                                                            id="input-egresos_materiales_estudio"
                                                                            name="egresos_materiales_estudio"
                                                                            placeholder="Egresos de Materiales"
                                                                            value="{{ egresos_materiales_estudio }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text"
                                                                            id="input-egresos_materiales_aseo"
                                                                            name="egresos_materiales_aseo"
                                                                            placeholder="Egresos de Aseo"
                                                                            value="{{ egresos_materiales_aseo }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_prestamos"
                                                                            name="egresos_prestamos"
                                                                            placeholder="Prestamos"
                                                                            value="{{ egresos_prestamos }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text"
                                                                            id="input-egresos_ocio_recreacion"
                                                                            name="egresos_ocio_recreacion"
                                                                            placeholder="Prestamos"
                                                                            value="{{ egresos_ocio_recreacion }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-dollar"></i>
                                                                        <input type="text" id="input-egresos_otros"
                                                                            name="egresos_otros"
                                                                            placeholder="Egresos Otros"
                                                                            value="{{ egresos_otros }}">
                                                                    </label>
                                                                </section>
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-clock-o"></i>
                                                                        <input type="text" id="input-estudios_horas"
                                                                            name="estudios_horas"
                                                                            placeholder="Horas de Estudio"
                                                                            value="{{ estudios_horas }}">
                                                                ...
                                                                <section class="col col-md-8">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-home"></i>
                                                                        <input type="text" id="input-estudios_lugar"
                                                                            name="estudios_lugar"
                                                                            placeholder="Horas de Estudio"
                                                                            value="{{ estudios_lugar }}">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-clock-o"></i>
                                                                        <input type="text"
                                                                            id="input-horas_ocio_recreacion"
                                                                            name="horas_ocio_recreacion"
                                                                            placeholder="Horas Recreación"
                                                                            value="{{ horas_ocio_recreacion }}">
                                                                    </label>
                                                                </section>
                                                                <section class="col col-md-12">
                                                                    <label class="text-info">Observaciones</label>
                                                                    <label class="textarea"> <i
                                                                            class="icon-append fa fa-comment"></i>
                                                                        <textarea rows="5"
                                                                            id="input-observaciones_ficha"
                                                                            name="observaciones_ficha">{{ observaciones_ficha }}</textarea>
                                                                    </label>
                                                                </section>
                                                            </div>
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="auto"
                                                                            value="{{ auto }}" id="input-auto" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="auto"
                                                                            value="{{ auto }}" id="input-auto">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="moto"
                                                                            value="{{ moto }}" id="input-moto" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="moto"
                                                                            value="{{ moto }}" id="input-moto">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="tv"
                                                                            value="{{ tv }}" id="input-tv" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="tv"
                                                                            value="{{ tv }}" id="input-tv">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="pc"
                                                                            value="{{ pc }}" id="input-pc" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="pc"
                                                                            value="{{ pc }}" id="input-pc">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if celular_ficha == 1 %}
                                                                        <input type="checkbox" name="celular_ficha"
                                                                            value="{{ celular_ficha }}"
                                                                            id="input-celular_ficha" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="celular_ficha"
                                                                            value="{{ celular_ficha }}"
                                                                            id="input-celular_ficha">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if hervidora == 1 %}
                                                                        <input type="checkbox" name="hervidora"
                                                                            value="{{ hervidora }}" id="input-hervidora"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="hervidora"
                                                                            value="{{ hervidora }}"
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if mesa == 1 %}
                                                                        <input type="checkbox" name="mesa"
                                                                            value="{{ mesa }}" id="input-mesa" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="mesa"
                                                                            value="{{ mesa }}" id="input-mesa">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if silla == 1 %}
                                                                        <input type="checkbox" name="silla"
                                                                            value="{{ silla }}" id="input-silla"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="silla"
                                                                            value="{{ silla }}" id="input-silla">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if cama == 1 %}
                                                                        <input type="checkbox" name="cama"
                                                                            value="{{ cama }}" id="input-cama" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="cama"
                                                                            value="{{ cama }}" id="input-cama">
                                                                        {% endif %}
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-hashtag"></i>
                                                                        <input type="text" id="input-nro_cuartos"
                                                                            name="nro_cuartos"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-hashtag"></i>
                                                                        <input type="text"
                                                                            id="input-nro_personas_cuarto"
                                                                            name="nro_personas_cuarto"
                                                                            placeholder="Número de Personas"
                                                                            value="{{ nro_personas_cuarto }}">
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input-vivienda" name="vivienda">
                                                                            ...
                                                                            <option selected="selected"
                                                                                value="{{ v.codigo }}">{{ v.nombres }}
                                                                            </option>
                                                                            {% else %}
                                                                            <option value="{{ v.codigo }}">{{ v.nombres
                                                                                }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input-vivienda_tipo"
                                                                            name="vivienda_tipo">
                                                                            <option value="">SELECCIONE...</option>
                                                                            {% for tv in tipoviviendas %}
                                                                            {% if tv.codigo == vivienda_tipo %}
                                                                            <option selected="selected"
                                                                                value="{{ tv.codigo }}">{{ tv.nombres }}
                                                                            </option>
                                                                            {% else %}
                                                                            <option value="{{ tv.codigo }}">{{
                                                                                tv.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Material de
                                                                        Vivienda</label>
                                                                    <label class="select">
                                                                        <select id="input-vivienda_material"
                                                                            name="vivienda_material">
                                                                            <option value="">SELECCIONE...</option>
                                                                            {% for mv in materialviviendas %}
                                                                            {% if mv.codigo == vivienda_material %}
                                                                            <option selected="selected"
                                                                                value="{{ mv.codigo }}">{{ mv.nombres }}
                                                                            </option>
                                                                            {% else %}
                                                                            <option value="{{ mv.codigo }}">{{
                                                                                mv.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Material Techo
                                                                        Vivienda</label>
                                                                    <label class="select">
                                                                        <select id="input-vivienda_material_techo"
                                                                            name="vivienda_material_techo">
                                                                            <option value="">SELECCIONE...</option>
                                                                            {% for mtv in materialtechoviviendas %}
                                                                            {% if mtv.codigo == vivienda_material_techo
                                                                            %}
                                                                            <option selected="selected"
                                                                                value="{{ mtv.codigo }}">{{ mtv.nombres
                                                                                }}</option>
                                                                            {% else %}
                                                                            <option value="{{ mtv.codigo }}">{{
                                                                                mtv.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Vivienda Mterial
                                                                        Piso</label>
                                                                    <label class="select">
                                                                        <select id="input-vivienda_material_piso"
                                                                            name="vivienda_material_piso">
                                                                            <option value="">SELECCIONE...</option>
                                                                            ...
                                                                            <option selected="selected"
                                                                                value="{{ v_m_p.codigo }}">{{
                                                                                v_m_p.nombres }}</option>
                                                                            {% else %}
                                                                            <option value="{{ v_m_p.codigo }}">{{
                                                                                v_m_p.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="text-info">Vivienda Mterial
                                                                        Pared</label>
                                                                    <label class="select">
                                                                        <select id="input-vivienda_material_pared"
                                                                            name="vivienda_material_pared">
                                                                            <option value="">SELECCIONE...</option>
                                                                            ...
                                                                            <option selected="selected"
                                                                                value="{{ v_m_pa.codigo }}">{{
                                                                                v_m_pa.nombres }}</option>
                                                                            {% else %}
                                                                            <option value="{{ v_m_pa.codigo }}">{{
                                                                                v_m_pa.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-hashtag"></i>
                                                                        <input type="text" id="input-nro_ambientes"
                                                                            name="nro_ambientes"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="otros_servicios"
                                                                            value="{{ otros_servicios }}"
                                                                            id="input-otros_servicios" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="otros_servicios"
                                                                            value="{{ otros_servicios }}"
                                                                            id="input-otros_servicios">
                                                                        {% endif %}
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-otros_servicios_descripcion"
                                                                            name="otros_servicios_descripcion"
                                                                            placeholder="Otros Servicios"
                                                                            value="{{ otros_servicios_descripcion }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if luz_ficha == 1 %}
                                                                        <input type="checkbox" name="luz_ficha"
                                                                            value="{{ luz_ficha }}" id="luz" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="luz_ficha"
                                                                            value="{{ luz_ficha }}" id="luz">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if agua_ficha == 1 %}
                                                                        <input type="checkbox" name="agua_ficha"
                                                                            value="{{ agua_ficha }}" id="agua" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="agua_ficha"
                                                                            value="{{ agua_ficha }}" id="agua">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if desague_ficha == 1 %}
                                                                        <input type="checkbox" name="desague_ficha"
                                                                            value="{{ desague_ficha }}" id="desague"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="desague_ficha"
                                                                            value="{{ desague_ficha }}" id="desague">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if telefono_ficha == 1 %}
                                                                        <input type="checkbox" name="telefono_ficha"
                                                                            value="{{ telefono_ficha }}" id="telefono"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="telefono_ficha"
                                                                            value="{{ telefono_ficha }}" id="telefono">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if cable_tv_ficha == 1 %}
                                                                        <input type="checkbox" name="cable_tv_ficha"
                                                                            value="{{ cable_tv_ficha }}" id="cable_tv"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="cable_tv_ficha"
                                                                            value="{{ cable_tv_ficha }}" id="cable_tv">
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        {% if internet_ficha == 1 %}
                                                                        <input type="checkbox" name="internet_ficha"
                                                                            value="{{ internet_ficha }}" id="internet"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="internet_ficha"
                                                                            value="{{ internet_ficha }}" id="internet">
                                                            ...
                                                            <div class="row">
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="beca_permanencia"
                                                                            value="{{ beca_permanencia }}"
                                                                            id="input-beca_permanencia" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="beca_permanencia"
                                                                            value="{{ beca_permanencia }}"
                                                                            id="inpu-beca_permanencia">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="beca_completa_alimentacion"
                                                                            value="{{ beca_completa_alimentacion }}"
                                                                            id="input-beca_completa_alimentacion"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="beca_completa_alimentacion"
                                                                            value="{{ beca_completa_alimentacion }}"
                                                                            id="inpu-beca_completa_alimentacion">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="subvencionada_alimentacion"
                                                                            value="{{ subvencionada_alimentacion }}"
                                                                            id="input-subvencionada_alimentacion"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="subvencionada_alimentacion"
                                                                            value="{{ subvencionada_alimentacion }}"
                                                                            id="inpu-subvencionada_alimentacion">
                                                                        {% endif %}
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-12">
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text" id="input-apreciacion"
                                                                            name="apreciacion" placeholder="Apreciación"
                                                                            value="{{ apreciacion }}">
                                                            ...
                                                            <div class="row">
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_celular"
                                                                            value="{{ acceso_internet_celular }}"
                                                                            id="input-acceso_internet_celular" checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_celular"
                                                                            value="{{ acceso_internet_celular }}"
                                                                            id="input-acceso_internet_celular">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_vivienda"
                                                                            value="{{ acceso_internet_vivienda }}"
                                                                            id="input-acceso_internet_vivienda" checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_vivienda"
                                                                            value="{{ acceso_internet_vivienda }}"
                                                                            id="input-acceso_internet_vivienda">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_cabina"
                                                                            value="{{ acceso_internet_cabina }}"
                                                                            id="input-acceso_internet_cabina" checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_cabina"
                                                                            value="{{ acceso_internet_cabina }}"
                                                                            id="input-acceso_internet_cabina">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_universidad"
                                                                            value="{{ acceso_internet_universidad }}"
                                                                            id="input-acceso_internet_universidad"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_universidad"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_otros"
                                                                            value="{{ acceso_internet_otros }}"
                                                                            id="input-acceso_internet_otros" checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="acceso_internet_otros"
                                                                            value="{{ acceso_internet_otros }}"
                                                                            id="input-acceso_internet_otros">
                                                                        {% endif %}
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-acceso_internet_otros_descripcion"
                                                                            name="acceso_internet_otros_descripcion"
                                                                            placeholder="Acceso internet otros"
                                                                            value="{{ acceso_internet_otros_descripcion }}">
                                                            ...
                                                            <div class="row">
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_laptop_propia"
                                                                            value="{{ uso_internet_laptop_propia }}"
                                                                            id="input-uso_internet_laptop_propia"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_laptop_propia"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_laptop_prestada"
                                                                            value="{{ uso_internet_laptop_prestada }}"
                                                                            id="input-uso_internet_laptop_prestada"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_laptop_prestada"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="uso_internet_pc"
                                                                            value="{{ uso_internet_pc }}"
                                                                            id="input-uso_internet_pc" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="uso_internet_pc"
                                                                            value="{{ uso_internet_pc }}"
                                                                            id="input-uso_internet_pc">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_plan"
                                                                            value="{{ uso_internet_celular_plan }}"
                                                                            id="input-uso_internet_celular_plan"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_plan"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_recarga"
                                                                            value="{{ uso_internet_celular_recarga }}"
                                                                            id="input-uso_internet_celular_recarga"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_recarga"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_prestado"
                                                                            value="{{ uso_internet_celular_prestado }}"
                                                                            id="input-uso_internet_celular_prestado"
                                                                            checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_celular_prestado"
                                                                ...
                                                                <section class="col col-md-4">
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox"
                                                                            name="uso_internet_tablet"
                                                                            value="{{ uso_internet_tablet }}"
                                                                            id="input-uso_internet_tablet" checked>
                                                                        {% else %}
                                                                        <input type="checkbox"
                                                                            name="uso_internet_tablet"
                                                                            value="{{ uso_internet_tablet }}"
                                                                            id="input-uso_internet_tablet">
                                                                        {% endif %}
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        <input type="checkbox" name="uso_internet_otros"
                                                                            value="{{ uso_internet_otros }}"
                                                                            id="input-uso_internet_otros" checked>
                                                                        {% else %}
                                                                        <input type="checkbox" name="uso_internet_otros"
                                                                            value="{{ uso_internet_otros }}"
                                                                            id="input-uso_internet_otros">
                                                                        {% endif %}
                                                                    ...
                                                                    <label class="input"> <i
                                                                            class="icon-prepend fa fa-edit"></i>
                                                                        <input type="text"
                                                                            id="input-uso_internet_otros_descripcion"
                                                                            name="uso_internet_otros_descripcion"
                                                                            placeholder="Uso internet otros"
                                                                            value="{{ uso_internet_otros_descripcion }}">
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input-composicion"
                                                                            name="composicion">
                                                                            <option value="">SELECCIONE...</option>
                                                                            {% for cf in composiciones %}
                                                                            {% if cf.codigo == composicion %}
                                                                            <option selected="selected"
                                                                                value="{{ cf.codigo }}">{{ cf.nombres }}
                                                                            </option>
                                                                            {% else %}
                                                                            <option value="{{ cf.codigo }}">{{
                                                                                cf.nombres }}</option>
                                                                            {% endif %}
                                                                ...
                                                                <section class="col col-md-1">
                                                                    <a style="margin-top: 18px; height: 33px;"
                                                                        href="javascript:void(0);" onclick="agregar()"
                                                                ...
                                                                <section class="col col-md-1">
                                                                    <a style="margin-top: 18px; height: 33px;"
                                                                        href="javascript:void(0);" onclick="editar()"
                                                                ...
                                                                <section class="col col-md-12">
                                                                    <table id="tbl_alumnos_familiares"
                                                                        class="table tablecuriosity table-striped table-hover"
                                                                        width="100%">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>
                                                                                ...
                                                                                <th data-hide="phone,tablet">Apellido
                                                                                    Materno</th>
                                                                                <th data-hide="phone,tablet">Nombres
                                                                                </th>
                                                                                <th data-hide="phone,tablet">Edad</th>
                                                                                <th data-hide="phone,tablet">Estado
                                                                                    Civil</th>
                                                                                <th data-hide="phone,tablet">Grado de
                                                                                    Instrucción</th>
                                                                                <th data-hide="phone,tablet">Ocupación
                                                                                </th>
...
{{ form('alumnosficha/saveFamiliares','method':
'post','id':'form_alumnos_familiares','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-3">
        ...
        <section class="col col-md-3">
            <label class="text-info">Apellido Paterno</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-apellido_paterno_familiares" name="apellido_paterno_familiares"
                    placeholder="Apellido Paterno">
        ...
        <section class="col col-md-3">
            <label class="text-info">Apellido Materno</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-apellido_materno_familiares" name="apellido_materno_familiares"
                    placeholder="Apellido Materno">
        ...
        <section class="col col-md-3">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-lugar_centro_estudios_familiares" name="lugar_centro_estudios_familiares"
                    placeholder="Lugar centro de estudios / labora">
            </label>
        </section>
        <section class="col col-md-3">
        ...
        <section class="col col-md-3">
            ...
            <label class="input"> <i class="icon-append fa fa-calendar"></i>
                <input type="text" id="input-fecha_nacimiento_familiares" name="fecha_nacimiento_familiares"
                    placeholder="Fecha Nac." class="datepicker" data-dateformat='dd/mm/yy' value="">
            </label>
        </section>
        <section class="col col-md-3">
            <label class="text-info">Estado civil</label>
        ...
        <section class="col col-md-12">
            <label class="text-info">Observaciones</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-observaciones_familiares" name="observaciones_familiares"
        ...
        <section class="col col-md-6">
            ...
            <div class="input input-file" id="archivo_alumno_familiares_modal">
                ...
                <span class="button"><input id="archivo_personal_familiares" type="file" name="archivo"
                        ...
                        disabled><i class="fa fa-search"></i> Buscar</span><input type="text"
                    id="input-file_personal_familiares" name="input-file" placeholder="Agregar Archivo" readonly="">
        ...
        <section class="col col-md-3">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-enfermedad_nombre_familiares" name="enfermedad_nombre_familiares"
        ...
        <section class="col col-md-3">
            ...
            <label class="input" style="margin-top: 10px;"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-enfermedad_tiempo_familiares" name="enfermedad_tiempo_familiares"
        ...
        <section class="col col-md-3">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-tratamiento_lugar_familiares" name="tratamiento_lugar_familiares"
                    placeholder="Lugar Tratamiento">
        ...
        <section class="col col-md-3">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-discapacidad_nombre_familiares" name="discapacidad_nombre_familiares"
                    placeholder="Nombre discapacidad">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img class="img-responsive" src="{{ url('adminpanel/imagenes/alumnos_familiares/'~foto) }}"
                    error="this.onerror=null;this.src='';"></img>
            </div>
