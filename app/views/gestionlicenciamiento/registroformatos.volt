                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('gestionlicenciamiento/saveFormatos','method': 'post','id':'form_formatos','class':'smart-form','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-id_formato" name="id_formato"  placeholder="Código" value="{{id_formato }}"    {% if id_formato !== "" %} readonly="" {% endif %} >                             
                                                </label>
