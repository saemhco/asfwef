                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registroalumnos/save','method': 'post','id':'form_alumnos','class':'smart-form','enctype':'multipart/form-data')  }}
                                                        ...
                                                        <fieldset>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-4">
                                                                    ...
                                                                    <label class="input"> <i class="icon-prepend fa fa-at"></i>
                                                                        <input type="text" id="input-email1" name="email1" placeholder="Correo UNAAA" value="{{ email1 }}" >
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        {% if envio == 1 %}
                                                                            <input type="checkbox" name="envio" value="{{ envio }}" id="envio" checked> 
                                                                        {% else %}
                                                                ...
                                                                <section class="col col-md-2">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        ...
                                                                        {% if activo == 1 %}
                                                                            <input type="checkbox" name="activo" value="{{ activo }}" id="activo" checked> 
                                                                        {% else %}
                                                                            <input type="checkbox" name="activo" value="{{ activo }}" id="activo">
                                                                        {% endif %}
                                                        ...
                                                        <fieldset>
                                                            <div class="row">
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        {% if graduado == 1 %}
                                                                            <input type="checkbox" name="graduado" value="{{ graduado }}" id="input-graduado" checked>
                                                                        {% else %}
                                                                            <input type="checkbox" name="graduado" value="{{ graduado }}" id="input-graduado">
                                                                        {% endif %}
                                                                        <i></i>Graduado</label>
                                                                </section>
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="checkbox">
                                                                        {% if titulado == 1 %}
                                                                            <input type="checkbox" name="titulado" value="{{ titulado }}" id="input-titulado" checked>
                                                                        {% else %}
                                                                            <input type="checkbox" name="titulado" value="{{ titulado }}" id="input-titulado">
                                                                        {% endif %}
                                                                        <i></i>Titulado</label>
                                                                </section>
                                                            ...
                                                            <div class="row"> 
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="select">
                                                                        <select id="input-semestre_egreso"  name="semestre_egreso" >
                                                                            <option value="" >Seleccione...</option>
                                                                            {% for semestre in semestres %}
                                                                ...
                                                                <section class="col col-md-3">
                                                                    ...
                                                                    <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                                        <input type="text" id="input-fecha_egreso" name="fecha_egreso" placeholder="Fecha de Egreso" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_egreso }}">
                                                                    </label>
                                                                </section>
