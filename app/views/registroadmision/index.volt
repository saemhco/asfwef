            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">								
                ...
                <div>
                    ...
                    <div class="widget-body text-center">
                        <a href="{{ url('registroadmision/registro') }}"  class="btn btn-primary btn-block"><i class="fa fa-plus"></i></a>
...
{{ form('registroadmision/save_parametros','method': 'post','id':'form_admision_parametros','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
