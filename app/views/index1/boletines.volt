            ...
            <div class="col-lg-3 col-md-6">
                <div class="card card-light-inverse">
                  <div class="withripple zoom-img" style="margin-top: 30px;">
                    <a target="_blank" href="{{ url('adminpanel/archivos/boletines/'~boletin.archivo) }}"><center>{{ image("adminpanel/imagenes/imagenes_boletines/"~boletin.imagen, "width":"258", "height":"172") }}</center></a>
                </div>
