<div class="col-md-12 col-sm-12 order-md-2 order-sm-2">    
    {% for convocatoria in convocatorias3 %} 
        <article>
            <div class="card card-light-inverse">
                <div class="card-body overflow-hidden overflow-hidden">
                    <div class="row">
                      <div class="col-xl-3">
                            <center>{{ image("adminpanel/imagenes/imagenes_convocatorias/"~convocatoria.imagen, "width":"250", "height":"130") }}</center>
                      </div>
                      <div class="col-xl-9">
                        <a href="{{ url('detalle-convocatoria/'~convocatoria.id_convocatoria~".html") }}" 
                            <h4>{{ utilidades.partedescripcion(convocatoria.titular,0,200)}} </h4>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-2 text-right">
                        <a href="{{ url('detalle-convocatoria/'~convocatoria.id_convocatoria~".html") }}" class="btn btn-primary btn-raised btn-block animate-icon">Leer Más ... <i class="ml-1 no-mr zmdi zmdi-long-arrow-right"></i></a>
                      </div>
                    </div>
                  </div>
            </div>
    ...
    {% endfor %}
    <center>
        <a href="convocatorias/3.html" class="btn btn-primary btn-raised text-right" role="button">
