...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Gestion de Encuestas</li>
    </ol>
</div>
<!-- END RIBBON -->		
              ...
              <center style="margin-top: -5px !important;">
                ...
                <div>
                    ...
                    <div class="widget-body text-center" style="margin-bottom: -55px;">
                        <a href="{{ url('registroencuestas1/registro') }}"  class="btn btn-primary btn-block"><i class="fa fa-plus"></i></a>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_alumnos_encuestas" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
                                        ...
                                        <th>Fecha</th>
                                        <th>Alumno (Código)</th>
                                        <th data-hide="phone,tablet">Asignatura</th>
                                        <th data-hide="phone,tablet">Grupo</th>
                                        <th data-hide="phone,tablet">Ciclo</th>
                                        <th data-hide="phone,tablet">Reporte</th>
