...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Medicamentos</li>
    </ol>
</div>
<!-- END RIBBON -->     
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">                                        
                                    ...
                                    <table id="tbl_medicamentos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>                         
                                            <tr>
...
{{ form('registromedicamentos/save','method': 'post','id':'form_medicamentos','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
