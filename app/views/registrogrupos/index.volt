            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">								
                ...
                <div>
                    ...
                    <div class="widget-body text-center" style="margin-bottom: -55px;">
                        ...
                        <a style="margin-bottom: 6px;" href="javascript:void(0);" onclick="detalle();" class="btn btn-primary btn-block" rel="tooltip" data-placement="top" data-original-title="Detalle Estudiantes"><i class="fa fa-list"></i></a>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_grupos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
                                                <th><center><i class="fa fa-check-circle"></i></center></th>

                                        <th data-class="expand">Tipo</th>
                                        <th data-class="">Descripcion</th>
...
{{ form('registrogrupos/save','method': 'post','id':'form_grupos','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">

        <section class="col col-md-12">
            <label class="text-info" >Tipo de usuarios</label>
            <label class="select">
                <select id="input-tipo"  name="tipo" >
                    <option value="" >SELECCIONE...</option>
                    {% for tipo_usuario_select in tipo_usuario %}                                       
                        <option value="{{ tipo_usuario_select.codigo }}">{{ tipo_usuario_select.nombres }}</option>                                       
                    {% endfor %}
                </select> <i></i> 
            </label>
        </section>  
        <section class="col col-md-12">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-nombre" name="nombre" placeholder="" value="" >
                <input type="hidden" id="input-id_grupo" name="id_grupo" value="">
            </label>
        </section>
