...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registrar Permiso Personal</li>
    </ol>
</div>
<!-- END RIBBON -->     
                            ...
                            <div>
                                ...
                                <table class="table table-sm table-primary table-bordered">
                                    <thead>
                                        <tr>
                                            <th colspan="5">
                                    <center>DATOS DEL PERSONAL </center>
                                    </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_personal_permisos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
                                                <th>
...
{{ form('personalpermisos/savePersonalPermisos','method': 'post','id':'form_personal_permisos','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        ...
        <section class="col col-md-6">
            ...
            <div class="input input-file" id="imagen_personal_permisos_modal">
                ...
                <label class="input">
                    ...
                    <span class="button"><input id="imagen_personal_permisos" type="file" name="imagen" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-image_personal_familiares" name="input-file"  placeholder="Agregar Imagen" readonly="">
                </label>
            </div>
