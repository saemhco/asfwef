                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-3" style="margin-top: 20px;">
                                            ...
                                            <section class="col col-md-12">
                                                ...
                                                <img class="img-responsive"
                                                    src="{{ url('adminpanel/imagenes/documentos/'~imagen) }}"
    ...
    <div class="row">
        ...
        <section class="col col-md-12">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                ...
                <input type="hidden" id="input-id_documento_archivo" name="id_documento_archivo" value="">
