...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Gestion de Horarios - Alumnos</li>
    </ol>
</div>
<!-- END RIBBON -->     
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">   
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>HORARIO ALUMNO - SEMESTRE {{ semestre.descripcion }}</h2>
                            </header>
                                                ...
                                                <tbody>
                                                    {% for hora in horas %} 
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,1) }}</center>
                                                            </td>
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,2) }}</center>
                                                            </td>
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,3) }}</center>
                                                            </td>
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,4) }}</center>
                                                            </td>
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,5) }}</center>
                                                            </td>
                                                            <td>
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,6) }}</center>
                                                            </td>
                                                          <!--  <td class="hide" >
                                                                <center>{{ registros.getHoraAlumnoTurno(semestre.codigo,hora.codigo,c_alumno,c_turno,7) }}</center>
                                                            </td> -->
                                                        </tr>
                                                    {% endfor %}    
                                                </tbody>
