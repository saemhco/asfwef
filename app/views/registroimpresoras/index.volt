...
{{ form('registroimpresoras/save','method':
'post','id':'form_impresoras','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-6">
            ...
            <label class="select">
                <select id="input-tipo" name="tipo">
                    ...
                    {% for tipoimpresoras_select in tipoimpresoras %}
                    <option value="{{ tipoimpresoras_select.codigo }}">{{ tipoimpresoras_select.nombres }}</option>
                    {% endfor %}
                </select> <i></i>
            </label>
        </section>
    ...
    <div class="row">
        <section class="col col-md-6">
            ...
            <label class="input"> <i class="icon-prepend fa fa-desktop"></i>
                ...
                <input type="hidden" id="input-id_impresora" name="id_impresora" value="">
            </label>
        </section>
        <section class="col col-md-6">
