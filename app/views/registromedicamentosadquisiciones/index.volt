...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Medicamentos Adquisiciones</li>
    </ol>
</div>
<!-- END RIBBON -->		
            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">								
                ...
                <div>
                    ...
                    <div class="widget-body text-center">
                        ...
                        <a href="{{ url('registromedicamentosadquisiciones/registro') }}"  class="btn btn-primary btn-block"><i class="fa fa-plus"></i></a>
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro Medicamentos Adquisiciones</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    <table id="tbl_dss_adquisiciones"
