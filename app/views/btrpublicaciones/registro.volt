...
{% if empleo.id_empleo is defined %}
{% set id_empleo = empleo.id_empleo %}
...
{% set fecha_creacion = ""%}
{% if empleo.fecha_creacion is defined %}
{% set fecha_creacion = utilidades.fechita(empleo.fecha_creacion,'d/m/Y') %}
{% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('btrpublicaciones/save','method': 'post','id':'form_empleos','class':'smart-form') }}
                                    <fieldset>
                                        <div class="row">
                                            <section class="col col-md-12">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-titulo" name="titulo" placeholder=""
                                                        value="{{ titulo }}">
                                                    <input type="hidden" id="input-id_empleo" name="id_empleo"
                                                        value="{{ id_empleo }}">
                                                </label>
                                            </section>
                                            <section class="col col-md-6">
                                                ...
                                                <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                                    <textarea rows="5" id="input-descripcion" name="descripcion"
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                                    <textarea rows="5" id="input-requisitos"
                                                        name="requisitosxd">{{ requisitos }}</textarea>
                                                </label>
                                            </section>
                                            <section class="col col-md-3">
                                                ...
                                                <label class="select">
                                                    <select id="input-region_id" name="region_id">
                                                        ...
                                                        <option selected="selected" value="{{ reg.region }}">
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-ubigeo_id" name="ubigeo_id"
                                                        placeholder="" value="{{ idubigeo }}" readonly>
                                                </label>
                                            </section>
                                            <section class="col col-md-3">
                                                <label class="text-info">Ciudad</label>
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    <input type="text" id="input-ciudad" name="ciudad" placeholder=""
                                                        value="{{ ciudad }}">
                                                </label>
                                            </section>
                                            <section class="col col-md-3">
                                                ...
                                                <label class="select">
                                                    ...
                                                    <select id="input-tipocontrato" name="tipocontrato">
                                                        ...
                                                        <option selected value="{{ tc.codigo }}">{{ tc.nombres }}
                                                        </option>
                                                        {% else %}
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                                    <input type="text" id="input-fecha_creacion" name="fecha_creacion"
                                                        placeholder="" class="datepicker" data-dateformat='dd/mm/yy'
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-append fa fa-calendar"></i>
                                                    <input type="text" id="input-fecha_clausura" name="fecha_clausura"
                                                        placeholder="" class="datepicker" data-dateformat='dd/mm/yy'
                                                        value="{{ fecha_clausura }}">
                                                </label>
                                            </section>
                                            <section class="col col-md-3">
                                                <label class="text-info">Salario</label>
                                                <label class="input"> <i class="icon-prepend fa fa-money"></i>
                                                    <input type="text" id="input-salario" name="salario" placeholder=""
                                                        value="{{ salario }}">
                                            ...
                                            <section class="col col-md-3">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-group"></i>
                                                    <input type="text" id="input-cantidad_vacantes"
                                                        name="cantidad_vacantes" placeholder=""
                                                        value="{{ cantidad_vacantes }}">
