...
{% if asignaturas.tipoe is defined %}
    {% set tipoe = asignaturas.tipoe %}
{% endif %}
...
{% if asignaturas.estado is defined %}
    {% set estado = asignaturas.estado %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registroasignaturas/save','method': 'post','id':'form_asignaturas','class':'smart-form','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-lock"></i>
                                                    ...
                                                    <input type="text" name="codigo" id="input-codigo" placeholder="Código de asignatura" {% if estado !== "" %}value="{{ codigo }}" readonly  {% endif %}>
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-2">
                                                <label class="text-info" >Tipo Asignatura</label>
                                                <label class="select">
                                                    <select id="input-tipoe"  name="tipoe" >
                                                        <option value="" >Seleccione...</option>
                                                        {% for tipoasignaturase1 in tipoasignaturase %}
                                                            {% if tipoasignaturase1.codigo == tipoe %}
                                                                <option selected="selected" value="{{ tipoasignaturase1.codigo }}">{{ tipoasignaturase1.nombres }}</option>   
                                                            {% else %}
                                                                <option value="{{ tipoasignaturase1.codigo }}">{{ tipoasignaturase1.nombres }}</option>   
                                                            {% endif %}
