                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <strong>DNI : <label class="label label-primary">{{
                                                                            docentes.nro_doc }}</label></strong>
                                                                </td>
                                                                <td>
                                                                    <strong>APELLIDOS Y NOMBRES: <label
                                                                            class="label label-primary"> {{
                                                                            docentes.apellidop }} {{ docentes.apellidom
                                                                            }} {{ docentes.nombres }}
                                                                        </label></strong>
                                                                </td>
                                                                <td>
                                                                    <strong>FECHA DE NACIMIENTO : <label
                                                                            class="label label-primary">{{
                                                                            utilidades.fechita(docentes.fecha_nacimiento,"d-m-Y")
                                                                            }}</label></strong>
                                                                </td>
                                                            ...
                                                            <tr style="border-bottom:1px solid #ddd !important;">
                                                                <td>
                                                                    <strong>FECHA DE INGRESO : <label
                                                                            class="label label-primary">{{
                                                                            utilidades.fechita(docentes.fecha_ingreso,"d-m-Y")
                                                                            }}</label></strong>
                                                                </td>
                                                                <td>
                                                    ...
                                                    <div class="tab-content padding-10">
                                                        <div class="tab-pane fade in active" id="hr1">
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    <span class="input-group-addon"
                                                                        style="width:145px;text-align: left;">Escolaridad</span>

                                                                    <input type='text' id="i_escolar"
                                                                        class='form-control rb' name='i_escolar'
                                                                        value="{{planilladetalle.i_escolar}}"
                                                        ...
                                                        <div class="tab-pane fade" id="hr2">
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type='text' id="aporte"
                                                                        class='form-control td' name='aporte'
                                                                        value="{{vplanillas.afp_aporte}}"
                                                                        style="text-align: right;" readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type='text' id="prima"
                                                                        class='form-control td' name='prima'
                                                                        value="{{vplanillas.afp_prima}}"
                                                                        style="text-align: right;" readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type='text' id="comision"
                                                                        class='form-control td' name='comision'
                                                                        value="{{vplanillas.afp_comision}}"
                                                                        style="text-align: right;" readonly>
                                                            ...
                                                            <div class="form-group col-md-3"
                                                                ...
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type='text' id="quinta_cat"
                                                                        class='form-control td' name='quinta_cat'
                                                                        value="{{vplanillas.quinta_cat}}"
                                                                        style="text-align: right;" readonly>
