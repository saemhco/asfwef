                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('importarcsv/savecsv','method': 'post','id':'form_csv','class':'smart-form','enctype':'multipart/form-data') }}
                                            ...
                                            <section class="col col-4">
                                                ...
                                                <div class="input input-file">
                                                    <span class="button"><input type="file" id="file" name="file"
                                                        ...
                                                        type="text" placeholder="Importar CSV" readonly="">
                                                </div>
                                            </section>
    ...
    <div class="row">
        <section class="col col-md-12">
            ...
            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                ...
                <input type="hidden" id="input-id_autor" name="id_autor" value="">
            </label>
        </section>
