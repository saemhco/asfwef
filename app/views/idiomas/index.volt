...
{{ form('idiomas/save','method': 'post','id':'form_idiomas','class':'smart-form') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
            <label class="input"> <i class="icon-prepend fa fa-user"></i>
                <input type="text" id="input-descripcion" name="descripcion" placeholder="Nombre del Idioma" >
                <input type="hidden" id="input-idioma_id" name="idioma_id" value="">
            </label>
        </section>
    </div>    
</fieldset>
