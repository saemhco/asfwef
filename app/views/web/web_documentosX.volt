                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div class="embed-responsive embed-responsive-16by9">
                                <embed src="../adminpanel/archivos/documentos/{{ documento.archivo }}" width=845
                                    height=1080>
                            </div>
                            <br>
                            <a href="../adminpanel/archivos/documentos/{{ documento.archivo }}" target="_blank"
                        ...
                        <div class="blog-post-item">
                            <h3><span>Documentos Anteriores</span></h3>
                            <table class="table table-hover table-bordered" style="border: solid 1px #f2f2f2;">
                                <thead>
                                    <tr>

                                        <th
                                            style="background-color: #4169e1; color: white;text-align:center !important;">
                                            Documento</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #000000;text-align:center !important;" width="20%">
                                            ...
                                            <a class="btn btn-warning btn-raised btn-xs" style="padding-right: 5px;"
                                                href="{{ config.global.xWebIns }}/adminpanel/archivos/documentos_archivos/{{ documentoArchivo.archivo }}"
                                                target="_blank" width="10%"><i class="fa fa-file-pdf-o"></i></a>

                                            {% for documentoArchivoResolucion in documentosArchivosResoluciones %}
                                            {% if documentoArchivoResolucion.id_resolucion ==
                                            documentoArchivo.id_resolucion %}
                                            <a class="btn btn-warning btn-raised btn-xs"
                                                href="{{ config.global.xWebIns }}/adminpanel/archivos/resoluciones/{{ documentoArchivoResolucion.archivo }}"
                                                target="_blank" width="10%">R</a>
                                            {% endif %}
                                            {% endfor %}
