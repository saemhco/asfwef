    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: 80px;">
                    <div class="card-body">
                        <h2 class="color-primary text-center">Recuperar Contraseña</h2>

                        {{ form('web/recuperarcontrasenhalogin8','method': 'post','id':'form_recuperarclave','class':'form-horizontal') }}
                        <fieldset>
                ...
                <div class="card card-primary animated fadeInUp animation-delay-7">
                    <div class="card-body">
                        ...
                        <div class="card" style="box-shadow: none !important;">
                            <ul class="list-group">
                                <li class="list-group-item" style="border: none !important;"><i class="color-primary fa fa-link"></i>Ingresa tu Email y envia el enlace a tu correo institucional.</li>
                                <li class="list-group-item" style="border: none !important;"><i class="color-success fa fa-mail-reply"></i> Accede al enlace proporcionado en el mensaje a tu email para crear tu nueva contraseña</li>
