                ...
                <div class="col-lg-9 col-md-9 col-sm-9 order-sm-2 order-md-2 order-lg-2" style ="margin-top: 20px;"> 
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <!--
                            <div class="col-lg-12">                                
                                <a target="_blank" href="{{ url('web-resoluciones-grupo.html') }}" class="btn btn-primary btn-raised text-right" role="button">
                                    <i class="fa fa-search"></i>
                                    <span>Buscar Resoluciones por año</span>
                                </a>
                            </div>
                            -->
                            <br>
                                ...
                                <div class="card card-primary">
                                    <div class="card-body">                                              
                                        ...
                                        <h6><p style="text-align:justify;margin-bottom: -5px;">{{ resolucion.resumen}}</p></h6>
                                            ...
                                            {% for resdetalle_select in resdetalle %}

                                                {% if resdetalle_select.id_resolucion == resolucion.id_resolucion %}
                                                    
                                                    <h6><p style="text-align:justify;margin-bottom: -5px;">Resolución que {{resdetalle_select.tipo}}: 
                                                    <a target="_blank" href="adminpanel/archivos/resoluciones/{{ resolucion_select.archivo }}">{{resdetalle_select.titulo}}</a></h6>
