    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: -30px;padding-bottom: 25px;">
                    <div class="card-body">
                        {#<h1 class="color-primary text-center">Inicio de Sesión</h1>#}
                        <center>{{ image("webpage/assets/img/logo.png", "alt":"UNCA") }}</center>
                        <br>
                        {{ form('web/loginEmpresas','method': 'post','id':'form_sesion_perfiles','class':'form-horizontal') }}
                        <fieldset>
                            ...
                            <div class="form-group row" style="margin-bottom: -10px !important;">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="input_ruc_form_sesion_perfiles" placeholder="Ingrese su número de RUC" name="nro_ruc">
                        ...
                        {#<a href="javascript:void(0);"class="btn btn-raised btn-primary btn-block" onclick="registro_publico();">Registro de Ciudadano / a <i class="zmdi zmdi-account-add no-mr ml-1"></i></a>#}
                        <a href="javascript:void(0);"class="btn btn-raised btn-primary btn-block" onclick="registro_empresa();">Registro de Empresa<i class="zmdi zmdi-home no-mr ml-1"></i></a>
                    ...
                    <!--Modal publico -->
                    <div class="modal modal-primary" id="modal_registro_publico" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog modal-xl animated zoomIn animated-3x" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    {{ form('web/savePublicoLoginExterno','method': 'post','id':'form_registro_publico','class':'form-horizontal','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="row form-group" id="select_documento">
                                                    ...
                                                    <select id="input_documento_select" class="form-control selectpicker" name="documento" style="pointer-events: none;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="input_nro_doc_modal" placeholder="" name="nro_doc_registro_publico" style="margin-top: 9px !important;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group">
                                                    ...
                                                    <input type="email" class="form-control" id="input_email_publico" placeholder="" name="email_publico_registro" style="margin-top: 9px !important;">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <input type="password" class="form-control" id="input_password_publico_modal" placeholder="" name="password">
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <input type="password" class="form-control" id="input_password_publico_repeat_modal" placeholder="" name="password">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-raised btn-primary" id="btn_grabar_publico"><i class="fa fa-save"></i>Guardar</button>
                    ...
                    <div class="modal modal-primary" id="modal_registro_empresa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" data-backdrop="static" data-keyboard="false">
                        <div class="modal-dialog modal-xl animated zoomIn animated-3x" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    {#<p>Se registro postulante correctamente...</p>#}
                                    {{ form('web/saveEmpresaLoginExterno','method': 'post','id':'form_registro_empresa','class':'form-horizontal','enctype':'multipart/form-data') }}
            ...
            <div class="col-xl-7 order-xl-1">
                <div class="card card-primary animated fadeInUp animation-delay-7" {#style="padding-top: -30px;padding-bottom: 55px;"#}>
                    <div class="card-body">
