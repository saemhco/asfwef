        ...
        <div class="row">
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: 10px;">
                    <div class="card-body">
                        ...
                        {{ form('web/recuperarContrasenhaTramiteDocumentario','method': 'post','id':'form_recuperarclave','class':'form-horizontal') }}
                        <fieldset>
            ...
            <div class="col-xl-7 order-xl-1">
                <div class="card card-primary animated fadeInUp animation-delay-7">
                    <div class="card-body">
                        <h2 class="color-primary text-left">SISTEMA DE GESTIÓN DOCUMENTAL</h2>
