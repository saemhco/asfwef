						...
						<div class="card-body">
							...
							<center>
								<div class="embed-responsive embed-responsive-16by9">
									<embed src="../adminpanel/archivos/docprocesos/{{ documento.archivo }}" width="845" height="1080">
								</div>
								<br>
								<a href="../adminpanel/archivos/docprocesos/{{ documento.archivo }}" target="_blank" class="btn btn-reveal btn-primary b-0 btn-shadow-2">
										...
										<tbody>
												...
												{% if documentoArchivo.estado == "A" %}
													<tr>
														...
														<td style="color: #000000;text-align:left !important; font-size: 12px;" width="40%">
															<a href="../web-procesos-archivos/{{ documentoArchivo.enlace }}.html" target="_blank">
                                            ...
                                            documentoArchivo.id_resolucion %}
														...
														<td style="color: #000000;text-align:center !important;" width="20%">
															...
															<a class="btn btn-raised btn-royal btn-xs" style="padding-right: 5px;" href="{{ config.global.xWebIns }}/adminpanel/archivos/docprocesos_archivos/{{ documentoArchivo.archivo }}" target="_blank" width="10%">
