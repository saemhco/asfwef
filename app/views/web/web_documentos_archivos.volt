                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div class="embed-responsive embed-responsive-16by9">
                                <embed src="../adminpanel/archivos/documentos_archivos/{{ documento.archivo }}" width=845
                                    height=1080>
                            </div>
                            <br>
                            <a href="../adminpanel/archivos/documentos_archivos/{{ documento.archivo }}" target="_blank"
