                                ...
                                <div class="col-md-12">
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title"><strong><span>{{ utilidades.partedescripcion(noticia.titular,0,200)}} </span> </strong></h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="row" style ="margin-left:20px;"><!-- item -->                                
                                                <div class="col-md-3" style="margin-left: -20px;">
                                                    ...
                                                    <div class="thumbnail"><!-- company logo -->
                                                        {{ image("adminpanel/imagenes/noticias/"~noticia.imagen, "width":"220", "height":"135") }}
                                                    </div>
                                                    </center>
                                                </div>
                                                <div class="col-md-9" style="margin-top: -10px;"><!-- company detail -->                                                
                                                    <ul class="list-inline">
                                                        <h4><li><i class="fa fa-newspaper-o"></i><span class="text-info">  Publicado por la Oficina de Relaciones Públicas - Fecha: {{ utilidades.fechita(noticia.fecha_hora,"d/m/Y")}}</span></li></h4>
                                                    </ul>
                                                    <p style="text-align:justify;">{{ utilidades.partedescripcion(noticia.texto_muestra,0,285)}} &nbsp ...</p>
                                                </div> 
                                            </div>
                                            <center>
                        ...
                        <nav aria-label="Page navigation" style="display: inline-block;">
                            ...
                            <ul class="pagination pagination-round">
                                ...
                                <li class="page-item">
                                    ...
                                    {{ link_to("web-noticias.html?page=" ~ page.before, '<<', "class": "page-link") }}
                                ...
                                {% if page.last == 1%}
                                    <li class="page-item active">
                                        ...
                                        <a class="page-link" href="{{ url('web-noticias.html?page='~page.first) }}">{{ page.first }}</a>
                                ...
                                {%  elseif(page.last == 2) %}
                                    ...
                                    {% for i in 1..page.total_items if i <= 2 %}
                                        <li  {% if i == page.current %} class="page-item active" {% else %} class="page-item"{% endif %}>
                                            ...
                                            <a class="page-link" href="{{ url('web-noticias.html?page='~i) }}">{{ i }}</a>
                                ...
                                {% else %}
                                    {% if page.current == page.last-1 or page.current == page.last-2 or page.current == page.last-3 %}
                                        ...
                                        <li  {% if page.current == page_last_4 %} class="page-item active" {% else %} class="page-item"{% endif %}>
                                            ...
                                            <a class="page-link" href="{{ url('web-noticias.html?page='~page_last_4) }}">{{ page_last_4 }}</a>
                                        ...
                                        <li  {% if page.current == page_last_3 %} class="page-item active" {% else %} class="page-item"{% endif %}>
                                            ...
                                            <a class="page-link" href="{{ url('web-noticias.html?page='~page_last_3) }}">{{ page_last_3 }}</a>
                                        ...
                                        <li  {% if page.current == page_last_2 %} class="page-item active" {% else %} class="page-item"{% endif %}>
                                            ...
                                            <a class="page-link" href="{{ url('web-noticias.html?page='~page_last_2) }}">{{ page_last_2 }}</a>
                                        ...
                                        <li  {% if page.current == page_last_1 %} class="page-item active" {% else %} class="page-item"{% endif %}>
                                            ...
                                            <a class="page-link" href="{{ url('web-noticias.html?page='~page_last_1) }}">{{ page_last_1 }}</a>

                                        </li>

                                        <li  {% if page.current == page.last %} class="page-item active" {% else %} class="page-item"{% endif %}>

                                            <a class="page-link" href="{{ url('web-noticias.html?page='~page.last) }}">{{ page.last }}</a>
                                    ...
                                    {% else %}
                                        ...
                                        {% if page.current >= 5%}
                                            <li class="page-item">
                                                ...
                                                <a class="page-link" href="{{ url('web-noticias.html?page='~1) }}">1</a>
                                            ...
                                            <li class="page-item">
                                                ...
                                                <a class="page-link" href="{{ url('web-noticias.html?page='~page.before) }}">{{ page.before }}</a>

                                            </li>
                                            <li class="page-item active">

                                                <a class="page-link" href="{{ url('web-noticias.html?page='~page.current) }}">{{ page.current }}</a>

                                            </li>

                                            <li class="page-item">

                                                <a class="page-link" href="{{ url('web-noticias.html?page='~page.next) }}">{{ page.next }}</a>
                                ...
                                <li class="page-item">
                                    ...
                                    {{ link_to("web-noticias.html?page=" ~ page.next, '>>', "class": "page-link") }}
