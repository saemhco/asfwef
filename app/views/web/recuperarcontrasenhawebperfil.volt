        ...
        <div class="row">
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: 10px;">
                    <div class="card-body">
                        <h2 class="color-primary text-center">Recuperar Contraseña2</h2>

                        {{ form('web/recuperarContrasenhaLogin','method': 'post','id':'form_recuperarclave','class':'form-horizontal') }}
                        <fieldset>
                            <div class="form-group row">
                                <label for="inputEmail-ñogin" class="col-md-3 control-label" style="font-size: 14px !important;padding-top: 1px !important;">E-mail</label>
                                <div class="col-md-4">
                        ...
                        <a href="{{ url('login-ratificacion-docentes') }}" class="btn btn-danger btn-raised btn-block" role="button">
