            ...
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: 10px;">
                    <div class="card-body">
                        ...
                        {{ form('web/recuperarContrasenhaInterno','method': 'post','id':'form_recuperarclave','class':'form-horizontal') }}
                        <fieldset>
                            <div class="form-group row">
                                <label for="inputEmail-ñogin" class="col-md-3 control-label" style="font-size: 14px;padding-top: 1px !important;">E-mail</label>
                                <div class="col-md-9">
                                    <input type="email" name="email" id="email" class="form-control" placeholder="Email">
                                </div>
{#                                <div class="col-md-5">

                                    <label for="inputEmail-ñogin" class="control-label" style="color: black !important; font-size: 14px;padding-top: 1px !important;"></label>
                        ...
                        <a href="{{ url('login.html') }}" class="btn btn-danger btn-raised btn-block" role="button">
