    ...
    <div class="row">
        <div class="col-xl-5 order-xl-2">
            <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-bottom: 48px;">
                <div class="card-body">
                    ...
                    <br>
                    {{ form('web/loginConvocatoriasbs','method':
                    ...
                    <fieldset>
                        <div class="form-group row" style="margin-bottom: -10px !important;">
                            <label for="inputEmail-ñogin" class="col-md-4 control-label" id="label_change"
                                ...
                                RUC</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="input_ruc_form_sesion_perfiles"
                                    placeholder="Ingrese su número de RUC" name="ruc">
                    ...
                    <a href="javascript:void(0);" class="btn btn-raised btn-primary btn-block"
                        onclick="registro_empresa();">Registro de Proveedores<i class="zmdi zmdi-collection-plus no-mr ml-1"></i></a>
                    ...
                    <div class="modal-dialog modal-xl animated zoomIn animated-3x" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                {{ form('web/saveProveedoresLogin','method':
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row form-group" id="input-archivo_rnp">
                                                ...
                                                <input type="text" readonly="" class="form-control"
                                                    placeholder="Buscar..." name="archivo_brochure">
        ...
        <div class="col-xl-7 order-xl-1">
            <div class="card card-primary animated fadeInUp animation-delay-7"
                ...
                <div class="card-body">
                    <h2 class="color-primary text-center" style="font-size:25px;"><strong><span style="font-size: 30px;">SISTEMA DE GESTIÓN ADMINISTRATIVA</span> “CONVOCATORIAS DE BIENES Y SERVICIOS”</strong></h2>
                    <p style="text-align: justify;padding-bottom: 15px;">
                        Bienvenidos al nuevo portal de Gestión Administrativa mediante la modalidad de Convocatorias de Bienes y Servicios. La información que se consigne tiene carácter de Declaración Jurada, por lo que el postulante será responsable de la Información presentada.
                    </p>
                    <p style="text-align: justify;">Para más información sobre el procedimiento de postulación descargue el siguiente <a target="_blank"
                            href="#"><strong> Manual de usuario del Sistema de Gestión Administrativa: Convocatorias de Bienes y Servicios de la UNCA</strong></a>.</p>
                    ...
                    <div>
                        ...
                        <ul style="list-style-type: disc;">
                            <i class="fa fa-envelope"></i>&nbsp&nbsp&nbsp Email: <a
                                href="mailto:informes@unca.edu.pe">abastecimientos@unca.edu.pe</a> <br />
