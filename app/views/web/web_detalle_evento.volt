                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">    
                            ...
                            <div class="blog-post-item">
                                ...
                                <h3><span>{{ evento.titular }}</span></h3>
                                <!-- OWL SLIDER -->
                                <div>
                                    <center>
                                        <div id="carousel-example-generic" class="ms-carousel carousel slide" data-ride="carousel" {#style="width: 600px;border: 3px solid #C0C0C0;"#}>
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                {% if activa_imagenes == 1 %} 
                                                    {% set codigo_active = evento_imagen_active.id_evento_imagen %}
                                                    {% for  evento_imagen in eventos_imagenes  %}
                                                        <div class="carousel-item {% if evento_imagen.id_evento_imagen == codigo_active %} active {% endif %}">
                                                            {{ image("adminpanel/imagenes/eventos_img/"~evento_imagen.imagen, "class":"d-block img-fluid", "alt":"") }}
                                                ...
                                                {% elseif activa_imagenes == 0 %}
                                                    <div class="carousel-item active">
                                                        {{ image("adminpanel/imagenes/eventos/"~evento.imagen, "class":"d-block img-fluid", "alt":"") }}
                                ...
                                <p>{{ evento.texto_complementario }}</p>
                                    ...
                                    <table class="table table-hover table-bordered" style="border: solid 1px #f2f2f2;">
                                        ...
                                        <tbody>
                                            {% for  evento_archivo in eventos_archivos  %}
                                                ...
                                                <tr>
                                                    <td style="color: #000000;text-align:left !important;">{{ evento_archivo.titular }}</td>
                                                    <td style="color: #000000;text-align:center !important;"><a href="{{ config.global.xWebIns }}/adminpanel/archivos/eventos_files/{{ evento_archivo.archivo }}" target="_BLANK"><i class="fa fa-file-pdf-o"></i></a></td>
                                                </tr>
                                ...
                                <a href="{{ url('web-eventos.html') }}" class="btn btn-primary btn-raised text-right" role="button">
