    ...
    <div class="ms-paper">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 order-sm-2 order-md-2 order-lg-2" style="margin-top: 20px;">
                <div class="card card-primary">
                    ...
                    <div class="card-header" style="padding-bottom: 5px !important;padding-top: 5px !important;">
                        <div class="list-group">
                            <a href="javascript:void(0)" style="pointer-events: none;"
                                ...
                                <h3 class="card-title"><strong>Detalle de la Convocatoria</strong></h3>
                                ...
                                <span class="ml-auto badge badge-default"
                                    style="background-color: #da1515;color: white;">SUSPENDIDO</span>
                                {% endif %}
                            </a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="blog-post-item">
                            ...
                            {% if convocatoria.tipo == 9 %}

                            <center>                                
                            <img src="../adminpanel/imagenes/admision/banner-documentos-admision.jpg" alt="ADMISIÓN" style="width: 100%;">                                                                
                            </center>

                            {% endif %}


                            <h3 style="text-align: justify !important;"><strong>{{ convocatoria.titulo }}</strong></h3>
                            <p style="text-align: justify;">{{ convocatoria.texto_muestra }}</p>
                                ...
                                {% if convocatoria.etapa == 1 %}
                                    ...
                                    {% if convocatoria.tipo == 1 %}
                                        ...
                                        <div style="margin-top: -5px !important;margin-bottom: 10px !important;">
                                            <center>
                                                <a target="_blank" href="{{ url('login-convocatorias.html') }}"
                                                    class="btn btn-warning btn-raised text-right" role="button">
                                                    <i class="zmdi zmdi-plus"></i><span>REGÍSTRATE</span>
                                                </a>
                                            </center>
                                        </div>
                                    {% endif %}
                                    ...
                                    {% if convocatoria.tipo == 2 %}
                                        ...
                                        <div style="margin-top: -5px !important;margin-bottom: 10px !important;">
                                            <center>
                                                <a target="_blank" target="_blank" href="{{ url('login-convocatorias-docentes.html') }}"
                                                    class="btn btn-warning btn-raised text-right" role="button">
                                                    <i class="zmdi zmdi-plus"></i><span>POSTULAR</span>
                                                </a>
                                            </center>
                                        </div>
                                    ...
                                    {% if convocatoria.tipo == 3 %}

                                        <div style="margin-top: -5px !important;margin-bottom: 10px !important;">
                                            <center>
                                                <a target="_blank" href="{{ url('login-ratificacion-docentes.html') }}"
                                                    class="btn btn-warning btn-raised text-right" role="button">
                                                    <i class="zmdi zmdi-plus"></i><span>POSTULAR</span>
                                                </a>
                                            </center>
                                    ...
                                    {% if convocatoria.tipo == 4 %}

                                        <div style="margin-top: -5px !important;margin-bottom: 10px !important;">
                                            <center>
                                                <a target="_blank" href="{{ url('login-concursos-rsu.html') }}"
                                                    class="btn btn-warning btn-raised text-right" role="button">
                                                    <i class="zmdi zmdi-plus"></i><span>POSTULAR</span>
                                                </a>
                                            </center>
                        ...
                        <div>
                            ...
                            <ul style="list-style-type: disc;">
                                <i class="fa fa-envelope"></i>&nbsp&nbsp&nbsp Email: <a
                                    href="mailto:informes@unca.edu.pe">admision@unca.edu.pe</a> <br />
                ...
                <a href="{{ url('web-convocatorias/'~convocatoria.tipo~'.html') }}"
