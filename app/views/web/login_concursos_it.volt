            ...
            <div class="card card-primary animated fadeInUp animation-delay-7">
                <div class="card-body">
                    <h4 class="color-primary text-center" style="font-size:24px;;padding-bottom: 20px;"><strong>
                        ...
                        <span>SISTEMA DE INFORMACION DE GESTIÓN DE CONVOCATORIAS DE PROYECTOS DE INNOVACIÓN TECNOLÓGICA</strong>
                                
                    </h4>
                    <p style="text-align: justify;padding-bottom: 5px;">
                        Bienvenidos a la nueva Plataforma de Gestión de Convocatorias de Proyectos de Innovación Tecnológica. La información que se consigne tiene carácter de Declaración Jurada, por lo que el postulante será responsable de la Información presentada.
                    </p>
                    <p style="text-align: justify;">Para más información sobre el procedimiento de postulación descargue el siguiente Manual de Usuario: <br><a target="_blank"
                            href="https://www.unca.edu.pe/adminpanel/archivos/documentos/manual-de-usuario-del-sistema-de-informacion-de-gestion-de-convocatorias-de-concurso-docente.pdf"><strong>
                                Sistema de Información de Gestión de Convocatorias de Proyectos de Innovación Tecnológica SIGCPIT.</strong></a>
                    </p>
