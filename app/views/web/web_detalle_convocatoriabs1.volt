    ...
    <div class="ms-paper">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 order-sm-2 order-md-2 order-lg-2" style="margin-top: 20px;">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fa fa-globe"></i><strong>Consultas y envío de
                                propuestas</strong></h3>
                    </div>
                    <div class="card-body">
                        <div class="heading-title heading-border-bottom heading-color">
                            <h4 class="panel-title">Las consultas y presentación de propuestas se pueden realizar: </h4>
                        </div>
                        <div>
                            <h5>
