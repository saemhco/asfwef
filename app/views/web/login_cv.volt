            ...
            <div class="col-xl-5 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7"  style="padding-top: 25px;">
                    <div class="card-body">
                        ...
                        {{ form('web/loginCv','method': 'post','id':'form_sesion_convocatorias','class':'form-horizontal') }}
                        <fieldset>
                        ...
                        <div class="modal-dialog modal-xl animated zoomIn animated-3x" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    {{ form('web/savePublicoCV','method': 'post','id':'form_registro_convocatorias','class':'form-horizontal','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="input_nro_ruc" placeholder="" name="nro_ruc" style="margin-top: 9px !important;">
                                                </div>
                                            </div>
                                        ...
                                        <!-- <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="row form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="input_ubigeo" placeholder="Ubigeo" name="ubigeo" style="margin-top: 9px !important;">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group" id="select_estado_civil">
                                                    <label for="input_estado_civil" class="control-label" >Estado Civil:</label>
                                        ...
                                        <!-- <div class="row">
                                            <div class="col-md-8">
                                                <div class="row form-group" id="select_colegio_profesional">
                                                    <label for="input_colegio_profesional" class="control-label" >Colegio Profesional:</label>
                                                    <select id="input_colegio_profesional_select" class="form-control selectpicker" name="colegio_profesional">
                                                        ...
                                                        {% for colegioprofesional_select in colegioprofesional %}
                                                            <option value="{{ colegioprofesional_select.codigo }}">{{ colegioprofesional_select.nombres }}</option>                                      
                                                        {% endfor %}
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="row form-group">
                                                    <label for="input_Colegio Profesional Número" class="control-label">Colegio Profesional Número</label>
                                                    <input type="text" class="form-control" id="input-colegio_profesional_nro" name="colegio_profesional_nro" placeholder="" style="margin-top: 9px !important;">
            ...
            <div class="col-xl-7 order-xl-1">
                <div class="card card-primary animated fadeInUp animation-delay-7">
                    <div class="card-body">
                        ...
                        <h2 class="color-primary text-center"><strong>SISTEMA DE GESTIÓN DE CONVOCATORIAS</strong></h2>
                        ...
                        <p style="text-align: justify;">Para mas información sobre el procedimiento de postulación descargue el siguiente <a target="_blank" href="https://www.unca.edu.pe/adminpanel/archivos/documentos/manual-de-usuario-del-sistema-de-gestion-de-convocatorias-unca-656574.pdf" ><strong>Manual de usuario del Sistema de Gestión de Convocatorias de la UNCA</strong></a>.</p>
