    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 order-xl-2">
                <div class="card card-primary animated fadeInUp animation-delay-7" style="padding-top: 120px;">
                    <div class="card-body">
                        <h1 class="color-primary text-center" style="margin-top: -80px !important;">Inicio de Sesión</h1>

                        {{ form('web/loginperfiles','method': 'post','id':'form_sesion_perfiles','class':'form-horizontal') }}
                        <fieldset>
                            <div class="row form-group" style="margin-bottom: -20px !important;">
                                <label for="inputGen" class="col-md-4 control-label" style="font-size: 14px !important;text-align: left;padding-top: 1px !important;">Tipo de usuario</label>
                                <div class="col-md-8">
            ...
            <div class="col-xl-6 order-xl-1">
                <div class="card card-primary animated fadeInUp animation-delay-7">
                    <div class="card-body">
                        ...
                        <center><h4><strong>Manuales de Usuario de los Sistemas de Información de la UNCA</strong></h4></center>
                        <div class="card" style="box-shadow: none !important;">
                            <ul class="list-group">
                                <li class="list-group-item" style="border: none !important;"><i class="color-primary fa fa-home"></i><a target="_blank" href="{{ url('web-documentos/'~'manual-usuario-sistema-informacion-gestion-matricula'~".html") }}" > Gestión de Matricula Online</a></li>
                                <li class="list-group-item" style="border: none !important;"><i class="color-success fa fa-user-plus"></i><a target="_blank" href="{{ url('web-documentos/'~'manual-usuario-sistema-informacion-gestion-docente'~".html") }}" > Gestión Docente</a></li>
                                <li class="list-group-item" style="border: none !important;"><i class="color-warning fa fa-user"></i><a target="_blank" href="{{ url('web-documentos/'~'manual-usuario-sistema-informacion-gestion-registros-academicos'~".html") }}" > Registros Académicos</a></li>
                                <li class="list-group-item" style="border: none !important;"><i class="color-success fa fa-file-text"></i><a target="_blank" href="{{ url('web-documentos/'~'manual-usuario-plataforma-virtual-biblioteca'~".html") }}" > Plataforma Virtual de Biblioteca</a></li>
                                <li class="list-group-item" style="border: none !important;"><i class="color-primary fa fa-briefcase"></i><a target="_blank" href="{{ url('web-documentos/'~'manual-usuario-plataforma-virtual-bolsa-de-trabajo'~".html") }}" > Plataforma Virtual de Bolsa de Trabajo</a></li>
