<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Solicitudes</li><li>Alumnos</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Lista de Solicitudes de Alumnos</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_registrosolicitudesalumnos" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
