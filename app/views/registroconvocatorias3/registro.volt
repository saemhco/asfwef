                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registroconvocatorias3/save','method': 'post','id':'form_convocatorias','class':'smart-form','enctype':'multipart/form-data') }}
...
{{ form('registroconvocatorias3/savearchivo','method': 'post','id':'form_convocatorias_detalles','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
