                                                                        ...
                                                                        <tbody>
                                                                            {% for det in notas %}
                                                                                <tr class="activa" id="get-{{ det.alumno }}"  >
                                                                                    ...
                                                                                    <td class="p_p1"><input type="text" style="width: 50px;" class="input-xs pp1 not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ep1[]" value="{{ det.ep1 }}" disabled></td>
                                                                                    ...
                                                                                    <td class="p_ef"><input type="text" style="width: 50px;" class="input-xs pef not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ef[]" value="{{ det.ea }}" disabled></td>
