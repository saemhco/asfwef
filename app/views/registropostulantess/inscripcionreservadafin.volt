                                ...
                                <table class="table table-sm table-primary table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="90%">
                                                <strong style="color: red;">Inscripción Reservada</strong>
                                            </td>
                                        </tr>
                                        <tr> 
...
<fieldset>
    <div class="row">
        <section class="col col-md-12">
                ...
                <center>
                    <img class="img-responsive" src="{{ url('adminpanel/imagenes/admision/'~admision.imagen) }}"
