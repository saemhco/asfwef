                                ...
                                <table class="table table-sm table-primary table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td width="90%">
                                                {% if admision.proceso == "" %}
                                                <strong style="color:red;">Aún no ha iniciado el proceso de inscripción...</strong>
                                                {% else %}
                                                ...
                                                <strong style="color: blue;">{{procesosPostulantes_select.nombres }}</strong>
                                                {% elseif(procesosPostulantes_select.codigo == 3) %}
                                                <strong style="color: red;">{{procesosPostulantes_select.nombres }}</strong>
                                                {% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    {{ form('registropostulantesa/updateInscripcion','method':
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-1">
                                                ...
                                                onclick="modal_voucher();"> <i
                                                    class="fa-fw fa fa-image" style="padding-left: 30px;padding-right: 30px;padding-top: 8px;padding-bottom: 8px;"></i></a>
                                            </section>
                                            ...
                                            <section class="col col-md-5">
                                                <div class="input input-file">
                                                    ...
                                                    <label class="input">
                                                        <input id="file_inscripcionobservada_imagen" type="file" name="file_imagen"
...
<fieldset>
    <div class="row">
        <section class="col col-md-12">
                ...
                <center>
                    <img class="img-responsive" src="{{ url('adminpanel/imagenes/admision/'~admision_m.codigo~'/'~admision.imagen) }}"
                </center>
