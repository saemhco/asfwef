                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="input">
                                                    {% if id_doc !== "" %}
                                                    <input  type="text" list="datalist-personal"
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="select">
                                                    <select readonly id="input-id_cargo" name="id_cargo" {% if id_doc !=="" %}
                                                         {% endif %}>
                                            ...
                                            <section class="col col-md-6" style="float: right;">
                                                ...
                                                <label class="select">
                                                    <select readonly id="input-id_sede" name="id_sede" {% if id_doc !=="" %}
                                                         {% endif %}>
                                                        <option value="">SELECCIONE...</option>
                                            ...
                                            <section class="col col-md-6">
                                                <label class="text-info">Áreas</label>
                                                <label class="input">
                                                    {% if id_doc !== "" %}
                                                    <input  type="text" list="datalist-area" name="destinatario_area"
                                    ...
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-3" style="float: left;">
                                                ...
                                                <label class="select">
                                                    <select readonly id="input-id_tipo_doc" name="id_tipo_doc" {% if id_doc !==""
                                                        %} {% endif %}>
                                                        <option value="">SELECCIONE...</option>
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="text-info" >Adjuntar Archivo foliado en formato .pdf (Si tiene varios documentos debe consolidarlo en un solo archivo)</label>
