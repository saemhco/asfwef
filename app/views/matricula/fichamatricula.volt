                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    {% for curso in cursos %}
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td id="observacion-{{ curso.asignatura }}">{{ curso.observacion }}</td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td colspan="1" style="text-align: right;" ><h4>TOTAL CREDITOS </h4></td>
                                                                        <td style="vertical-align: middle;text-align: center;"><h4>{{ sum }}</h4></td>
                                                                        <td></td>
                                                                        <td></td>
                                                                        <td></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="7">
                                                                <center> <a role="button" href="{{ url('reportes/reportefichamatricula/'~semestre.codigo~'/'~alumno.codigo) }}"  target="_BLANK" class="btn btn-info  btn-md"><i class="fa fa-download"></i>  DESCARGAR FICHA DE MATRICULA </a></center>
                                                                </td>
                                                                </tr>
                                                                </tbody>    
                                                            </table>
