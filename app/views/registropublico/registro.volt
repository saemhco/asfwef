                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registropublico/save','method': 'post','id':'form_postulantes','class':'smart-form','enctype':'multipart/form-data') }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <div class="input input-file">
                                                    ...
                                                    <span class="button"><input id="archivo" type="file" name="archivo" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-file-archivo" name="input-file"  placeholder="Agregar Archivo" readonly="">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <div class="input input-file">
                                                    ...
                                                    {#<input type="file" id="archivo_personal" name="archivo_personal" >
                                                    <input type="hidden" id="input-archivo" name="archivo" value="{{ archivo_cp }}">#}

                                                    <span class="button"><input id="archivo_cp" type="file" name="archivo_cp" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-file-archivo_cp" name="input-file"  placeholder="Agregar Archivo" readonly="">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <div class="input input-file">
                                                    ...
                                                    <label class="input">
                                                        ...
                                                        <span class="button"><input id="imagen" type="file" name="imagen" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-image" name="input-file-imagen"  placeholder="Agregar Imagen" readonly="">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <label class="text-info" >Agregar Archivo Escuela(Subir Archivo Escuela)</label>
                                                <div class="input input-file">

                                                    {#<input type="file" id="archivo_escuela" name="archivo_escuela" >
                                                    <input type="hidden" id="input-archivo" name="archivo" value="{{ archivo_escuela }}">#}

                                                    <span class="button"><input id="archivo_escuela" type="file" name="archivo_escuela" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-file-archivo_escuela" name="input-file"  placeholder="Agregar Archivo" readonly="">
                                                ...
                                                {% if archivo_escuela !== ""   %}
                                                    ...
                                                    <div class="alert alert-success fade in">                                                        
                                                        ...
                                                        Click aqui para ver el archivo 
                                                        <a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/publico/personales/'~archivo_escuela) }}" >  <i class="fa-fw fa fa-book"></i></a>
                                                    </div>
