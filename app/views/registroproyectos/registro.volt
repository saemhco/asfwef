...
{% if proyectos.tipo is defined %}
{% set tipo = proyectos.tipo %}
{% endif %}

{% if proyectos.titulo is defined %}
{% set titulo = proyectos.titulo %}
{% endif %}

{% if proyectos.lineas is defined %}
{% set lineas = proyectos.lineas %}
{% endif %}

{% if proyectos.fecha_inicio is defined %}
{% set fecha_inicio = utilidades.fechita(proyectos.fecha_inicio,'d/m/Y') %}
{% endif %}

{% if proyectos.fecha_termino is defined %}
{% set fecha_termino = utilidades.fechita(proyectos.fecha_termino,'d/m/Y') %}
{% endif %}

{% if proyectos.objetivo is defined %}
{% set objetivo = proyectos.objetivo %}
{% endif %}

{% if proyectos.objetivos is defined %}
{% set objetivos = proyectos.objetivos %}
{% endif %}

{% if proyectos.archivo is defined %}
{% set archivo = proyectos.archivo %}
{% endif %}

{% if proyectos.enlace is defined %}
{% set enlace = proyectos.enlace %}
{% endif %}

{% if proyectos.investigador is defined %}
{% set investigador = proyectos.investigador %}
{% endif %}

{% if proyectos.imagen is defined %}
{% set imagen = proyectos.imagen %}
{% endif %}

{% if proyectos.vigencia is defined %}
{% set vigencia = proyectos.vigencia %}
{% endif %}

{% if proyectos.presupuesto is defined %}
{% set presupuesto = proyectos.presupuesto %}
{% endif %}

{% if proyectos.entidad_cooperante is defined %}
{% set entidad_cooperante = proyectos.entidad_cooperante %}
{% endif %}

{% if proyectos.compromiso_cooperante is defined %}
{% set compromiso_cooperante = proyectos.compromiso_cooperante %}
{% endif %}

{% if proyectos.local_proyecto is defined %}
{% set local_proyecto = proyectos.local_proyecto %}
{% endif %}



{% if proyectos.id_proyecto is defined %}
{% set id_proyecto = proyectos.id_proyecto %}
{% endif %}

{% set txt_buton = "Guardar" %}
{% if proyectos.estado is defined %}
{% set estado = proyectos.estado %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    {{ form('registroproyectos/save','method':
...
{{ form('registroproyectos/saveUsuarioDetallePersonal','method':
...
{{ form('registroproyectos/saveUsuarioDetalleDocente','method':
