            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">								
                ...
                <div>
                    ...
                    <div class="widget-body text-center">
                        ...
                        <a href="{{ url('licenciamiento1/registrocondiciones1') }}" class="btn btn-primary btn-block"><i class="fa fa-plus"></i></a>
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_condiciones1" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
                                        ...
                                        <th data-hide="phone,tablet">Finalizadas </th>
                                        <th data-hide="phone,tablet">Total</th>
                                        <th data-hide="phone,tablet">Avance</th>
