...
{% set nro_act_fin = "" %}
{% if condiciones.nro_act_fin is defined %}
    {% set nro_act_fin = condiciones.nro_act_fin %}
{% endif %}

{% set nro_act_total = "" %}
{% if condiciones.nro_act_total is defined %}
    {% set nro_act_total = condiciones.nro_act_total %}
{% endif %}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    ...
                                                    <input type="text" id="input-nro_act_fin" name="nro_act_fin" placeholder="Fin" value="{{ nro_act_fin }}" >
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    ...
                                                    <input type="text" id="input-nro_act_total" name="nro_act_total" placeholder="Total" value="{{ nro_act_total }}" >
