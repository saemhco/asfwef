...
{{ form('registropantallas/save','method':
'post','id':'form_pantallas','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-6">
            ...
            <label class="select">
                <select id="input-tipo" name="tipo">
                    ...
                    {% for tipoPantallas_select in tipoPantallas %}
                    <option value="{{ tipoPantallas_select.codigo }}">{{ tipoPantallas_select.nombres }}</option>
                    {% endfor %}
                </select> <i></i>
            </label>
        </section>
    ...
    <div class="row">
        <section class="col col-md-6">
            ...
            <label class="input"> <i class="icon-prepend fa fa-desktop"></i>
                ...
                <input type="hidden" id="input-id_pantalla" name="id_pantalla" value="">
            </label>
        </section>
        <section class="col col-md-6">
