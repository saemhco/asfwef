...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Lista de Prestamos de Recursos</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Lista de Prestamos de Recursos</h2>
                            </header>
...
<div class="modal fade" id="modal_hora_salida" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
                ...
                <form>
                    <div class="form-group has-success">
                        ...
                        <div class="input-group">
                            ...
                            <input type="hidden" name="prestamopc_id" id="prestamopc_id">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-primary" onclick="grabar_hora_salida()">Guardar</button>
            </div>
        </div>
    </div>
</div>