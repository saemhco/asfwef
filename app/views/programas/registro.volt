...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Registrar Programa</li>
    </ol>
</div>
<!-- END RIBBON -->     
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    {{ form('programas/save','method': 'post','id':'form_programas','class':'smart-form','enctype':'multipart/form-data') }}
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-6">
                                                <label class="text-info" >Nombre del Programa</label>
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
