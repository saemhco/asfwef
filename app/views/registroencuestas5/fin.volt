                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registroencuestas5/save','method':
                                                ...
                                                <div class="col col-md-12">
                                                    ...
                                                    <table class="table table-bordered table-hover"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            {% set id_tipo_pregunta = tp.codigo %}
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width:2%" rowspan="2">{{ pregunta.numero }}</td>
                                                                <td colspan="5">{{ pregunta.descripcion }}</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                {% if pregunta.id_encuesta_pregunta ==
                                                                ...
                                                                {% if respuesta.puntaje === pregunta.valor %}
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="inline-group">
                                                                        <label class="radio">
                                                                            <input type="radio"
                                                                                name="radio{{ pregunta.id_encuesta_pregunta }}"
                                                                                checked="checked"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="inline-group">
                                                                        <label class="radio state-disabled">
                                                                            <input type="radio"
                                                                                name="radio{{ pregunta.id_encuesta_pregunta }}"
                                                                                value="{{respuesta.puntaje}}" disabled="disabled">
                                                                            <i></i>{{respuesta.descripcion}}
                                                                        </label>
                                                                ...
                                                                <td colspan="6">
                                                                    <label class="textarea"> <i
                                                                        ...
                                                                        <textarea rows="3" id="input-recomendacion"
                                                                            name="recomendacion" readonly
                                                                            placeholder="Comentario o Recomendaciones">{{recomendacion}}</textarea>
                                                                    </label>
                                                                </td>
                                                            </tr>
