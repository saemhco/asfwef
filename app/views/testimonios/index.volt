...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Mantenimientos</li><li>Testimonios</li>
    </ol>
</div>
<!-- END RIBBON -->		
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">										
                                    ...
                                    <table id="tbl_testimonios" class="table tablecuriosity table-striped table-bordered table-hover" width="100%">
                                        <thead>			                
                                            <tr>
...
{{ form('testimonios/save','method': 'post','id':'form_testimonios','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
            ...
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                ...
                <input type="hidden" id="input-id_testimonio" name="id_testimonio" value="">
            </label>
        </section>
