            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false"
                ...
                <div>
                    ...
                    <div class="widget-body text-center">
                        ...
                        <a href="{{ url('licenciamiento/registrocondiciones') }}" class="btn btn-primary btn-block"><i
                                    ...
                                    <div class="widget-body-toolbar">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <select class="form-control" id="input-condicion_select">
                                                    ...
                                                    <option value="{{ condiciones_select.id_condicion }}">{{
                                                        condiciones_select.codigo }} - {{ condiciones_select.nombre }}
                                                    </option>
                                                    {% endfor %}
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <select class="form-control" id="input-componente_select">
