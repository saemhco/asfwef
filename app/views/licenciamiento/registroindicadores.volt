{% set id_indicador = "" %}
{% if indicadores.id_indicador is defined %}
{% set id_indicador = indicadores.id_indicador %}
{% endif %}

{% set componente = "" %}
{% if indicadores.componente is defined %}
{% set componente = indicadores.componente %}
{% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false"
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('licenciamiento/saveIndicadores','method':
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-12">
                                                ...
                                                <label class="select">
                                                    <select id="input-condicion" name="condicion1" style="pointer-events: none;">
                                                        ...
                                                        {% if condiciones_select.id_condicion == condicionSelected %}
                                                        <option value="{{ condiciones_select.id_condicion }}"
                                            ...
                                            <section class="col col-md-12">
                                                ...
                                                <label class="select">
                                                    <select id="input-componente" name="componente"
                                                        ...
                                                        {% if componentes_select.id_componente == componenteSelected %}
                                                        <option value="{{ componentes_select.id_componente }}"
                                            ...
                                            <section class="col col-md-12">
                                                ...
                                                <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                                                    <input type="hidden" id="input-id_indicador" name="id_indicador"
                                                        value="{{ id_indicador }}">
                                    ...
                                    <footer>
                                        ...
                                        <a href="{{ url('licenciamiento/indicadores') }}" type="button" class="btn btn-default">
                                            Volver
                                        </a>
