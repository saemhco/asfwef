                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('licenciamiento/saveFormatos','method': 'post','id':'form_formatos','class':'smart-form','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                {% if archivo !== ""   %}
                                                    ...
                                                    <a href="{{ url('adminpanel/archivos/formatos/'~archivo) }}"  target="_BLANK" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                {% if archivo2 !== ""   %}
                                                    ...
                                                    <a href="{{ url('adminpanel/archivos/formatos/'~archivo2) }}"  target="_BLANK" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a>
...
{{ form('formatos/saveUsuariosDetalles','method': 'post','id':'form_usuarios_detalles','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
...
{{ form('formatos/savePersonalGrupo','method': 'post','id':'form_grupos_personal','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
...
{{ form('formatos/saveUsuariosDetallesDocente','method': 'post','id':'form_usuarios_detalles_docente','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
...
{{ form('formatos/savePersonalGrupoDocente','method': 'post','id':'form_grupos_docente','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-12">
