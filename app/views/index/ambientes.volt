<p/>
    ...
    <div class="row d-flex justify-content-center">
            ...
            <div class="col-lg-3">
                <div class="card card-light-inverse">
                    <div class="withripple zoom-img" style="margin-top: 30px;">
                        <a href="{{ url('web-detalle-ambiente/'~ambiente.id_ambiente~".html") }}"><center>{{ image("adminpanel/imagenes/ambientes/"~ambiente.imagen, "width":"258", "height":"172") }}</center></a>
                    </div>
        ...
        <center>
            <a href="web-ambientes.html" class="btn btn-primary btn-raised text-right" role="button">
