...
{{ form('registrocomputadoras/save','method':
'post','id':'form_computadoras','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-6">
            ...
            <label class="select">
                <select id="input-tipo"  name="tipo" >
                    ...
                    {% for tipocomputadoras_select in tipocomputadoras %}                                       
                        <option value="{{ tipocomputadoras_select.codigo }}">{{ tipocomputadoras_select.nombres }}</option>                                       
                    {% endfor %}
                </select> <i></i> 
            </label>
        </section> 
    ...
    <div class="row">
        <section class="col col-md-12">
            ...
            <label class="textarea"> <i class="icon-append fa fa-comment"></i>
                ...
                <input type="hidden" id="input-id_computadora" name="id_computadora" value="">
            </label>
        </section>
    </div>
