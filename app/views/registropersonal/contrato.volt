                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registropersonal/saveContrato','method': 'post','id':'form_contratos','class':'smart-form','enctype':'multipart/form-data') }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                    ...
                                                    <input type="hidden" id="input-personal" name="personal" value="{{id_personal}}">
                                                </label>
                                            </section>
                                    ...
                                    <footer>
                                        <button id="registrar_contrato" type="button" class="btn btn-primary">
                                            {{ txt_buton }}
                                        </button>
...
<!--Formulario-->
{{ form('registropersonal/saveAdendas','method': 'post','id':'form_adenda','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
