...
{% set discapacitado_archivo = "" %}
{% if publico.discapacitado_archivo is defined %}
    {% set discapacitado_archivo = publico.discapacitado_archivo %}
{% endif %}
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                    <input type="text" id="input-nro_ruc" name="nro_ruc"  placeholder="RUC" value="{{ nro_ruc }}" readonly>                             
                                                </label>
                                            </section>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-6">
                                                ...
                                                <div class="input input-file">
                                                    ...
                                                    <span class="button"><input id="discapacitado_archivo" type="file" name="discapacitado_archivo" onchange="this.parentNode.nextSibling.value = this.value.replace('C:\\fakepath\\', '');"><i class="fa fa-search"></i> Buscar</span><input type="text" id="input-file" name="input-file"  placeholder="Agregar Archivo" readonly="">

                                                </div>

                                                {% if discapacitado_archivo !== ""   %}

                                                    <div class="alert alert-success fade in">                                                        

                                                        Click aqui para ver el archivo 
                                                        <a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/publico/personales/'~discapacitado_archivo) }}" >  <i class="fa-fw fa fa-book"></i></a>
                                                    </div>
