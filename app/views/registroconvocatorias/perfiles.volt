...
{{ form('registroconvocatorias/savePerfiles','method': 'post','id':'form_convocatorias_perfiles','class':'smart-form','enctype':'multipart/form-data','style':'display:none;') }}
<fieldset>
    <div class="row">
    ...
    <div class="row">
        <section class="col col-md-3" >
            ...
            <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                <input type="text" id="input-fecha_inicio" name="fecha_inicio" placeholder="Fecha Inicio" class="datepicker" data-dateformat='dd/mm/yy' value="" autocomplete="off">
            </label>
        </section>
        <section class="col col-md-3">
        ...
        <section class="col col-md-3" >
            ...
            <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                <input type="text" id="input-fecha_fin" name="fecha_fin" placeholder="Fecha Fin" class="datepicker" data-dateformat='dd/mm/yy' value="" autocomplete="off">
            </label>
        </section>
        <section class="col col-md-3">
...
<script type="text/javascript" >
    ...
    var tipoconvocatoria = "{{tipoconvocatoria.tipo}}";
