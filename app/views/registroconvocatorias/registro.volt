...
{% if convocatorias.titulo is defined %}
    {% set titulo = convocatorias.titulo %}
{% endif %}
...
{% if convocatorias.fecha_boton_inicio is defined %}
{% set hora_boton_inicio = utilidades.hora_formato(convocatorias.fecha_boton_inicio,'H:i:s') %}
{% endif %}
...
{% if convocatorias.fecha_boton_fin is defined %}
{% set hora_boton_fin = utilidades.hora_formato(convocatorias.fecha_boton_fin,'H:i:s') %}
{% endif %}
                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('registroconvocatorias/save','method': 'post','id':'form_convocatorias','class':'smart-form','enctype':'multipart/form-data') }}
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-2" >
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                    ...
                                                    <input type="text" id="input-fecha_boton_inicio" name="fecha_boton_inicio" placeholder="Fecha Boton Inicio" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_boton_inicio }}" autocomplete="off">
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                       <input type="text" id="input-hora_boton_inicio" name="hora_boton_inicio" placeholder="Hora Inicio" value="{{hora_boton_inicio}}">
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                    ...
                                                    <input type="text" id="input-fecha_boton_fin" name="fecha_boton_fin" placeholder="Fecha Boton Fin" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_boton_fin }}" autocomplete="off">
                                            ...
                                            <section class="col col-md-2">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                                                       <input type="text" id="input-hora_boton_fin" name="hora_boton_fin" placeholder="Hora Fin" value="{{hora_boton_fin}}">
                                                </label>
                                            </section>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-4" style="margin-bottom: 10px;">
                                                    <button type="button" class="btn btn-primary btn-lg btn-block" id="btn-registrar-cv">
                                                        <i class="fa fa-file-pdf-o"></i> Generar CVS
                                                    </button>
