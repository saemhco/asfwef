...
<div id="ribbon">
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Mantenimiento de tablas maestras</li>
    </ol>
</div>
<!-- END RIBBON -->		
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">	
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <header>
                                ...
                                <h2>Registro de tablas maestras</h2>
                            </header>
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('','method': 'post','id':'form_select_tabla_maestra','class':'smart-form') }}
                                    <fieldset>
                                        <div class="row">
                            
                                                
                                                    <section class="col col-md-12">
                                                        <!-- <label class="text-info" >Seleccione Tabla Maestra …</label> -->
                                                        <select style="width:100%" id="tablas_maestras"  name="tablas_maestras">
                                                            <optgroup label="">
                                                                <option value="">--SELECCIONE TABLA MAESTRA--</option>
                                                                {% for tabla_maestra in tablas_maestras %}
                                                                {% if tabla_maestra.numero == numero_tabla %}
                                                                    <option value="{{ tabla_maestra.numero }}" selected>{{ tabla_maestra.nombres }}</option>
                                                                {% else %}
                                                                    <option value="{{ tabla_maestra.numero }}">{{ tabla_maestra.nombres }}</option>
                                                                {% endif %}
                                                            {% endfor %}
                                                            </optgroup>
                                                        </select>
...
{{ form('tablasmaestras/save','method': 'post','id':'form_tablas_maestras','class':'smart-form','style':'display:none;') }}
<fieldset>
    <div class="row">
        <section class="col col-md-6">
            <label class="text-info" >Codigo</label>
            <label class="input"> <i class="icon-prepend fa fa-edit"></i>
                <input type="text" id="input-codigo" name="codigo" placeholder=""  readonly="">
