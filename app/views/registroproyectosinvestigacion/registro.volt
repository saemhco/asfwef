						...
						<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-colorbutton="false" data-widget-custombutton="false" data-widget-sortable="false" data-widget-togglebutton="false">
							...
							<div>
								...
								<div class="widget-body no-padding">
									...
									{{ form('registroproyectosinvestigacion/save','method':
											...
											<div class="row">
												...
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-investigador" name="investigador" placeholder="Investigador" value="{{ investigador }}">
														<input type="hidden" id="input-id_proyecto" name="id_proyecto" value="{{ id_proyecto }}">
													</label>
												</section>
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-titulo" name="titulo" placeholder="Título" value="{{ titulo }}">
													</label>
												</section>


												<section class="col col-md-12">
													<label class="text-info">Lineas
													</label>
													<label class="select">
														<select id="input-id_linea_investigacion" name="id_linea_investigacion">
															<option value="0">
																Seleccione...</option>
															{% for lineasinv_select in lineasinv %}
																{% if lineasinv_select.id_linea_investigacion == id_linea_investigacion %}
																	<option value="{{ lineasinv_select.id_linea_investigacion }}" selected="selected">{{ lineasinv_select.nombre }}
																	</option>
																{% else %}
																	<option value="{{ lineasinv_select.id_linea_investigacion }}">{{
                                                            lineasinv_select.nombre }}
																	</option>
																{% endif %}
															{% endfor %}
												...
												<section class="col col-md-12">
													<label class="text-info">Sub Linea
													</label>
													<label class="select">
														<select id="input-id_sub_linea_investigacion" name="id_sub_linea_investigacion">
												...
												<section class="col col-md-12">
													...
													<label class="select">
														<select id="input-tipo" name="tipo">
															<option value="0">
																Seleccione...</option>
															{% for tipo_select in tipos %}
																{% if tipo_select.codigo == tipo %}
																	<option value="{{ tipo_select.codigo }}" selected="selected">{{ tipo_select.nombres }}
																	</option>
																{% else %}
																	<option value="{{ tipo_select.codigo }}">{{
                                                            tipo_select.nombres }}
																	</option>
																{% endif %}
															{% endfor %}
												...
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-objetivo" name="objetivo" placeholder="Objetivo" value="{{ objetivo }}">
													</label>
												</section>
												<section class="col col-md-12">
													<label class="text-info">Objetivos Especificos
													</label>
													<label class="input">
														<i class="icon-prepend fa fa-tags"></i>
														<input type="text" id="input-objetivos" name="objetivos" placeholder="Objetivos" value="{{ objetivos }}">
													</label>
												</section>
												...
												<section class="col col-md-2">
													...
													<label class="input">
														<i class="icon-prepend fa fa-calendar"></i>
														<input type="text" id="input-fecha_termino" name="fecha_termino" placeholder="Fecha termino" class="datepicker" data-dateformat='dd/mm/yy' value="{{ fecha_termino }}">
													</label>
												</section>
												...
												<section class="col col-md-2">
													...
													<label class="input">
														...
														<input type="text" id="input-vigencia" name="vigencia" placeholder="Vigencia" value="{{ vigencia }}">
													</label>
												</section>
                                                <section class="col col-md-2">
												...
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-presupuesto" name="presupuesto" placeholder="Presupuesto" value="{{ presupuesto}}">
													</label>
												</section>
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-entidad_cooperante" name="entidad_cooperante" placeholder="Entidad Cooperante" value="{{ entidad_cooperante }}">
													</label>
												</section>
												...
												<section class="col col-md-12">
													...
													<label class="textarea">
														...
														<textarea rows="16" id="input-compromiso_cooperante" name="compromiso_cooperante_ckeditor">{{ compromiso_cooperante }}</textarea>
													</label>
												</section>
												...
												<section class="col col-md-12">
													...
													<label class="textarea">
														<i class="icon-append fa fa-comment"></i>
														<textarea rows="3" id="input-resumen" name="resumen" placeholder="Resumen">{{ resumen }}</textarea>
													</label>
												</section>
												...
												<section class="col col-md-12">
													...
													<label class="input">
														...
														<input type="text" id="input-local_proyecto" name="local_proyecto" placeholder="Local Proyecto" value="{{ local_proyecto }}">
													</label>
												</section>
												...
												<section class="col col-md-12">
													...
													<br>
													<img class="img-responsive" src="{{ url('adminpanel/imagenes/invproyecto/'~imagen) }}" error="this.onerror=null;this.src='{{ url('adminpanel/img/avatars/book_green.png') }}';"></img>
											...
											<section class="col col-md-12">
												...
												{% if archivo !== "" %}
													...
													<div class="alert alert-success fade in">
														...
														<a class="btn btn-ribbon" target="_BLANK" role="button" href="{{ url('adminpanel/archivos/invproyecto/'~archivo) }}">
				...
				<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
					...
					<div>
						...
						<div class="widget-body text-center">
							<a href="javascript:void(0);" onclick="agregar_usuarios_docente();" class="btn btn-primary btn-block">
								<i class="fa fa-plus"></i>
							</a>

							<a href="javascript:void(0);" onclick="editar_usuarios_docente();" class="btn btn-warning btn-block">
								<i class="fa fa-edit"></i>
							</a>
							{# <a href="javascript:void(0);" onclick="ver()" class="btn btn-success btn-block"><i
							                                class="fa fa-eye"></i></a> #}
							<a href="javascript:void(0);" onclick="eliminar_usuarios_docente();" class="btn btn-danger btn-block">
			...
			<div class="col-sm-1">
				<div class="jarviswidget" id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" data-widget-sortable="false">
					...
					<div>
						<div class="jarviswidget-editbox"></div>
						<div class="widget-body text-center">
							<a href="javascript:void(0);" onclick="agregar_usuarios();" class="btn btn-primary btn-block">
								<i class="fa fa-plus"></i>
							</a>

							<a href="javascript:void(0);" onclick="editar_usuarios();" class="btn btn-warning btn-block">
								<i class="fa fa-edit"></i>
							</a>

							<a href="javascript:void(0);" onclick="eliminar_usuarios();" class="btn btn-danger btn-block">
								<i class="fa fa-trash"></i>
							</a>
...
{{ form('registroproyectosinvestigacion/saveUsuarioDetallePersonal','method':
'post','id':'form_usuarios_detalles','class':'smart-form','style':'display:none;') }}
	...
	{{ form('registroproyectosinvestigacion/saveUsuarioDetalleDocente','method':
						...
						<optgroup label="">
							...
							{% for docentes_select in docentes %}
								<option value="{{ docentes_select.codigo }}">{{ docentes_select.apellidop }}
									{{
                        docentes_select.apellidom }}
									{{ docentes_select.nombres }}</option>
							{% endfor %}
						</optgroup>
					</select>
