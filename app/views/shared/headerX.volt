                              ...
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInRight animated-2x">
                                  ...
                                  <ul class="megamenu-block-list">
                                        ...
                                        <li><a href="{{ url('web-areas/'~'ocii'~".html") }}"><i class="fa fa-caret-right"></i>Comunicación e Imagen</a></li>
                              ...
                              <div class="col-sm-3 megamenu-col">
                                <div class="megamenu-block animated fadeInRight animated-2x">
                                  ...
                                  <ul class="megamenu-block-list">
                                        ...
                                        <li><a class="withripple" href="https://www.transparencia.gob.pe/enlaces/pte_transparencia_enlaces.aspx?id_entidad=18813&id_tema=1&ver=D"><i class="fa fa-caret-right"></i>Portal Transparencia Estandar</a></li>
                            ...
                            <div class="row">
                              <div class="col-sm-6 megamenu-col">
                                <div class="megamenu-block animated fadeInLeft animated-2x">
                                  ...
                                  <ul class="megamenu-block-list">
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'1'~".html") }}"><i class="fa fa-caret-right"></i>Condición I  : Modelo Educativo de la Universidad.</a></li>
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'2'~".html") }}"><i class="fa fa-caret-right"></i>Condición II : Constitución, Gobierno y Gestión de la Universidad.</a></li>
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'3'~".html") }}"><i class="fa fa-caret-right"></i>Condición III: La Oferta Académica, Recursos Educativos y Docencia.</a></li>
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'4'~".html") }}"><i class="fa fa-caret-right"></i>Condición IV: Propuesta en Investigación.</a></li>
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'5'~".html") }}"><i class="fa fa-caret-right"></i>Condición V : Responsabilidad Social Universitaria y Bienestar Universitario.</a></li>
                                    <li><a href="{{ url('web-licenciamiento1-cbc/'~'6'~".html") }}"><i class="fa fa-caret-right"></i>Condición VI: Transparencia.</a></li>
                                    <li><a class="withripple" href="javascript:void(0)"></a></li>
                              ...
                              <div class="col-sm-6 megamenu-col">
                                <div class="megamenu-block animated fadeInLeft animated-2x">
                                  <h3 class="megamenu-block-title">Sistema de Gestión de Calidad - UNCA</h3>
                                  <ul class="megamenu-block-list">
                                    <li><a href="https://www.unca.edu.pe/web-documentos/politica-de-calidad-institucional-de-la-universidad-nacional-ciro-alegria.html"><i class="fa fa-caret-right"></i>PGC-OD-01 - Política de Calidad Institucional</a></li>
                                    
                                    <li><a href="https://www.unca.edu.pe/web-documentos/mapa-de-procesos.html"><i class="fa fa-caret-right"></i>PGC-OD-03 - Mapa de Procesos</a></li>
                                    
                                    <li><a href="https://www.unca.edu.pe/web-documentos/alcance-del-sistema-de-gestion-de-la-calidad.html"><i class="fa fa-caret-right"></i>PGC-OD-05 - Alcance del Sistema de Gestión de Calidad</a></li>
                                    <li><a href="https://www.unca.edu.pe/web-documentos/objetivos-del-sistema-de-gestion-de-calidad.html"><i class="fa fa-caret-right"></i>PGC-OD-06 - Objetivos del Sistema de Gestión de Calidad</a></li>
                                    <li><a href="https://www.unca.edu.pe/web-documentos/instructivo-elaboracion-documentos-internos-sistema-gestion-calidad.html"><i class="fa fa-caret-right"></i>PGC-IN-01 - Instructivo para la Elaboración de Documentos Internos </a></li>
                                    <li><a href="https://www.unca.edu.pe/web-documentos/manual-de-contexto.html"><i class="fa fa-caret-right"></i>PGC-MN-01 - Manual de Contexto </a></li>
