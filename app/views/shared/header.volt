...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="/adminpanel/img/favicon/favicon.ico" type="image/x-icon"> 
        <link rel="icon" href="/adminpanel/img/favicon/favicon.ico" type="image/x-icon">
