                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('datos/save_colegiado','method': 'post','id':'form_colegiados','class':'smart-form','enctype':'multipart/form-data') }}
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <div class="inline-group">
                                                    <label class="checkbox">
                                                        {% if habilitado == 1%}
                                                            <input type="checkbox" name="habilitado" value="{{ habilitado }}" checked="checked" id="input-habilitado" onclick="javascript: return false;">
                                                    ...
                                                    <label class="checkbox">
                                                        {% if vive == 1 OR vive == '' %}
                                                            <input type="checkbox" name="vive" value="{{ vive }}" checked="checked" id="input-vive" onclick="javascript: return false;">
                                                    ...
                                                    <label class="checkbox">
                                                        {% if estado == 'A' OR estado == '' %}   
                                                            ...
                                                            <input type="checkbox" name="estado" value="{{ estado }}" id="estado" checked onclick="javascript: return false;"> 
                                                        {% elseif(estado == 'X') %}
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-calendar"></i>
                                                    <input type="text" id="input-fecha_cip" name="fecha_cip" placeholder="Fecha Cip." data-dateformat='dd/mm/yy' value="{{  fecha_cip }}" readonly="">
                                                </label>
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                    <input type="text" id="input-nro_documento" name="nro_documento"  placeholder="DNI" value="{{ nro_documento }}" readonly="">                             
                                                </label>
                                            </section>
                                            <section class="col col-md-4">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                    <input type="text" id="input-apellido_paterno"name="apellido_paterno" placeholder="Apellido Paterno" value="{{apellido_paterno }}"  readonly="">                             
                                                </label>
                                            </section>
                                            <section class="col col-md-4">
                                                <label class="text-info" >Apellido Materno</label>
                                                <label class="input"> <i class="icon-prepend fa fa-user"></i>
                                                    <input type="text" id="input-apellido_materno"name="apellido_materno" placeholder="Apellido Materno" value="{{apellido_materno }}"  readonly="">                             
                                                </label>
                                            </section>
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="select">
                                                    <select id="input-consejo"  name="consejo" style="pointer-events: none;">
                                                        <option value="" >SELECCIONE...</option>
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="select">
                                                    <select id="input-capitulo"  name="capitulo" style="pointer-events: none;">
                                                        <option value="" >SELECCIONE...</option>
