                        ...
                        <div class="jarviswidget" id="wid-id-0" 
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    {{ form('empresas/save','method': 'post','id':'form_empresas','class':'smart-form','enctype':'multipart/form-data') }}
                                    <fieldset>
                                        <div class="row">
                                            ...
                                            <section class="col col-md-4">
                                                ...
                                                <label class="input"> <i class="icon-prepend fa fa-credit-card-alt"></i>
                                                    <input type="text" name="ruc" id="input-ruc" placeholder="RUC" value="{{ ruc }}" readonly>                             
                                                </label>
                                            </section>
                                        </div>
                                        <div class="row">
