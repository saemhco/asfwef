                                                                        ...
                                                                        <tbody>
                                                                            {% for det in notas %}
                                                                                <tr class="activa" id="get-{{ det.alumno }}"  >
                                                                                    ...
                                                                                    <td class="p_p1"><input type="text" style="width: 50px;" class="input-xs pp1 not get-{{ det.alumno }}" name="ep1[]" value="{{ det.ep1 }}" disabled></td>
                                                                                    <td class="p_p2"><input type="text" style="width: 50px;" class="input-xs pp2 not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ep2[]" value="{{ det.ep2 }}" readonly="" disabled></td>
                                                                                    <td class="p_ef"><input type="text" style="width: 50px;" class="input-xs pef not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ef[]" value="{{ det.ef }}" readonly="" disabled></td>
                                                                                    <td class="p_ea"><input type="text" style="width: 50px;" class="input-xs pea not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ea[]" value="{{ det.ea }}" readonly="" disabled></td>
