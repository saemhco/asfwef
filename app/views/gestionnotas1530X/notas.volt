...
<div id="ribbon">
    ...
    <!-- breadcrumb -->
    <ol class="breadcrumb">
        <li>Panel</li><li>Gestión de Notas</li>
    </ol>
</div>
<!-- END RIBBON -->		
                                                                        ...
                                                                        <tbody>
                                                                            {% for det in notas %}
                                                                                <tr class="activa" id="get-{{ det.alumno }}"  >
                                                                                    ...
                                                                                    <td class="p_p1"><input type="text" style="width: 50px;" class="input-xs pp1 not get-{{ det.alumno }}" 
                                                                                        onkeyup="calculaprom($(this))"
                                                                                        
                                                                                        oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" 

                                                                                        name="ep1[]" value="{{ det.ep1 }}" 
                                                                                         {{ eaactivado[1] }}
                                                                                         {{ eaadisab[1] }}
                                                                                        ></td>
                                                                                    <td class="p_p2"><input type="text" style="width: 50px;" class="input-xs pp2 not get-{{ det.alumno }}" 
                                                                                        onkeyup="calculaprom($(this))" 
                                                                                        oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                                                        name="ep2[]" value="{{ det.ep2 }}" 
                                                                                        {{ eaactivado[2] }}
                                                                                         {{ eaadisab[2] }}
                                                                                        ></td>
                                                                                    <td class="p_ef"><input type="text" style="width: 50px;" class="input-xs pef not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" 
                                                                                    oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                                                    
                                                                                        name="ef[]" value="{{ det.ef }}" 
                                                                                         {{ eaactivado[2] }}
                                                                                         {{ eaadisab[2] }}
                                                                                        ></td>
                                                                                    <td class="p_ea"><input type="text" style="width: 50px;" class="input-xs pea not get-{{ det.alumno }}" onkeyup="calculaprom($(this))" name="ea[]" value="{{ det.ea }}" 
