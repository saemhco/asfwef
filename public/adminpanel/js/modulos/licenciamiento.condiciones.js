$(document).ready(function () {
    ...
    tbl_condiciones = $("#tbl_condiciones").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "licenciamiento/datatableCondiciones", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_condiciones'), breakpointDefinition);
            }
        },
        "columnDefs": [
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_condiciones').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#exito_formatos").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "licenciamiento/condiciones";
            }
        }]
    });
...
$("#input-codigo").focusout(function () {
    ...
    if (codigo === '') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento/codigoRegistradoCondiciones",
            data: { codigo: codigo },
            dataType: 'json',
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "licenciamiento/registrocondiciones/" + xsmart;
    } else {
