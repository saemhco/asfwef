$(document).ready(function () {
    ...
    tbl_convocatorias = $("#tbl_convocatorias").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registrocv/datatableConvocatorias", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columnDefs": [
        ...
        "columns": [
            ...
            {"data": "titular", "name": "convocatorias.titulo"},
        ...
        "drawCallback": function (oSettings) {
            ...
            var postular = "";
            postular = "<button onclick='postular(" + data.id_convocatoria + "," + data.codigo + ",\"" + data.titular + "\",\"" + data.nombre_corto + "\",\"" + data.nombre + "\",\"" + data.archivo + "\",\"" + data.fecha_inicio + "\",\"" + data.fecha_fin + "\")' class='btn btn-xs btn-success' >Postular</button>";
...
function postular(codigo, convocatoria_perfiles_codigo, convocatorias_titular, convocatoria_perfiles_nombre_corto, convocatoria_perfiles_nombre, convocatorias_archivo, fecha_inicio, fecha_fin) {
    ...
    if (f_a >= f_i && f_a <= f_f) {
        ...
        if (count_formacion > 0 && count_capacitaciones > 0 && count_experiencia > 0) {
