$(document).ready(function () {
    ...
    tbl_usuarios_detalles = $("#tbl_usuarios_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroconvocatoriasbs/datatableUsuariosDetalles/" + id_convocatoria_bs, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "registroconvocatoriasbs/getAjaxValidarUsuario",
                        type: 'POST',
...
function editar_usuarios() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroconvocatoriasbs/getAjaxUsuariosDetalles",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroconvocatoriasbs/eliminarUsuariosDetalles",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
