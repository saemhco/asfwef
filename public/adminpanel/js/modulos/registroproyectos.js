$(document).ready(function () {
    ...
    tbl_proyectos = $("#tbl_proyectos").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "registroproyectos/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_proyectos'), breakpointDefinition);
            }
        },
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_proyectos').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#exito_invproyecto").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "registroproyectos";
            }
        }]
    });
    ...
    $("#error_tipo_vacio").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "registroproyectos/registro";
            }
        }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registroproyectos/registro/" + xsmart;
    } else {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroproyectos/eliminar",
                            type: 'POST',
                            data: { id_proyecto: xsmart }, //esta parte
                            success: function (msg) {

                                if (msg.say == "yes") {
                                    $('#tbl_proyectos').dataTable().fnDraw();
                                } else {
