$(document).ready(function () {
    ...
    tbl_usuarios_detalles = $("#tbl_usuarios_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroproyectosinvestigacion/datatablePersonal/" + id_proyecto, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "registroproyectosinvestigacion/getAjaxValidarUsuarioPersonal",
                        type: 'POST',
...
function editar_usuarios() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroproyectosinvestigacion/getAjaxUsuarioDetallePersonal",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroproyectosinvestigacion/eliminarUsuarioDetallePersonal",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
