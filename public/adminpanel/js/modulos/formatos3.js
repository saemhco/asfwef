...
//alert(id);
    ...
    tbl_formatos = $("#tbl_formatos").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "formatos3/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
    ...
    $("#exito_formatos").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "formatos3";
                }
            }]
    });
...
$("#input-id_formato").focusout(function () {
    ...
    if (id_formato === '') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "formatos3/codigoRegistrado",
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            url: base_url + "formatos3/getAjaxPermiso",
            type: 'POST',
            data: {id: xsmart},
            success: function (msg) {
                ...
                if (msg.say === "yes") {
                    ...
                    console.log(msg.say);
                    window.location.href = base_url + "formatos3/registro/" + xsmart;
                } else if (msg.say === "no") {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "formatos3/deletepdf",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {

                            if (msg.say == "yes") {
                                window.location.href = base_url + "formatos3/registro/" + id;
                            } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "formatos3/deleteexcel",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {
