$(document).ready(function () {
    ...
    tbl_empleo = $("#tbl_empleo").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "gestionegresados/datatableEmpleos/" + id_alumno, "type": "POST" },
        "processing": false,
        "serverSide": true,
...
function editar() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "gestionegresados/getAjaxEmpleos",
            data: { id: xsmart },
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "gestionegresados/eliminarEmpleos",
                            type: 'POST',
                            data: { "id": xsmart },
                            success: function (msg) {
