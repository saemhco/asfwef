$(document).ready(function () {
    ...
    tbl_usuarios_detalles_docente = $("#tbl_usuarios_detalles_docente").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroinvproyectos/datatableDocente/" + id_proyecto, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles_docente").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "registroinvproyectos/getAjaxValidarUsuarioDocente",
                        type: 'POST',
...
function editar_usuarios_docente() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroinvproyectos/getAjaxUsuarioDetalleDocente",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroinvproyectos/eliminarUsuarioDetalleDocente",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
