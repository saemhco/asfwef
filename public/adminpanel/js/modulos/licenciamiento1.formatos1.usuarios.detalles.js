...
$(document).ready(function () {
    ...
    tbl_usuarios_detalles = $("#tbl_usuarios_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento1/datatableUsuariosDetallesf/" + id_formato, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "licenciamiento1/getAjaxValidarUsuariof",
                        type: 'POST',
                        ...
                        success: function (msg) {
                            ...
                            if (msg.say === "existe") {
                                ...
                                //window.location.href = base_url + "licenciamiento11/registro/" + xsmart;
                ...
                click: function () {
                    ...
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            {
                                $('#tbl_usuarios_detalles').dataTable().fnDraw();
                                $("#form_grupos_personal").dialog("close");
                                bootbox.alert("<strong>Se registró correctamente</strong>");
...
function editar_usuarios() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento1/getAjaxUsuariosDetallesf",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "licenciamiento1/eliminarUsuariosDetallesf",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
...
function agregar_personal_grupo() {
    $('#input-grupo_personal').val("0").trigger('change');

    $('#input-grupo_personal').select2({
        dropdownParent: $('#form_grupos_personal')
    });

    $("#form_grupos_personal").dialog("open");
