$(document).ready(function () {
    ...
    tbl_usuarios_detalles = $("#tbl_usuarios_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento/datatableUsuariosDetalles/" + id_formato, "type": "POST"},
        "processing": false,
        "serverSide": true,
...
function editar_usuarios() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento/getAjaxUsuariosDetalles",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "licenciamiento/eliminarUsuariosDetalles",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
