$(document).ready(function () {
    ...
    tbl_usuarios_detalles_docente = $("#tbl_usuarios_detalles_docente").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento1/datatableUsuariosDetallesDocentef/" + id_formato, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles_docente").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "formatos/getAjaxValidarUsuarioDocentef",
                        type: 'POST',
...
function editar_usuarios_docente() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "formatos/getAjaxUsuariosDetallesDocentef",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "formatos/eliminarUsuariosDetallesDocentef",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
