$(document).ready(function () {
    ...
    tbl_formatos = $("#tbl_formatos").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "gestionlicenciamiento/datatableFormatos", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
...
$("#input-id_formato").focusout(function () {
    ...
    if (id_formato === '') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "gestionlicenciamiento/codigoRegistradoFormatos",
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            url: base_url + "gestionlicenciamiento/getAjaxPermisoFormatos",
            type: 'POST',
            data: {id: xsmart},
            success: function (msg) {
                ...
                if (msg.say === "yes") {
                    ...
                    console.log(msg.say);
                    window.location.href = base_url + "gestionlicenciamiento/registroFormatos/" + xsmart;
                } else if (msg.say === "no") {
...
//                    callback: function () {
//                        $.ajax({
//                            url: base_url + "formatos/eliminar",
//                            type: 'POST',
//                            data: {"id": xsmart},
//                            success: function (msg) {
//
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento/deletepdfFormatos",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {

                            if (msg.say == "yes") {
                                window.location.href = base_url + "gestionlicenciamiento/registroFormatos/" + id;
                            } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento/deleteexcelFormatos",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {
