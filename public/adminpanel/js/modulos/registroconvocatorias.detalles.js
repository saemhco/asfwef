$(document).ready(function () {
    ...
    tbl_convocatoria_detalles = $("#tbl_convocatoria_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroconvocatorias/datatableArchivos/" + id_convocatoria, "type": "POST"},
        "processing": false,
        "serverSide": true,
        ...
        "columns": [
            ...
            {"data": "titulo", "name": "conv_detalle.titulo"},
...
function agregar() {
    ...
    $(".errorforms").hide();
    //$("#input-codigo").val("");
    $("#input-id_convocatoria_detalle_pk").val("");
...
function editar() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroconvocatorias/getAjaxArchivos",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroconvocatorias/eliminarDetalle",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
