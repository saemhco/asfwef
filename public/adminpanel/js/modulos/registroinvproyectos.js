$(document).ready(function () {
    ...
    tbl_inv_proyectos = $("#tbl_inv_proyectos").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "registroinvproyectos/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
    ...
    $("#exito_invproyecto").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "registroinvproyectos";
            }
        }]
    });
    ...
    $("#error_tipo_vacio").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "registroinvproyectos/registro";
            }
        }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registroinvproyectos/registro/" + xsmart;
    } else {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroinvproyectos/eliminar",
                            type: 'POST',
