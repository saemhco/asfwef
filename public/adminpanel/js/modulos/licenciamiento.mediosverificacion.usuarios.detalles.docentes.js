$(document).ready(function () {
    ...
    tbl_usuarios_detalles_docente = $("#tbl_usuarios_detalles_docente").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento/datatableUsuariosDetallesDocenteMediosverificacion/" + id_medio_verificacion, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles_docente").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "licenciamiento/getAjaxValidarUsuarioDocenteMediosverificacion",
                        type: 'POST',
...
function editar_usuarios_docente() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento/getAjaxUsuariosDetallesDocenteMediosverificacion",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "licenciamiento/eliminarUsuariosDetallesDocenteMediosverificacion",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
