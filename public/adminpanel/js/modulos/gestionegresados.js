$(document).ready(function () {
    ...
    tbl_alumnos = $("#tbl_alumnos").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "gestionegresados/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columns": [
    ...
    $("#exito_alumno").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "gestionegresados";
            }
        }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "gestionegresados/registro/" + xsmart;
        ;
    } else {
...
function empleos() {
    if ($(".selrow").is(':checked')) {
        ...
        //Agregamos el id del semestre
        var semes = $("#semestre").val();
        window.location.href = base_url + "gestionegresados/empleos/" + xsmart;
        ;
    } else {
        errordialogtablecuriosity();
    }
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "gestionegresados/eliminar",
                            type: 'POST',
                            data: { "id": xsmart },
                            success: function (msg) {
...
function reporte_lista_egresados_pdf() {
    window.open(base_url + "reportes/reportelistaegresados");
}
...
function reporte_lista_egresados_xls() {
    window.open(base_url + "exportar/reportelistaegresados");
}
