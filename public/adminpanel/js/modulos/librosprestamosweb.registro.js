$(document).ready(function () {
    ...
    tbl_usuario = $("#tbl_postulaciones").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "librosprestamosweb/datatableregistro", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"]],
        "columns": [
            ...
            {"data": "fecha_entrega", "name": " p.fecha_entrega"},
        ...
        "drawCallback": function (oSettings) {
            ...
            if (data.estado === 1) {
                ...
                html2 = '<span class="label label-success">Con Ud.</span>';
                
            }else if(data.estado === 3){
                html2 = '<span class="label label-danger">Devuelto</span>';
