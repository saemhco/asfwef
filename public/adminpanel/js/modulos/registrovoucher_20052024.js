...
/*
                ...
                if (data.estado == 0) {
                    ...
                    estado = estado+"<button  onclick='enviaremail(" + data.voucher + ")'  style='margin-right: 5px;'  class='btn btn-xs btn-primary'>   <i class=\"fa fa-paper-plane\"></i></button>";
