$(document).ready(function () {
    ...
    //condiciones
    var condiciones = CKEDITOR.replace('condiciones_ckeditor', {
    ...
    tbl_convocatoria_perfiles = $("#tbl_convocatoria_perfiles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroconvocatoriasbs/datatablesPerfiles/" + convocatoria, "type": "POST"},
        "processing": false,
        "serverSide": true,
        ...
        "columns": [
            ...
            {"data": "nombre", "name": "public.tbl_web_convocatorias_bs_perfiles.nombre"},
            {"data": "nombre_corto", "name": "public.tbl_web_convocatorias_bs_perfiles.nombre_corto"},
            {"data": "nombre_corto", "name": "public.tbl_web_convocatorias_bs_perfiles.nombre_corto"},
            {"data": "estado", "name": "public.tbl_web_convocatorias_bs_perfiles.estado"}
        ],
        ...
        "drawCallback": function (oSettings) {
            ...
            var postulantes = "";
            var postulantes = "<a role='button' class='btn btn-xs btn-success' href='" + base_url + "registroconvocatoriasbs/postulantes/" + data.id_convocatoria_bs_perfil + "/" + data.id_convocatoria_bs + "' >   <i class='fa fa-users' ></i></a>";
    ...
    $("#form_convocatorias_perfiles").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    frm.append('condiciones', condiciones.getData());
...
function agregar_perfiles() {
    ...
    CKEDITOR.instances['input-condiciones'].setData('');

    //nuevo
    $.ajax({
        type: 'POST',
        url: base_url + "convocatorias/getNuevoPerfiles",
...
function editar_perfiles() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroconvocatoriasbs/getAjaxPerfiles",
            data: {id: xsmart},
            dataType: 'json',
            success: function (response) {
                ...
                $.each(response, function (i, val) {
                    ...
                    if (i === "id_convocatoria_bs_perfil") {
                        $("#input-" + i ).val(val);
                    }
                    ...
                    if (i === 'condiciones') {
                        CKEDITOR.instances['input-condiciones'].setData(val);
                    }
                    ...
                    if (i === "archivo") {
                        ...
                        if (val === "" || val === null) {
                            ...
                            //
                            var valor = '<div class="alert alert-success fade in form_convocatorias_perfiles">Click aqui para ver la imagen<a class="btn btn-ribbon" target="_BLANK" role="button" href=" ' + base_url + 'adminpanel/archivos/convocatoriasbs_perfiles/' + val + '" >  <i class="fa-fw fa fa-book"></i></a></div>';
                            $("#archivo_perfiles_modal").after(valor);
                        }
                    }
                    ...
                    if (i === "imagen") {
                        ...
                        if (val === "" || val === null) {
                            ...
                            var valor = '<div class="alert alert-success fade in form_convocatorias_perfiles">Click aqui para ver la imagen<a class="btn btn-ribbon" target="_BLANK" role="button" href=" ' + base_url + 'adminpanel/imagenes/convocatoriasbs_perfiles/' + val + '" >  <i class="fa-fw fa fa-image"></i></a></div>';
                            $("#imagen_perfiles_modal").after(valor);
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroconvocatoriasbs/eliminarPerfiles",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
