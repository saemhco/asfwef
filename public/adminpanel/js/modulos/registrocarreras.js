$(document).ready(function () {
    ...
    tbl_carreras = $("#tbl_carreras").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registrocarreras/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_carreras'), breakpointDefinition);
            }
        },
        ...
        "drawCallback": function (oSettings) {
            ...
            var html = "<img src='" + base_url + "adminpanel/imagenes/carreras/" + data.imagen + "'   width='90' height='60'  />";
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_carreras').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#success").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registrocarreras";
                }
            }]
    });
    ...
    $("#save").on("click", function () {
        ...
        var frm = new FormData(document.getElementById("form_carreras"));
    ...
    //valida enter
    $("#form_carreras .input").keypress(function (e) {
        if (e.which == 13) {
            $("#graba").trigger("click");
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registrocarreras/registro/" + xsmart;
    } else {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registrocarreras/eliminar",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {

                                if (msg.say == "yes") {
                                    $('#tbl_carreras').dataTable().fnDraw();
                                } else {
