$(document).ready(function () {
    ...
    tbl_convocatorias = $("#tbl_convocatorias").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "gestionconvocatorias/datatableConvocatorias4", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columnDefs": [
...
function postular(codigo, convocatoria_perfiles_codigo, convocatorias_titular, convocatoria_perfiles_nombre_corto, convocatoria_perfiles_nombre, convocatorias_archivo, fecha_inicio, fecha_fin) {
    ...
    console.log("Fecha actual:" + count_archivo_solicitud);
    ...
    if (f_a >= f_i && f_a <= f_f) {
        ...
        if (count_archivo_solicitud > 0 && count_archivo_proyecto > 0  && count_carta_cumplir > 0  && count_carta_presentar > 0  && count_carta_difundir > 0 ) {
            //alert("GAAAAAAAAAAA PUEDE POSTULAR");
            $.ajax({
                type: 'POST',
                url: base_url + "gestionconvocatorias/verificarConvocatoria4",
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                                ...
                                success: {
                                    ...
                                    callback: function () {
                                        $.ajax({
                                            url: base_url + "gestionconvocatorias/saveConvocatorias4",
                                            type: 'POST',
                                            //data: {"id": xsmart},
            ...
            bootbox.alert("<strong>Debe registrar Solicitud / Proyectos / Cartas para postular...</strong>");
        }
        //
