$(document).ready(function () {
    ...
    tbl_experiencia = $("#tbl_experiencia").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "gestionconvocatorias/datatableExperiencia", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columns": [
...
//    $.ajax({
//        type: 'POST',
//        url: base_url + "gestionconvocatorias/getNuevoExperiencia",
//        dataType: 'json',
...
function editar() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "gestionconvocatorias/getAjaxPublicoExperiencia",
            data: {id: xsmart},
            dataType: 'json',
            success: function (response) {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "gestionconvocatorias/eliminarPublicoExperiencia",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
