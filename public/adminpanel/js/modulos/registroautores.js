$(document).ready(function () {
    ...
    tbl_autor = $("#tbl_autores").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroautores/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_autores'), breakpointDefinition);
            }
        },
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_autores').dataTable().fnFilter(this.value);
                }
            });
        }
...
function reporte_pdf() {
    window.open(base_url + "registroautores/reporte");
}
function agregar() {
...
function editar() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroautores/getAjax",
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroautores/eliminar",
                            type: 'POST',
                            data: {"id_autor": xsmart},
                            success: function (msg) {
