$(document).ready(function () {
    ...
    tbl_convocatoria_perfiles = $("#tbl_convocatoria_perfiles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "convocatoriasganadores/datatablesPerfiles/" + convocatoria, "type": "POST"},
        "processing": false,
        "serverSide": true,
        ...
        "drawCallback": function (oSettings) {
            ...
            var postulantes = "";
            var postulantes = "<a role='button' class='btn btn-xs btn-success' href='" + base_url + "convocatoriasganadores/ganadores/" + data.codigo + "/" + data.convocatoria + "' >   <i class='fa fa-users' ></i></a>";
            $('td', row).eq(2).html(postulantes);
...
function editar_perfiles() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "convocatorias/getAjaxPerfiles",
            data: {id: xsmart},
            dataType: 'json',
            success: function (response) {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "convocatorias/eliminarPerfiles",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
