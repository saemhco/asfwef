...
//alert(id);
    ...
    tbl_formatos = $("#tbl_formatos").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "formatos/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
...
$("#input-codigo").focusout(function () {
    ...
    if (codigo === '') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "formatos/codigoRegistrado",
            data: {codigo: codigo},
            dataType: 'json',
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "formatos/registro/" + xsmart;
    } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "formatos/deletepdf",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {

                            if (msg.say == "yes") {
                                window.location.href = base_url + "formatos/registro/" + id;
                            } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "formatos/deleteexcel",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {
