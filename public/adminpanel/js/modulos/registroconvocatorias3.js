...
//alert("Hola Mundo");
    ...
    tbl_convocatorias = $("#tbl_convocatorias").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroconvocatorias3/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        'columnDefs': [
...
//            $('td', row).eq(5).html(html2);
    ...
    $("#exito_convocatorias").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "convocatorias3";
                    //location.reload();
                }
            }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        //console.log(xsmart);
        $.ajax({
            url: base_url + "registroconvocatorias3/getAjaxPermiso",
            type: 'POST',
            data: {id: xsmart},
            success: function (msg) {
                ...
                if (msg.say === "yes") {
                    ...
                    console.log(msg.say);
                    window.location.href = base_url + "registroconvocatorias3/registro/" + xsmart;
                } else if (msg.say === "no") {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroconvocatorias3/eliminar",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                ...
                if (result === true) {
                    ...
                    $.ajax({
                        url: base_url + "registroconvocatorias3/liberarPostulantes",
                        type: 'POST',
