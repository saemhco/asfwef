    ...
    $("#success").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                if (id) {
                    window.location.href = base_url + "registropostulantesa/inscripcionporverificar/" + id;
                } else {
                    window.location.href = base_url + "registropostulantesa/inscripcionporverificar";
                }
