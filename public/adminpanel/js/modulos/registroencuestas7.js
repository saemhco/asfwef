$(document).ready(function () {
    ...
    tbl_alumnos_encuestas = $("#tbl_alumnos_encuestas").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroencuestas7/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        'columnDefs': [
            {
    ...
    $("#error_encuesta_registrada").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registroencuestas7/registro";
                }
            }]
    });
    ...
    $("#success").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registroencuestas7/fin";
                }
            }]
    });
