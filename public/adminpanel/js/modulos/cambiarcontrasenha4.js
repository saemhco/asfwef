$(document).ready(function () {
    ...
    $("#exito_cambio_password").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "datos/cambiarcontrasenha4";
                }
            }]
    });
    ...
    $("#campos_vacio_password").dialog({
        ...
        resizable: false,
        modal: true,
        title: "<div class='widget-header text-warning'><h4><i class='fa fa-check'></i> Sistema de gestión académica</h4></div>",
        show: {
            effect: "highlight",
            duration: 300
        },
