$(document).ready(function () {
    ...
    tbl_noticias = $("#tbl_noticias").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registronoticias/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_noticias'), breakpointDefinition);
            }
        },
        ...
        "drawCallback": function (oSettings) {
            ...
            var html = "<img src='" + base_url + "adminpanel/imagenes/noticias/" + data.imagen + "'   width='90' height='60'  />";
...
console.log(data.fecha_hora);
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_noticias').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#exito_noticias").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registronoticias";
                }
            }]
    });
...
//Publicar form
    $("#publicar").on("click", function () {
        ...
        var frm = new FormData(document.getElementById("form_noticias"));
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registronoticias/registro/" + xsmart;
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registronoticias/eliminar",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {

                                if (msg.say == "yes") {
                                    $('#tbl_noticias').dataTable().fnDraw();
                                } else {
