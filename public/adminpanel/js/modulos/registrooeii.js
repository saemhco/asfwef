...
//
    ...
    tbl_registrooeii = $("#tbl_registrooeii").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registrooeii/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
    ...
    $("#error_objetivoei").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registrooeii/registro";
                }
            }]
    });
...
function editar() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registrooeii/registro/" + xsmart + "/" + ano_eje;
    } else {
