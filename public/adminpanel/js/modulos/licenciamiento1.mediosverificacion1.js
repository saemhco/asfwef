...
//alert("Hola Mundo");
    ...
    tbl_medios = $("#tbl_medios").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento1/datatableMediosverificacion1", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
        ...
        "drawCallback": function (oSettings) {
            ...
            var perfiles = "<a role='button' class='btn btn-xs btn-primary' href='" + base_url + "licenciamiento1/requisitos1/" + data.id_medio_verificacion1 + "' >   <i class='fa fa-list' ></i></a>";
