$(document).ready(function () {
    ...
    tbl_documentos = $("#tbl_documentos").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "registrotramitedocumentario/datatableDocumentosrecibidos/" + id_personal_area, "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[1, "desc"]],
        "columnDefs": [
        ...
        "drawCallback": function (oSettings) {
            ...
            documentoDetalle = "<button onclick='AgregarDocumentoDetalle(" + data.id_doc + "," + data.id_personal_area + ",\"" + data.fecha + "\")' class='btn btn-xs btn-primary' ><i class='fa fa-list'></i></button>";
    ...
    $("#success").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "registrotramitedocumentario/documentosenviados/" + id_personal_area;
            }
        }]
    });
            ...
            $.each(response, function (i, val) {
                ...
                if (i === "archivo") {
                    ...
                    if (val === "" || val === null) {
                        ...
                        //
                        var valor = '<div class="alert alert-success fade in form_documento_detalle">Click aqui para ver la imagen<a class="btn btn-ribbon" target="_BLANK" role="button" href=" ' + base_url + 'adminpanel/archivos/tramite_documentario/internos/' + val + '" >  <i class="fa-fw fa fa-book"></i></a></div>';
                        $("#input-archivo").after(valor);
                        $("#input-file").val(val);
