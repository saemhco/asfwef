$(document).ready(function () {
    ...
    tbl_planillas = $("#tbl_planillas_personal").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "registroplanillas/datatablePlanillaDetallecas/" + codigo, "type": "POST" },
        "processing": false,
        "serverSide": true,
        ...
        "columns": [
            ...
            { "data": "apellidop", "name": "twp.apellidop" },
            { "data": "meta", "name": "tpp.meta" },
            ...
            { "data": "estado", "name": "tpp.estado" },
            { "data": "estado", "name": "tpp.estado" },
            { "data": "apellidom", "name": "twp.apellidom", "visible": false },
...
function salario(planilla, personal) {
    location.href = base_url + "registroplanillas/detallepago1/" + planilla + "/" + personal;
}

function salarioPdf(planilla, personal) {
    var url_pdf = base_url + "registroplanillas/detallepagoPdf1/" + planilla + "/" + personal;
