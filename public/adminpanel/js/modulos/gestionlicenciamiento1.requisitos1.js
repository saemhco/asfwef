...
//alert("Hola Mundo");
    ...
    tbl_requisitos1 = $("#tbl_requisitos1").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "gestionlicenciamiento1/datatableRequisitos1/"+medio_verificacion, "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
            ...
            {"data": "codigo", "name": "public.tbl_lic_requisitos1.codigo"},
            {"data": "nombre", "name": "public.tbl_lic_requisitos1.nombre"}, 
            {"data": "archivo", "name": "public.tbl_lic_requisitos1.archivo"}, 
            {"data": "estado", "name": "public.tbl_lic_requisitos1.estado"}
    ...
    $("#exito_requisitos1").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "gestionlicenciamiento1/requisitos1/"+medio_verificacion;
                }
            }]
    });
...
//Publicar form
    ...
    function carga_componentes(id_condicion1, param) {
        $.post(base_url + "gestionlicenciamiento1/getComponentes", {condicion1: id_condicion1}, function (response) {
            var html = "";
    ...
    function carga_indicadores(id_componente1, param) {
        ...
        $.post(base_url + "gestionlicenciamiento1/getIndicadores", {componente1: id_componente1}, function (response) {
            var html = "";
...
//
//        $.post(base_url + "gestionlicenciamiento1/getMedios", {id_indicador1: id_indicador1}, function (response) {
//            var html = "";
...
function getarchivos(archivo_medio) {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + "gestionlicenciamiento1/getArchivos",
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "gestionlicenciamiento1/registrorequisitos1/" + xsmart;
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "gestionlicenciamiento1/eliminarRequisitos1",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento1/deletepdfRequisitos1",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {

                            if (msg.say == "yes") {
                                window.location.href = base_url + "gestionlicenciamiento1/registrorequisitos1/" + id;
                            } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento1/deleteexcelRequisitos1",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {
