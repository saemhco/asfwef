$(document).ready(function () {
    ...
    $("#btn-registrar-personal").on("click", function () {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "procesosgestionpersonal/saveRegistrarPersonal",
    ...
    tbl_web_personal_marcaciones = $("#tbl_web_personal_marcaciones").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "procesosgestionpersonal/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columns": [
    ...
    $("#input-buscar").on("click", function () {
        ...
        tbl_web_personal_marcaciones = $("#tbl_web_personal_marcaciones").DataTable({
            "stateSave": true,
            "ajax": { "url": base_url + "procesosgestionpersonal/datatable/" + fecha_inicio + "/" + fecha_fin, "type": "POST" },
            "processing": false,
            "serverSide": true,
            "order": [[2, "asc"], [3, "asc"]],
            "columns": [
