$(document).ready(function () {
    ...
    tbl_formatos1 = $("#tbl_formatos1").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "gestionlicenciamiento1/datatableFormatos1", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
            ...
            {"data": "codigo", "name": "formatos.codigo"},
            {"data": "nombre", "name": "formatos.nombre"},
            {"data": "archivo", "name": "formatos.archivo"},
            {"data": "estado", "name": "formatos.estado"}
        ],
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_formatos1'), breakpointDefinition);
            }
        },
        "columnDefs": [
        ...
        "drawCallback": function (oSettings) {
            ...
            if (String(data.archivo2).length > 9) {
                var excel = "<a role='button' class='btn btn-xs btn-success' target='_BLANK' href='" + base_url + "adminpanel/archivos/formatos/" + data.archivo2 + "' >   <i class='fa fa-file-excel-o' ></i></a>";
            }
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_formatos1').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#exito_formatos").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "gestionlicenciamiento1/formatos1";
                }
            }]
    });
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (result.say === "yes")
                {
                    ...
                    //window.location.href = base_url + "formatos";
...
$("#input-id_formato").focusout(function () {

    var id_formato = $("#input-id_formato").val();
    ...
    if (id_formato === '') {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "gestionlicenciamiento1/codigoRegistradoFormatos1",
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            url: base_url + "gestionlicenciamiento1/getAjaxPermisoFormatos1",
            type: 'POST',
            data: {id: xsmart},
            success: function (msg) {
                ...
                if (msg.say === "yes") {
                    ...
                    console.log(msg.say);
                    window.location.href = base_url + "gestionlicenciamiento1/registroFormatos1/" + xsmart;
                } else if (msg.say === "no") {
...
//                    callback: function () {
//                        $.ajax({
//                            url: base_url + "formatos/eliminarformatos1",
//                            type: 'POST',
//                            data: {"id": xsmart},
//                            success: function (msg) {
//
//                                if (msg.say == "yes") {
//                                    $('#tbl_formatos1').dataTable().fnDraw();
//                                } else {
//
//                                }
//                            }
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento1/deletepdfFormatos1",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {

                            if (msg.say == "yes") {
                                window.location.href = base_url + "gestionlicenciamiento1/registroFormatos1/" + id;
                            } else {
    ...
    bootbox.dialog({
        ...
        buttons: {
            ...
            success: {
                ...
                callback: function () {
                    $.ajax({
                        url: base_url + "gestionlicenciamiento1/deleteexcelFormatos1",
                        type: 'POST',
                        data: {"id": xsmart},
                        success: function (msg) {
