$(document).ready(function () {
    ...
    tbl_alumnos = $("#tbl_alumnos").DataTable({
        ...
        "drawCallback": function (oSettings) {
            ...
            var test1 = "<a role='button' class='btn btn-xs btn-info' target='_BLANK' href='" + base_url + "reportes/test1/" + data.codigo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
            $('td', row).eq(7).html(test1);

            var test2 = "<a role='button' class='btn btn-xs btn-info' target='_BLANK' href='" + base_url + "reportes/test2/" + data.codigo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
            $('td', row).eq(8).html(test2);

            var test3 = "<a role='button' class='btn btn-xs btn-info' target='_BLANK' href='" + base_url + "reportes/test3/" + data.codigo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
            $('td', row).eq(9).html(test3);
    ...
    //semestre select
    $("#input-semestre_select").attr("value", semestreax);
