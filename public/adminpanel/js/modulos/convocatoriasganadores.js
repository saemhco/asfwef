...
//alert("Hola Mundo");
    ...
    tbl_convocatorias = $("#tbl_convocatorias").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "convocatoriasganadores/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        'columnDefs': [
...
//            $('td', row).eq(5).html(html2);
            ...
            var perfiles = "<a role='button' class='btn btn-xs btn-success' href='" + base_url + "convocatoriasganadores/perfiles/" + data.id_convocatoria + "' >   <i class='fa fa-list' ></i></a>";
    ...
    $("#exito_convocatorias").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "convocatorias";
                    //location.reload();
                }
            }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "convocatorias/registro/" + xsmart;
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "convocatorias/eliminar",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
