$(document).ready(function () {
    ...
    tbl_capacitaciones = $("#tbl_capacitaciones").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "gestionconvocatorias/datatableCapacitaciones", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columns": [
...
//                    }
    ...
    //Validar solo numeros ya no porque se agregara decimales
    /*
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "gestionconvocatorias/getAjaxPublicoCapacitaciones",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "gestionconvocatorias/eliminarPublicoCapacitaciones",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
