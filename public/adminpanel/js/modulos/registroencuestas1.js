$(document).ready(function () {
    ...
    tbl_alumnos_encuestas = $("#tbl_alumnos_encuestas").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroencuestas1/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        'columnDefs': [
            {
    ...
    $("#error_encuesta_registrada").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registroencuestas1/registro";
                }
            }]
    });
    ...
    $("#asignatura").on("change", function () {
        ...
        if (text_asignatura === undefined) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + "registroencuestas1/encuestaRegistrada",
    ...
    $("#success").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registroencuestas1";
                }
            }]
    });
