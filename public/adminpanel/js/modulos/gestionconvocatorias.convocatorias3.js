$(document).ready(function () {
    ...
    tbl_convocatorias = $("#tbl_convocatorias").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "gestionconvocatorias/datatableConvocatorias3", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[2, "asc"], [3, "asc"]],
        "columnDefs": [
...
function postular(codigo, convocatoria_perfiles_codigo, convocatorias_titular, convocatoria_perfiles_nombre_corto, convocatoria_perfiles_nombre, convocatorias_archivo, fecha_inicio, fecha_fin) {
    ...
    if (f_a >= f_i && f_a <= f_f) {
        ...
        if (count_datos_generales_anexo_01 != '0' && count_datos_generales_anexo_02 != '0' && archivo_datos_generales_dni != '0' && count_formacion != '0' && count_publicaciones != '0' && count_capacitaciones != '0' && count_cargos != '0' && count_extension != '0' ) {
            //alert("GAAAAAAAAAAA PUEDE POSTULAR");
            $.ajax({
                type: 'POST',
                url: base_url + "gestionconvocatorias/verificarConvocatoria3",
                        ...
                        bootbox.dialog({
                            ...
                            buttons: {
                                ...
                                success: {
                                    ...
                                    callback: function () {
                                        $.ajax({
                                            url: base_url + "gestionconvocatorias/saveConvocatorias3",
                                            type: 'POST',
                                            //data: {"id": xsmart},
            ...
            bootbox.alert("<strong>Debe registrar datos generales, formación académica, publicaciones, cursos, cargos, proyectos...</strong>");
        }
        //
