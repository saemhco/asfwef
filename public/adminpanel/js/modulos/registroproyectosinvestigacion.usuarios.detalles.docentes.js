$(document).ready(function () {
    ...
    tbl_usuarios_detalles_docente = $("#tbl_usuarios_detalles_docente").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroproyectosinvestigacion/datatableDocente/" + id_proyecto, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles_docente").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "registroproyectosinvestigacion/getAjaxValidarUsuarioDocente",
                        type: 'POST',
                        ...
                        success: function (msg) {
                            ...
                            if (msg.say === "existe") {
                                ...
                                //window.location.href = base_url + "mediosverificacion1/registro/" + xsmart;
...
function agregar_usuarios_docente() {
    ...
    $("#input-id_proyecto_investigador_docente").val("");
    ...
    $(".form_mediosverificacion_archivos").remove();
...
function editar_usuarios_docente() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registroproyectosinvestigacion/getAjaxUsuarioDetalleDocente",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroproyectosinvestigacion/eliminarUsuarioDetalleDocente",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
