$(document).ready(function () {
    ...
    tbl_documentos = $("#tbl_documentos").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "gestiontramitedocumentarioexternoweb/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        'columnDefs': [
    ...
    $("#success").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "gestiontramitedocumentarioexternoweb/documentosenviadosweb";
            }
        }]
    });
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "gestiontramitedocumentarioexternoweb/registro/" + xsmart;
    } else {
