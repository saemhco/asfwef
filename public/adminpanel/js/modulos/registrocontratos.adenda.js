$(document).ready(function () {
    ...
    tbl_adenda = $("#tbl_adenda").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registrocontratos/datatableAdendas/" + id_contrato, "type": "POST"},
        "processing": false,
        "serverSide": true,
...
function agregar() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + "registrocontratos/getNew",
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "registrocontratos/getAjaxContratosAdendas",
            data: {id: xsmart},
            dataType: 'json',
            success: function (response) {
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registrocontratos/eliminarContratosAdendas",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
