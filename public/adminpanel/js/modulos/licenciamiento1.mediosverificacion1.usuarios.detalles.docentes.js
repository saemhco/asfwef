$(document).ready(function () {
    ...
    tbl_usuarios_detalles_docente = $("#tbl_usuarios_detalles_docente").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento1/datatableUsuariosDetallesDocente/" + id_medio_verificacion1, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles_docente").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "licenciamiento1/getAjaxValidarUsuarioDocente",
                        type: 'POST',
...
function editar_usuarios_docente() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento1/getAjaxUsuariosDetallesDocente",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "licenciamiento1/eliminarUsuariosDetallesDocente",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
