$(document).ready(function () {
    ...
    tbl_usuarios_detalles = $("#tbl_usuarios_detalles").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "licenciamiento/datatableUsuariosDetallesMediosverificacion/" + id_medio_verificacion, "type": "POST"},
        "processing": false,
        "serverSide": true,
    ...
    $("#form_usuarios_detalles").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    ...
                    $.ajax({
                        url: base_url + "licenciamiento/getAjaxValidarUsuario",
                        type: 'POST',
...
function editar_usuarios() {
    ...
    if ($(".selrow").is(':checked')) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "licenciamiento/getAjaxUsuariosDetallesMediosverificacion",
            data: {id: xsmart},
            dataType: 'json',
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "licenciamiento/eliminarUsuariosDetallesMediosverificacion",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {
