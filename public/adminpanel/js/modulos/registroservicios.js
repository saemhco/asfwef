$(document).ready(function () {
    ...
    tbl_servicios = $("#tbl_servicios").DataTable({
        "stateSave": true,
        "ajax": {"url": base_url + "registroservicios/datatable", "type": "POST"},
        "processing": false,
        "serverSide": true,
        "order": [[1, "asc"]],
        "columns": [
            ...
            {"data": "texto_complementario", "name": "texto_complementario"},
        ...
        "preDrawCallback": function () {
            ...
            if (!responsiveHelper_dt_basic) {
                responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#tbl_servicios'), breakpointDefinition);
            }
        },
        ...
        "drawCallback": function (oSettings) {
            ...
            var html = "<img src='" + base_url + "adminpanel/imagenes/servicios/" + data.imagen + "'   width='90' height='60'  />";
            ...
            //Texto coplemnetario
            var texto_complementario = data.texto_complementario;
            var res_texto_complementario = texto_complementario.substring(0, 100);
            //console.log(res_texto_muestra);
            $('td', row).eq(4).html(res_texto_complementario + "...");
            ...
            $('td', row).eq(5).html(res_fecha_hora);
        ...
        initComplete: function () {
            ...
            $('div.dataTables_filter input').bind('keyup', function (e) {
                if (e.keyCode == 13) {
                    $('#tbl_servicios').dataTable().fnFilter(this.value);
                }
            });
        }
    });
    ...
    $("#exito_servicios").dialog({
        ...
        buttons: [{
                ...
                click: function () {
                    $(this).dialog("close");
                    window.location.href = base_url + "registroservicios";
                }
            }]
    });
...
//Publicar form
    $("#publicar").on("click", function () {
        ...
        var frm = new FormData(document.getElementById("form_servicios"));
...
function agregar() {
    ...
    $(".errorforms").hide();
    $("#input-id_servicio").val("");
    $("#form_servicios")[0].reset();
    $("#form_servicios").dialog("open");
}
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registroservicios/registro/" + xsmart;
        ...
        bootbox.dialog({
            ...
            buttons: {
                ...
                success: {
                    ...
                    callback: function () {
                        $.ajax({
                            url: base_url + "registroservicios/eliminar",
                            type: 'POST',
                            data: {"id": xsmart},
                            success: function (msg) {

                                if (msg.say == "yes") {
                                    $('#tbl_servicios').dataTable().fnDraw();
                                } else {
