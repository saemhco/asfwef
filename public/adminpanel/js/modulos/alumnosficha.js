$(document).ready(function () {
    ...
    tbl_alumnos = $("#tbl_alumnos").DataTable({
        ...
        "drawCallback": function (oSettings) {
            ...
            var html2 = "<a role='button' class='btn btn-xs btn-info' target='_BLANK' href='" + base_url + "reportes/reportefichasocioeconomica/" + semestreax + '/' + data.codigo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
