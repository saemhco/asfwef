$(document).ready(function () {
    ...
    tbl_pacientes = $("#tbl_pacientes").DataTable({
        "stateSave": true,
        "ajax": { "url": base_url + "registrohistoriasclinicas/datatable", "type": "POST" },
        "processing": false,
        "serverSide": true,
        'columnDefs': [
            {
        ...
        "drawCallback": function (oSettings) {
            ...
            var historia = "<a role='button' class='btn btn-xs btn-primary' href='" + base_url + "registroatencionessalud/paciente/" + data.nro_doc +"' >   <i class='fa fa-list' ></i></a>";
            $('td', row).eq(3).html(historia);
...
function editar() {
    if ($(".selrow").is(':checked')) {
        ...
        window.location.href = base_url + "registrohistoriasclinicas/registro/" + xsmart;
    } else {
