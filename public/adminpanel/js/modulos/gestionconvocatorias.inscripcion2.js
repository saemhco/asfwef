$(document).ready(function () {
    ...
    $("#success").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                // $(this).dialog("close");
                // if (id) {
                //     window.location.href = base_url + "gestionconvocatorias/inscripcionporverificar/" + id;
                // } else {
                //     window.location.href = base_url + "gestionconvocatorias/inscripcionporverificar";
                // }
                window.location.href = base_url + "gestionconvocatorias/cv2";
            }
        }]
    });
    //fin succes
    ...
    $("#waringFiles").dialog({
        ...
        buttons: [{
            ...
            click: function () {
                $(this).dialog("close");
                window.location.href = base_url + "datos/publico";
            }
        }]
    });
    ...
    $("#save_io").on("click", function () {

        var recibo = $("#input_recibo").val();
        var monto = $("#input_monto").val();
        var imagen = $("#file_inscripcionobservada_imagen").val();
        console.log(imagen);
        ...
        if (recibo == "") {
            ...
            $("#file_inscripcionobservada_imagen").after(val);
        } else {
            $("#warning").dialog("open");
    ...
    $("#file_index_imagen").on("change", function () {
        ...
        if (this.files[0].size > 2000000) {
            ...
            $("#input-index-imagen").after(val);
            $(this).val('');
            $("#save").attr("disabled", true);
        } else {
            console.log("valida formato");
            var imagen = $("#file_index_imagen").val();
            var extensiones = imagen.substring(imagen.lastIndexOf("."));
...
function imagen_tasa_lugar_pago() {
    ...
    $("#input-lugar_pago").attr("src", base_url + "adminpanel/imagenes/web/admision-2021.jpg");
