...
console.log(base_url + "gestionconvocatorias/datatableDetallePago")
    tbl_registrosolicitudesalumnos = $("#tbl_registrovoucherdocente").DataTable({
            ...
            "drawCallback": function (oSettings) {
                ...
                $('td', row).eq(6).html(estadonom);
            var archivo='';
            if (data.estado == 1) {
                 archivo = "<a role='button' class='btn btn-xs btn-warning m-5' style='margin-right: 5px;' target='_BLANK' href='" + base_url + "adminpanel/archivos/voucher/" + data.archivo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
                archivo  = archivo+"<a role='button' class='btn btn-xs btn-info m-5' style='margin-right: 5px;'  target='_BLANK' href='" + base_url + "adminpanel/archivos/voucher/" + data.archivo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
                archivo = archivo+"<a role='button' class='btn btn-xs btn-success m-5' style='margin-right: 5px;'  target='_BLANK' href='" + base_url + "adminpanel/archivos/voucher/" + data.archivo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
                archivo = archivo+"<a role='button' class='btn btn-xs btn-danger m-5' style='margin-right: 5px;'  target='_BLANK' href='" + base_url + "adminpanel/archivos/voucher/" + data.archivo + "' >   <i class='fa fa-file-pdf-o' ></i></a>";
