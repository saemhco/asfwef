$(document).ready(function () {
    ...
    $("#btn-enviar_email").on("click", function () {

        $(".errorforms").hide();
        
        if ($("#input_email_publico").val() === "") {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.mensaje_envio == "no") {

                        $("#modal_enviar_email").modal("hide");
                      
                        $("#modal_envio_link").modal("show");
                        $("#modal_envio_link").on("hide.bs.modal", function () {
                            //alert('Testing');
                            window.location.href = base_url;
                        });


                    } else if(msg.mensaje_envio == "si") {

                        var val = '<div class="text-danger errorforms">El email ya está registrado</div>';
                        $("#input_email_publico").after(val);
    ...
    $("#input_email_publico").focus(function(){
        $(".errorforms").hide();
      });
});
...
function enviar_email() {
    $(".errorforms").hide();
    $(".error_focus").hide();
    $("#form_enviar_email")[0].reset();
    $('#modal_enviar_email').modal('show');
}
