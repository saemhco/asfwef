                ...
                success: function (msg) {
                    ...
                    if (msg.mensaje_envio == "si") {
                        ...
                        $("#modal_envio_link").on("hide.bs.modal", function () {
                            //alert('Testing');
                            window.location.href = base_url + "login-convocatorias-docentes.html";
                        });
                        ...
                        // $("#modal_email_no_registrado").on("hide.bs.modal", function () {
                        //     //alert('Testing');
                        //     window.location.href = base_url+"recuperar-contrasenha-web-externo2.html";
                        // });
