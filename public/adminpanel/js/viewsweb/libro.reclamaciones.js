$(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.say === "yes") {
                    ...
                    carga_provincia_personal_natural(response.persona_natural.region, response.persona_natural.provincia);
    ...
    function carga_provincia_personal_natural(idregion, param) {
    ...
    $("#btn_graba_ciudadano").on("click", function () {
        if ($("#input-nro_doc_ciudadano").val() !== "") {
            console.log("@garaba persona natural");
    ...
    //valida solo numeros
    $('#input-nro_doc_pn').on('input', function () {
        this.value = this.value.replace(/[^0-9]/g, '');
    });
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.say === "yes") {
                    ...
                    carga_provincia_persona_juridica(response.persona_juridica.region, response.persona_juridica.provincia);
    ...
    function carga_provincia_persona_juridica(idregion, param) {
