$(document).ready(function () {
    ...
    $("#btn_grabar_postulantes").on("click", function () {
        ...
        if (input_password === input_password2) {
            ...
            //alert('Testing');
            frmx = $("#form_registro_voluntariado");
            var frm = new FormData(document.getElementById("form_registro_voluntariado"));
            $.ajax({
...
function agregar() {
    ...
    //error focus
    $(".error_focus").hide();
    $("#form_registro_voluntariado")[0].reset();
    //$("#form_registro_voluntariado").dialog("open");
