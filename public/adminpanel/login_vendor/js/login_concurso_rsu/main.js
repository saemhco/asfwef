$(function () {
  ...
  function account_concurso_rsu_recoveryF() {
    var account_concurso_rsu_recovery = JSON.parse(
      localStorage.getItem("account_concurso_rsu_recovery")
    );
    if (account_concurso_rsu_recovery != null) {
      var $field = $(".form-control").closest(".form-group");
      $field.addClass("field--not-empty");
      $("#username").val(account_concurso_rsu_recovery.username);
      $("#password").val(account_concurso_rsu_recovery.password);
      $("#saveAccount").prop("checked", true);
    }
  }
  account_concurso_rsu_recoveryF();
  ...
  $("#saveAccount").click(function () {
    ...
    if (value) {
      localStorage.setItem(
        "account_concurso_rsu_recovery",
        JSON.stringify({ username: username, password: password })
      );
    } else {
      localStorage.removeItem("account_concurso_rsu_recovery");
    }
  });
      ...
      if (isLogin == false) {
        ...
        grecaptcha
          ...
          .then(function (token) {
            ...
            $.ajax({
              url: urlPath + "web/loginConcursosRsu",
              type: "POST",
