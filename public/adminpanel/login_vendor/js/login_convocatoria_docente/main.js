$(function () {
  ...
  function account_convocatoria_docente_recoveryF() {
    var account_convocatoria_docente_recovery = JSON.parse(
      localStorage.getItem("account_convocatoria_docente_recovery")
    );
    if (account_convocatoria_docente_recovery != null) {
      var $field = $(".form-control").closest(".form-group");
      $field.addClass("field--not-empty");
      $("#username").val(account_convocatoria_docente_recovery.username);
      $("#password").val(account_convocatoria_docente_recovery.password);
      $("#saveAccount").prop("checked", true);
    }
  }
  account_convocatoria_docente_recoveryF();
  ...
  $("#saveAccount").click(function () {
    ...
    if (value) {
      localStorage.setItem(
        "account_convocatoria_docente_recovery",
        JSON.stringify({ username: username, password: password })
      );
    } else {
      localStorage.removeItem("account_convocatoria_docente_recovery");
    }
  });
      ...
      if (isLogin == false) {
        ...
        grecaptcha
          ...
          .then(function (token) {
            ...
            $.ajax({
              url: urlPath + "web/loginConvocatoriasDocentes",
              type: "POST",
