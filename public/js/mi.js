$(document).ready(function () {
    $("#input_provincia").addClass('form-control selectpicker');
    //Para activar modal
    $('#myModal').modal('show');
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.say === 'si') {
                        ...
                        $("#modal_nro_doc_registrado").modal("show");
                        $('#input_nro_doc').val('');
                        //$("#input_nro_doc").focus();
    ...
    function carga_provincia(idregion, param) {
        ...
        $.post(base_url + "web/getProvincias", {pk: idregion}, function (response) {
            ...
            $("#input_provincia").html(html).selectpicker('refresh');
    ...
    $("#input_provincia").on("change", function () {
        $("#input_ubigeo").val("");
        carga_distrito($("#input_region").val(), $(this).val(), 0);
    });
    ...
    function carga_distrito(idregion, idprov, param) {
        ...
        $.post(base_url + "web/getDistritos", {pk: idregion, idprov: idprov}, function (response) {
            ...
            $("#input_distrito").html(html).selectpicker('refresh');
        }, "json");

    }

    //carga input ubigeo
    $("#input_distrito").on("change", function () {
        var c_region = $("#input_region").val();
        var c_provincia = $("#input_provincia").val();
    ...
    $("#input_region1").on("change", function () {
    ...
    function carga_provincia_lp(idregion, param) {
        ...
        $.post(base_url + "web/getProvincias", {pk: idregion}, function (response) {
            ...
            $("#input_provincia1").html(html).selectpicker('refresh');
        }, "json");

    }

    //select procinvia (lugar de prodecencia)
    $("#input_provincia1").on("change", function () {
        $("#input_ubigeo1").val("");
        carga_distrito_lp($("#input_region1").val(), $(this).val(), 0);
    });
    ...
    function carga_distrito_lp(idregion, idprov, param) {
        ...
        $.post(base_url + "web/getDistritos", {pk: idregion, idprov: idprov}, function (response) {
            ...
            $("#input_distrito1").html(html).selectpicker('refresh');
        }, "json");

    }

    //select input lugar de procedencia
    $("#input_distrito1").on("change", function () {
        var c_region1 = $("#input_region1").val();
        var c_provincia1 = $("#input_provincia1").val();
